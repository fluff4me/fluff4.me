(factory => {
	...
	exports.default = {
		...
		"text-editor-toolbar-button-group": [
			...
			"text-editor-toolbar-button-group__first__before",
		],
		"text-editor-toolbar-button": [
			...
			"text-editor-toolbar-button__hover-any_focus-any_active-any",
			"z-index-fg__hover-any_focus-any_active-any",
		],
		...
		"text-editor-toolbar-button--has-popover": [
			...
			"border-radius-0",
			"outline-none",
			"translate-y-0__hover-any_focus-any",
			"z-index-fg__before",
			"block__after",
			"absolute__after",
