(factory => {
	...
	exports.default = {
		...
		"patreon-icon-after": [
			...
			"left-2__after",
			"top-50__after",
			"translate-up-50__after",
			"block__after",
			"size-em__after",
			"patreon-icon-after__after",
		],
		"break": [
			"block",
			"margin-top-1",
		...
		"link-external": [
			"link-external__hover_focus-visible-has-focus-visible",
		],
		"link-external--has": [
			"link-external--has__hover_focus-visible-has-focus-visible",
			"after",
			"font-font-awesome__after",
			"vertical-align-super__after",
			"weight-bold__after",
			"link-external--has__after",
		],
		"button": [
			"borderless",
			"padding-2-3",
		...
		"paginator-error": [
			...
			"justify-items-centre",
			"gap-3",
			"paginator-error_paginator-loading",
			"paginator-error",
		],
		"paginator-loading": [
			"grid",
		...
		"chapter--patreon": [
			...
			"absolute__before",
			"inset-0__before",
			"background-patreon-a10__before",
			"chapter--patreon__before",
			"border-patreon__before",
		],
		"chapter-patreon-tier": [
			"before-after",
			"relative",
			"padding-1-2",
			"colour-patreon",
			...
			"absolute__before",
			"inset-0__before",
			"unmargin-left-1__before",
			"border-none__before",
			"chapter-patreon-tier__before",
			"margin-left-2__after",
		],
		"oauth-service": [
			"relative",
			"flex__2",
		...
		"view-type-account-patreon-campaign": [
		],
		"view-type-account-patreon-campaign-oauth-row": [
			"grid",
			"view-type-account-patreon-campaign-oauth-row",
		],
		"view-type-account-patreon-campaign-oauth-row-relink-button": [
			"margin-left-3",
		],
		"view-type-account-patreon-campaign-tier": [
			"grid",
			"columns-subgrid",
			"span-2",
			"padding-2-3",
		...
		"view-type-account-patreon-campaign-tier-list": [
			"grid",
			"view-type-account-patreon-campaign-tier-list",
		],
		"view-type-account-patreon-campaign-tier-list-wrapper": [
			"block",
			"margin-top-4",
		],
		"view-type-account-patreon-campaign-tier-list-heading": [
			"colour-6",
			"font-4",
			"margin-0",
			"uppercase",
		...
		"view-type-account-patreon-campaign-tier-name": [
			"weight-bold",
			"colour-1",
		],
		"view-type-account-patreon-campaign-tier-amount": [
		],
		"view-type-home": [
		],
		"view-type-author": [
		...
		"view-type-chapter-block-number-label": [
			"uppercase",
			"weight-bold",
			"font-2",
			"colour-6",
		...
		"view-type-chapter-block-actions": [
			"row-1-2__2",
		],
		...
		"view-type-chapter-block-patreon-header": [
			"block",
			"relative",
			"margin-block-4",
			"unmargin-inline-4__2",
			"padding-2-4",
			"view-type-chapter-block-patreon-header_view-type-chapter-block-patreon-footer_2",
			"border-box",
			"view-type-chapter-block-patreon-header_view-type-chapter-block-patreon-footer",
			"before",
			"block__before",
			"absolute__before",
			"inset-0__before",
			...
			"border-patreon__before",
			"background-patreon-a10__before",
			"view-type-chapter-block-patreon-header__before_view-type-chapter-block-patreon-footer__before",
			"padding-bottom-5",
			"unmargin-bottom-5",
			"border-top-radius-2__before",
			"border-bottom-none__before",
			"gradient-mask-bottom__before",
		],
		"view-type-chapter-block-patreon-footer": [
			"block",
			"relative",
			"margin-block-4",
			"unmargin-inline-4__2",
			...
			"unmargin-top-5",
			"border-bottom-radius-2__before",
			"border-top-none__before",
			"gradient-mask-top__before",
		],
		"view-type-chapter-block-patreon-header-label": [
			"uppercase",
			"colour-patreon-a60",
			"font-1",
			"weight-bold",
		...
		"view-type-chapter-block-patreon-header-title": [
			"font-kanit",
			"font-4",
			"colour-patreon",
			"margin-0",
		...
		"view-type-chapter-block-patreon-header-actions": [
			"flex",
			"flex-wrap",
			"gap-3",
			"justify-content-centre",
		],
		"view-type-chapter-block-patreon-header-button": [
			"font-3",
			"z-index-fg",
			"font-open-sans",
			"height-fit",
		...
		"view-type-chapter-block-patreon-header-placeholder": [
			"view-type-chapter-block-patreon-header-placeholder",
			"block",
			"font-2",
			"font-open-sans",
		...
		"view-type-chapter-edit-visibility-patreon": [
			"view-type-chapter-edit-visibility-patreon",
		],
		"view-type-new": [
		],
