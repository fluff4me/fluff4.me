...
define("endpoint/Endpoint", ["require", "exports", "utility/Env", "utility/Objects", "utility/Time"], function (require, exports, Env_1, Objects_1, Time_1) {
    ...
    function Endpoint(route, method, headers) {
        ...
        async function query(data, search) {
            ...
            for (let i = 0; shouldRetry && i < 3; i++) {
                ...
                response = undefined;
                shouldRetry = false;
                response = await fetch(`${Env_1.default.API_ORIGIN}${url}${qs}`, {
                    method,
                    headers: Objects_1.default.filterNullish({
                        ...!Env_1.default.API_ORIGIN.includes('ngrok') ? undefined : { 'ngrok-skip-browser-warning': 'true' },
                        'Content-Type': body ? 'application/json' : undefined,
                        'Accept': 'application/json',
                        'App-Build-Number': Env_1.default.BUILD_NUMBER,
                        'App-Build-SHA': Env_1.default.BUILD_SHA,
                        ...headers,
                    }),
                    credentials: 'include',
                    body,
                    signal: AbortSignal.timeout(Time_1.default.seconds(7)),
                }).catch((e) => {
    ...
    (function (Endpoint) {
        function path(route) {
            return `${Env_1.default.API_ORIGIN.slice(0, -1)}${route}`;
        }
        Endpoint.path = path;
    })(Endpoint || (Endpoint = {}));
...
define("ui/component/core/Checkbutton", ["require", "exports", "ui/Component", "ui/component/core/Button", "utility/State"], function (require, exports, Component_2, Button_1, State_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Checkbutton = Component_2.default.Builder('label', (component) => {
        ...
        const state = (0, State_6.default)(false);
        let unuse;
...
define("ui/component/auth/OAuthService", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Checkbutton", "utility/Objects", "utility/State"], function (require, exports, Session_1, Component_3, Checkbutton_1, Objects_2, State_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const OAuthService = Component_3.default.Builder((component, service, definition) => {
        ...
        const isAuthed = State_7.default.Truthy(component, authorisationState);
        ...
        (0, Objects_2.mutable)(button).stateIndicatorWrapper = (0, Component_3.default)()
            .style('oauth-service-state-wrapper')
            .style.bind(button.hoveredOrFocused, 'oauth-service-state-wrapper--focus')
            .appendTo(button);
        (0, Objects_2.mutable)(button).stateIndicator = (0, Component_3.default)()
            .style('oauth-service-state')
            .style.bind(isAuthed, 'oauth-service-state--authenticated')
            .style.bind(State_7.default.Map(button, [button.hoveredOrFocused, button.disabled], (focus, disabled) => focus && !disabled), 'oauth-service-state--focus')
...
define("ui/utility/FocusListener", ["require", "exports", "utility/State"], function (require, exports, State_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/utility/Mouse", ["require", "exports", "utility/State"], function (require, exports, State_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Mouse) {
        const pos = { x: 0, y: 0 };
        Mouse.state = (0, State_9.default)(pos);
...
define("ui/utility/TypeManipulator", ["require", "exports", "utility/State"], function (require, exports, State_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_10 = __importDefault(State_10);
    const TypeManipulator = Object.assign(function (host, onAdd, onRemove) {
        const state = (0, State_10.default)(new Set());
...
define("ui/utility/Viewport", ["require", "exports", "utility/State", "utility/Style"], function (require, exports, State_11, Style_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Viewport) {
        ...
        Viewport.mobile = State_11.default.JIT(owner => {
            const result = State_11.default.Use(owner, {
        ...
        Viewport.tablet = State_11.default.JIT(owner => {
            const result = State_11.default.Use(owner, {
...
define("ui/component/core/Popover", ["require", "exports", "ui/Component", "ui/InputBus", "ui/utility/FocusListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/TypeManipulator", "ui/utility/Viewport", "utility/Objects", "utility/State", "utility/Task"], function (require, exports, Component_5, InputBus_1, FocusListener_1, HoverListener_1, Mouse_2, TypeManipulator_1, Viewport_1, Objects_3, State_12, Task_2) {
    ...
    const Popover = Component_5.default.Builder((component) => {
        let mousePadding;
        let unbind;
        const visible = (0, State_12.default)(false);
        ...
        const popover = component
            ...
            popoverChildren: (0, State_12.default)([]),
            popoverParent: (0, State_12.default)(undefined),
...
define("ui/component/core/Slot", ["require", "exports", "ui/Component", "ui/component/core/ext/ComponentInsertionTransaction", "utility/AbortPromise", "utility/State"], function (require, exports, Component_6, ComponentInsertionTransaction_1, AbortPromise_1, State_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Slot = Object.assign(Component_6.default.Builder((slot) => {
        ...
        const elses = (0, State_13.default)({ elseIfs: [] });
        let unuseElses;
        return slot
            .extend(slot => ({
            use: (state, initialiser) => {
                state = State_13.default.get(state);
                unuse?.();
                unuse = undefined;
                abort?.();
                abort = undefined;
                ...
                state.use(slot, value => {
                    ...
                    if (!value) {
                        ...
                        const unuseElsesContainer = elses.useManual(elses => {
                            unuseElsesList = State_13.default.MapManual(elses.elseIfs.map(({ state }) => state), (...elses) => elses.indexOf(true))
                                .useManual(elseToUse => {
        ...
        using: (value, initialiser) => Slot().use(State_13.default.get(value), initialiser),
    });
    exports.default = Slot;
});
define("ui/component/core/ext/CanHasActionsMenu", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Popover", "ui/component/core/Slot", "ui/utility/Viewport", "utility/Objects"], function (require, exports, Component_7, Button_2, Popover_1, Slot_1, Viewport_2, Objects_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        return component
            ...
            setActionsMenu(initialiser) {
                ...
                component.clearPopover().setPopover('hover', (popover, button) => {
                    const actionsMenu = (0, Objects_4.mutable)(component).actionsMenu = popover
                        .and(ActionsMenu)
...
define("ui/component/core/Heading", ["require", "exports", "ui/Component", "ui/utility/MarkdownContent", "ui/utility/TextManipulator", "utility/Define", "utility/maths/Maths", "utility/State"], function (require, exports, Component_9, MarkdownContent_1, TextManipulator_1, Define_3, Maths_1, State_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Heading = Component_9.default.Builder('h1', (component) => {
        ...
        let aestheticLevel;
        let aestheticStyle;
        const resizeRange = (0, State_14.default)(undefined);
        State_14.default.Map(component, [component.text.state, resizeRange], (...args) => args)
        ...
        return component.extend(heading => ({
            ...
            setResizeRange(minLength, maxLength) {
                if (State_14.default.is(maxLength))
...
define("ui/component/core/Link", ["require", "exports", "navigation/RoutePath", "ui/Component", "ui/InputBus", "ui/utility/MarkdownContent", "utility/Env", "utility/State"], function (require, exports, RoutePath_1, Component_10, InputBus_2, MarkdownContent_2, Env_4, State_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Link = Component_10.default.Builder('a', (component, route) => {
        component
            ...
            .style('link');
        const canNavigate = (0, State_15.default)(true);
...
define("ui/component/core/Block", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/ext/CanHasActionsMenu", "ui/component/core/Heading", "ui/component/core/Link", "ui/component/core/Paragraph", "ui/utility/TypeManipulator", "utility/State"], function (require, exports, Component_12, ActionRow_1, CanHasActionsMenu_1, Heading_1, Link_1, Paragraph_1, TypeManipulator_2, State_16) {
    ...
    const Block = Component_12.default.Builder((component) => {
        ...
        const block = component
            ...
            .tweak(block => block
            .style.bindFrom(State_16.default.MapManual([isLink, block.type.state], (link, types) => [...types].map((t) => `block${link ? '--link' : ''}--type-${t}`))))
...
define("ui/component/auth/OAuthServices", ["require", "exports", "endpoint/auth/EndpointAuthServices", "model/Session", "ui/Component", "ui/component/auth/OAuthService", "ui/component/core/Block", "ui/component/core/Placeholder", "ui/component/core/Slot", "utility/Objects", "utility/State"], function (require, exports, EndpointAuthServices_1, Session_2, Component_14, OAuthService_1, Block_1, Placeholder_1, Slot_2, Objects_5, State_17) {
    ...
    Objects_5 = __importStar(Objects_5);
    ...
    const OAuthServices = Component_14.default.Builder(async (component, state, reauthDangerToken) => {
        ...
        (0, Objects_5.mutable)(block).data = services.data;
        (0, Slot_2.default)()
            ...
            if (!session)
                return (0, Component_14.default)()
                    ...
                    .appendTo(slot);
            for (const service of Objects_5.default.values(services.data))
                if (!service.disabled)
...
define("ui/component/core/Dialog", ["require", "exports", "ui/Component", "utility/State"], function (require, exports, Component_15, State_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/ProgressWheel", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/Slot", "utility/State"], function (require, exports, en_nz_1, Component_21, Slot_4, State_21) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ProgressWheel = Object.assign(ProgressWheelBuilder, {
        Length(length, maxLength) {
            ...
            return Slot_4.default.using(State_21.default.UseManual({ unusedPercent, unusedChars }), (slot, { unusedPercent, unusedChars }) => unusedPercent === undefined || unusedChars === undefined ? undefined
    ...
    const Input = Object.assign(Component_22.default.Extension((component) => {
        ...
        const input = component.extend(component => ({
            ...
            setMaxLength(newLength) {
                if (State_23.default.is(newLength))
...
define("ui/component/core/TextEditor", ["require", "exports", "lang/en-nz", "model/Session", "prosemirror-commands", "prosemirror-dropcursor", "prosemirror-example-setup", "prosemirror-gapcursor", "prosemirror-history", "prosemirror-inputrules", "prosemirror-keymap", "prosemirror-markdown", "prosemirror-model", "prosemirror-schema-list", "prosemirror-state", "prosemirror-transform", "prosemirror-view", "ui/Announcer", "ui/Component", "ui/component/core/Button", "ui/component/core/Checkbutton", "ui/component/core/Dialog", "ui/component/core/ext/Input", "ui/component/core/Popover", "ui/component/core/RadioButton", "ui/component/core/Slot", "ui/InputBus", "ui/utility/MarkdownContent", "ui/utility/StringApplicator", "ui/utility/Viewport", "ui/view/shared/ext/ViewTransition", "utility/Arrays", "utility/Define", "utility/Env", "utility/Objects", "utility/State", "utility/Store", "utility/string/Markdown", "utility/Time", "w3c-keyname"], function (require, exports, en_nz_3, Session_4, prosemirror_commands_1, prosemirror_dropcursor_1, prosemirror_example_setup_1, prosemirror_gapcursor_1, prosemirror_history_1, prosemirror_inputrules_1, prosemirror_keymap_1, prosemirror_markdown_1, prosemirror_model_1, prosemirror_schema_list_1, prosemirror_state_1, prosemirror_transform_1, prosemirror_view_1, Announcer_1, Component_29, Button_5, Checkbutton_3, Dialog_2, Input_2, Popover_3, RadioButton_1, Slot_6, InputBus_3, MarkdownContent_3, StringApplicator_4, Viewport_5, ViewTransition_1, Arrays_4, Define_4, Env_5, Objects_6, State_26, Store_1, Markdown_2, Time_4, w3c_keyname_1) {
    ...
    const schema = new prosemirror_model_1.Schema({
        nodes: Objects_6.default.filterNullish({
            ...
            text_align: {
                ...
                toDOM: (node) => ['div', Objects_6.default.filterNullish({
    ...
    const markdownParser = new prosemirror_markdown_1.MarkdownParser(schema, markdown, Objects_6.default.filterNullish({
...
define("endpoint/patreon/EndpointPatreonCampaignRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_9 = __importDefault(Endpoint_9);
    exports.default = (0, Endpoint_9.default)('/patreon/campaign/remove', 'post');
});
...
define("ui/view/account/AccountViewPatreonCampaign", ["require", "exports", "endpoint/Endpoint", "endpoint/patreon/EndpointPatreonCampaignRemove", "model/Session", "ui/Component", "ui/component/auth/OAuthService", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/ConfirmDialog", "ui/component/core/Heading", "ui/component/core/Slot", "utility/Popup"], function (require, exports, Endpoint_10, EndpointPatreonCampaignRemove_1, Session_7, Component_34, OAuthService_2, Block_6, Button_6, ConfirmDialog_1, Heading_2, Slot_7, Popup_1) {
    ...
    exports.default = Component_34.default.Builder((component, patreon) => {
        ...
        async function relink() {
            await (0, Popup_1.default)('Link Patreon Campaign', Endpoint_10.default.path('/auth/patreon/campaign/begin'), 600, 900)
...
define("ui/component/core/Breadcrumbs", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Heading", "ui/component/core/Link", "utility/State"], function (require, exports, Component_35, Button_7, Heading_3, Link_2, State_27) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Breadcrumbs = Component_35.default.Builder((component) => {
        ...
        let title;
        const backButton = (0, State_27.default)(undefined);
...
define("ui/view/shared/component/View", ["require", "exports", "ui/Component", "ui/component/core/Breadcrumbs", "ui/component/core/Heading", "ui/view/shared/ext/ViewTitle", "utility/State"], function (require, exports, Component_37, Breadcrumbs_1, Heading_4, ViewTitle_1, State_28) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const View = Component_37.default.Builder((component, id) => {
        ...
        return component
            ...
            const state = (0, State_28.default)(undefined);
...
define("ui/view/AccountView", ["require", "exports", "endpoint/author/EndpointAuthorDelete", "model/Session", "ui/component/auth/OAuthServices", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/ConfirmDialog", "ui/component/core/Slot", "ui/view/account/AccountViewForm", "ui/view/account/AccountViewPatreonCampaign", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "utility/State"], function (require, exports, EndpointAuthorDelete_1, Session_8, OAuthServices_2, ActionRow_3, Button_8, ConfirmDialog_2, Slot_8, AccountViewForm_1, AccountViewPatreonCampaign_1, View_1, ViewDefinition_1, ViewTransition_2, State_29) {
    ...
    exports.default = (0, ViewDefinition_1.default)({
        async load() {
            const state = (0, State_29.default)(Session_8.default.Auth.state.value);
...
define("endpoint/author/EndpointAuthorGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_11 = __importDefault(Endpoint_11);
    exports.default = (0, Endpoint_11.default)('/author/{vanity}/get', 'get');
});
define("endpoint/work/EndpointWorkGetAllAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_12 = __importDefault(Endpoint_12);
    exports.default = (0, Endpoint_12.default)('/works/{author}', 'get');
});
define("model/PagedData", ["require", "exports", "ui/utility/EventManipulator", "utility/Objects", "utility/State"], function (require, exports, EventManipulator_1, Objects_7, State_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const PagedData = Object.assign(function (definition) {
        const pageCount = (0, State_30.default)(undefined);
        const pages = (0, State_30.default)([], false); // .setId('PagedData pages')
        const result = {
            pageCount,
            event: undefined,
            get pages() {
            ...
            get(page) {
                ...
                if (existing === undefined || existing === false) {
                    pages.value[page] = Promise.resolve(definition.get(page))
                        .then(data => {
                        if (!State_30.default.is(pages.value[page])) { // if it's already a State, it's been updated before this, don't overwrite
                            let newState;
                            if (State_30.default.is(data)) {
                                newState = (0, State_30.default)(null, false); // .setId(`PagedData page ${page} get 1`)
                                newState.bindManual(data);
                            }
                            else
                                newState = (0, State_30.default)(data, false); // .setId(`PagedData page ${page} get 2`)
            ...
            set(page, data, isLastPage) {
                if (State_30.default.is(pages.value[page]))
                    pages.value[page].value = data;
                else
                    pages.value[page] = (0, State_30.default)(data, false); // .setId(`PagedData page ${page} set`)
                if (isLastPage)
        ...
        (0, Objects_7.mutable)(result).event = (0, EventManipulator_1.default)(result);
        return result;
    }, {
        fromEndpoint,
    });
            ...
            async get(page) {
                ...
                if (dismantler) {
                    ...
                    for (const [key, value] of Object.entries(auxiliary)) {
                        if (value === content)
                            continue;
                        const state = aux[key] ??= (0, State_30.default)([]);
...
define("model/PagedListData", ["require", "exports", "model/PagedData", "utility/State"], function (require, exports, PagedData_1, State_31) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
            ...
            resized(resizePageSize) {
                ...
                list.rawPages.subscribeManual(() => {
                    ...
                    for (let i = 0; i < pages.length; i++) {
                        ...
                        function setPage(value) {
                            const state = pages[i] = (0, State_31.default)(null, false); // .setId('PagedListData subscribeManual setPage')
                            if (State_31.default.is(value))
                ...
                function getPage(page) {
                    ...
                    for (let i = startPageInSource; i < endPageInSource; i++) {
                        ...
                        if (i >= startPageInSource && i < endPageInSource && (!rawPage || (State_31.default.is(rawPage) && rawPage.value === false))) {
                ...
                function resolveData(sourcePages, startIndex, endIndex) {
                    ...
                    return State_31.default.Generator(() => data, false).observeManual(...sourcePages); // .setId('PagedListData resolveData')
                }
            },
            //#endregion
            ////////////////////////////////////
...
define("endpoint/follow/EndpointFollowAdd", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_13 = __importDefault(Endpoint_13);
    exports.default = {
        Author: (0, Endpoint_13.default)('/follow/author/{vanity}', 'post'),
        Work: (0, Endpoint_13.default)('/follow/work/{vanity}', 'post'),
        Tag: (0, Endpoint_13.default)('/follow/tag/{vanity}', 'post'),
        Category: (0, Endpoint_13.default)('/follow/category/{vanity}', 'post'),
    };
});
define("endpoint/follow/EndpointFollowAddWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_14 = __importDefault(Endpoint_14);
    exports.default = (0, Endpoint_14.default)('/follow/work/{author}/{vanity}', 'post');
});
define("endpoint/follow/EndpointFollowGetManifest", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_15 = __importDefault(Endpoint_15);
    exports.default = (0, Endpoint_15.default)('/following', 'get');
});
define("endpoint/follow/EndpointFollowRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_16 = __importDefault(Endpoint_16);
    exports.default = {
        Author: (0, Endpoint_16.default)('/unfollow/author/{vanity}', 'post'),
        Work: (0, Endpoint_16.default)('/unfollow/work/{vanity}', 'post'),
        Tag: (0, Endpoint_16.default)('/unfollow/tag/{vanity}', 'post'),
        Category: (0, Endpoint_16.default)('/unfollow/category/{vanity}', 'post'),
    };
});
define("endpoint/follow/EndpointFollowRemoveWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_17 = __importDefault(Endpoint_17);
    exports.default = (0, Endpoint_17.default)('/unfollow/work/{author}/{vanity}', 'post');
});
define("endpoint/follow/EndpointIgnoreAdd", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_18 = __importDefault(Endpoint_18);
    exports.default = {
        Author: (0, Endpoint_18.default)('/ignore/author/{vanity}', 'post'),
        Work: (0, Endpoint_18.default)('/ignore/work/{vanity}', 'post'),
        Tag: (0, Endpoint_18.default)('/ignore/tag/{vanity}', 'post'),
        Category: (0, Endpoint_18.default)('/ignore/category/{vanity}', 'post'),
    };
});
define("endpoint/follow/EndpointIgnoreAddWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_19) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_19 = __importDefault(Endpoint_19);
    exports.default = (0, Endpoint_19.default)('/ignore/work/{author}/{vanity}', 'post');
});
define("endpoint/follow/EndpointIgnoreRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_20 = __importDefault(Endpoint_20);
    exports.default = {
        Author: (0, Endpoint_20.default)('/unignore/author/{vanity}', 'post'),
        Work: (0, Endpoint_20.default)('/unignore/work/{vanity}', 'post'),
        Tag: (0, Endpoint_20.default)('/unignore/tag/{vanity}', 'post'),
        Category: (0, Endpoint_20.default)('/unignore/category/{vanity}', 'post'),
    };
});
define("endpoint/follow/EndpointIgnoreRemoveWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_21) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_21 = __importDefault(Endpoint_21);
    exports.default = (0, Endpoint_21.default)('/unignore/work/{author}/{vanity}', 'post');
});
define("endpoint/work/EndpointWorkDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_22 = __importDefault(Endpoint_22);
    exports.default = (0, Endpoint_22.default)('/work/{author}/{vanity}/delete', 'post');
});
...
define("ui/component/Author", ["require", "exports", "lang/en-nz", "model/Follows", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/ExternalLink", "ui/component/core/Placeholder", "ui/component/core/Slot"], function (require, exports, en_nz_5, Follows_1, Session_9, Component_39, Block_7, Button_9, ExternalLink_1, Placeholder_2, Slot_9) {
    ...
    exports.default = Component_39.default.Builder((component, author) => {
        ...
        block.setActionsMenu(popover => {
            Session_9.default.Auth.author.use(popover, self => {
...
define("ui/component/core/Flag", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_40, Arrays_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/Paginator", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Loading", "ui/component/core/Popover", "ui/component/core/Slot", "ui/view/shared/ext/ViewTransition", "utility/Async", "utility/State", "utility/string/Strings", "utility/Style"], function (require, exports, Component_42, Block_8, Button_10, Loading_1, Popover_4, Slot_10, ViewTransition_3, Async_3, State_32, Strings_2, Style_3) {
    ...
    const Paginator = Component_42.default.Builder((component) => {
        ...
        const cursor = (0, State_32.default)(0);
        const allData = (0, State_32.default)(undefined, false);
        ...
        const currentData = (0, State_32.default)(false, false);
        let settingId = Symbol();
        State_32.default.Use(component, { cursor, allData }).use(component, async ({ cursor, allData }) => {
            if (!allData)
        ...
        const isLastPage = State_32.default.Map(component, [cursor, pageCount], (cursor, pageCount) => cursor + 1 >= (pageCount ?? Infinity));
        // first
        (0, Button_10.default)()
            .setIcon('angles-left')
            .type('icon')
...
define("ui/component/core/Timestamp", ["require", "exports", "ui/Component", "utility/State", "utility/Time"], function (require, exports, Component_44, State_33, Time_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Timestamp = Component_44.default.Builder((component, time) => {
        let translation;
        const state = (0, State_33.default)(new Date(time ?? Date.now()));
...
define("endpoint/tag/EndpointTagManifest", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_23 = __importDefault(Endpoint_23);
    exports.default = (0, Endpoint_23.default)('/manifest/tags', 'get');
});
...
define("ui/component/core/ext/Draggable", ["require", "exports", "ui/Component", "utility/maths/Vector2", "utility/State"], function (require, exports, Component_45, Vector2_1, State_34) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const isDraggingAnyDraggable = (0, State_34.default)(false);
    const Draggable = Object.assign(Component_45.default.Extension((component, definition = {}) => {
        component.style('draggable');
        const state = (0, State_34.default)(DragState.None);
        const overrideStickyDistance = (0, State_34.default)(undefined);
        const overrideDelay = (0, State_34.default)(undefined);
        const stickyDistance = State_34.default.MapManual([overrideStickyDistance, definition.stickyDistance], (override, base) => override ?? base ?? 0);
        const delay = State_34.default.MapManual([overrideDelay, definition.delay], (override, base) => override ?? base ?? 0);
...
define("ui/component/core/ext/Sortable", ["require", "exports", "ui/Component", "ui/component/core/ext/Draggable", "utility/Arrays", "utility/maths/Vector2", "utility/State"], function (require, exports, Component_47, Draggable_2, Arrays_6, Vector2_2, State_35) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const isSortingAnySortable = (0, State_35.default)(false);
    const Sortable = Object.assign(Component_47.default.Extension((component, definition) => {
        const sorting = (0, State_35.default)(false);
        const sortDelay = (0, State_35.default)(definition.sortDelay ?? 0);
        const stickyDistance = (0, State_35.default)(definition.stickyDistance ?? 0);
        const order = (0, State_35.default)([]);
...
define("ui/utility/Applicator", ["require", "exports", "utility/State"], function (require, exports, State_36) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Applicator(host, defaultValueOrApply, apply) {
        ...
        function makeApplicator(host) {
            return {
                state: (0, State_36.default)(defaultValue),
                set: value => {
                    unbind?.();
                    setInternal(value);
                    return host;
...
define("ui/component/TagsEditor", ["require", "exports", "lang/en-nz", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/ext/Input", "ui/component/core/ext/Sortable", "ui/component/core/ProgressWheel", "ui/component/core/Slot", "ui/component/core/TextInput", "ui/component/Tag", "ui/utility/AnchorManipulator", "ui/utility/Applicator", "utility/AbortPromise", "utility/Mouse", "utility/State", "utility/string/Strings"], function (require, exports, en_nz_6, Tags_1, Component_48, Block_9, Input_4, Sortable_1, ProgressWheel_2, Slot_11, TextInput_4, Tag_1, AnchorManipulator_2, Applicator_1, AbortPromise_2, Mouse_4, State_37, Strings_3) {
    ...
    const TagsEditor = Component_48.default.Builder((component) => {
        const tagsState = (0, State_37.default)({ global_tags: [], custom_tags: [] });
        ////////////////////////////////////
        //#region Current
        ...
        ////////////////////////////////////
        //#region Suggestions
        const hasOrHadFocus = State_37.default.Some(component, component.hasFocused, component.hadFocusedLast);
        const suggestions = (0, Slot_11.default)()
            .style('tags-editor-suggestions')
            .use(State_37.default.UseManual({
            tags: tagsState,
            filter: input.state,
            focus: hasOrHadFocus,
        ...
        const maxLengthGlobal = (0, State_37.default)(undefined);
        const maxLengthCustom = (0, State_37.default)(undefined);
        const editor = component
            ...
            setMaxLengthGlobal(maxLength) {
                if (State_37.default.is(maxLength))
...
define("ui/component/Tags", ["require", "exports", "model/Tags", "ui/Component", "ui/component/core/Slot", "ui/component/Tag", "utility/AbortPromise", "utility/State"], function (require, exports, Tags_2, Component_49, Slot_12, Tag_2, AbortPromise_3, State_38) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Tags = Component_49.default.Builder((component) => {
        const state = (0, State_38.default)(undefined);
        let definition;
        (0, Slot_12.default)()
...
define("ui/component/Work", ["require", "exports", "lang/en-nz", "model/Follows", "model/FormInputLengths", "model/Session", "model/Works", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/core/TextLabel", "ui/component/core/Timestamp", "ui/component/Tags"], function (require, exports, en_nz_7, Follows_2, FormInputLengths_2, Session_10, Works_2, Component_50, Block_10, Button_12, Link_4, Slot_13, TextLabel_1, Timestamp_1, Tags_3) {
    ...
    const Work = Component_50.default.Builder((component, work, author, notFullOverride) => {
        ...
        block.setActionsMenu((popover, button) => {
            if (author && author.vanity === Session_10.default.Auth.author.value?.vanity) {
                (0, Button_12.default)()
                    .type('flush')
                    .setIcon('pencil')
    ...
    exports.default = (0, ViewDefinition_2.default)({
        ...
        create(params, { author }) {
            ...
            (0, Paginator_1.default)()
                ...
                .if(Session_11.default.Auth.author.map(popover, author => author?.vanity === params.vanity), () => (0, Button_13.default)()
                .type('flush')
                .setIcon('plus')
...
define("endpoint/chapter/EndpointChapterDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_24) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_24 = __importDefault(Endpoint_24);
    exports.default = (0, Endpoint_24.default)('/work/{author}/{work}/chapter/{url}/delete', 'post');
});
define("endpoint/chapter/EndpointChapterGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_25 = __importDefault(Endpoint_25);
    exports.default = (0, Endpoint_25.default)('/work/{author}/{work}/chapter/{url}/get', 'get');
});
define("endpoint/chapter/EndpointChapterGetPaged", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_26 = __importDefault(Endpoint_26);
    exports.default = (0, Endpoint_26.default)('/work/{author}/{work}/chapters/paged', 'get');
});
define("endpoint/work/EndpointWorkGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_27) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_27 = __importDefault(Endpoint_27);
    exports.default = (0, Endpoint_27.default)('/work/{author}/{vanity}/get', 'get');
});
...
define("ui/component/core/InfoDialog", ["require", "exports", "ui/Component", "ui/component/core/BlockDialog", "ui/component/core/Button", "ui/utility/StringApplicator", "utility/State"], function (require, exports, Component_52, BlockDialog_2, Button_14, StringApplicator_5, State_39) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const InfoDialog = Object.assign(Component_52.default.Builder((component, definition) => {
        ...
        const state = (0, State_39.default)(undefined);
...
define("endpoint/chapter/EndpointChapterCreate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_28) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_28 = __importDefault(Endpoint_28);
    exports.default = (0, Endpoint_28.default)('/work/{author}/{vanity}/chapter/create', 'post');
});
define("endpoint/chapter/EndpointChapterUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_29) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_29 = __importDefault(Endpoint_29);
    exports.default = (0, Endpoint_29.default)('/work/{author}/{work}/chapter/{url}/update', 'post');
});
define("ui/component/core/Dropdown", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/Button", "ui/component/core/ext/Input", "ui/component/core/RadioButton", "ui/component/core/TextInput", "ui/utility/Applicator", "utility/Async", "utility/Functions", "utility/State"], function (require, exports, en_nz_8, Component_53, Button_15, Input_5, RadioButton_2, TextInput_5, Applicator_2, Async_4, Functions_2, State_40) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Dropdown = Component_53.default.Builder((component) => {
        const dropdown = component.and(Input_5.default)
            .style('dropdown');
        const selection = (0, State_40.default)(undefined);
        let options = {};
        let popover;
        (0, Button_15.default)()
            .style('dropdown-button')
            .text.bind(selection.mapManual(state => _
            ?? Functions_2.default.resolve(options[state]?.translation, state)
            ?? en_nz_8.default['shared/form/dropdown/no-selection']()))
        ...
        dropdown
            ...
            add(id, definition) {
                const button = (0, RadioButton_2.default)()
                    .style('dropdown-option')
                    .type('flush')
                    .tweak(definition.tweakButton, id)
                    .setId(id)
                    .setName(labelFor)
                    .text.bind(Functions_2.default.resolve(definition.translation, id))
                ...
                const filteredOut = State_40.default.Map(button, [input.state, button.checked], (filter, selected) => !selected && !!filter && !button.element.textContent?.includes(filter));
...
define("ui/component/core/RadioRow", ["require", "exports", "ui/Component", "ui/component/core/ext/Input", "ui/component/core/RadioButton", "ui/utility/Applicator", "utility/State"], function (require, exports, Component_54, Input_6, RadioButton_3, Applicator_3, State_41) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const RadioRow = Component_54.default.Builder((component) => {
        const selection = (0, State_41.default)(undefined);
        const options = {};
        let labelFor;
...
define("ui/view/chapter/ChapterEditForm", ["require", "exports", "endpoint/chapter/EndpointChapterCreate", "endpoint/chapter/EndpointChapterUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Dropdown", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/Placeholder", "ui/component/core/RadioRow", "ui/component/core/TextEditor", "ui/component/core/TextInput", "ui/component/core/toast/Toast", "ui/component/TagsEditor", "utility/Objects", "utility/State"], function (require, exports, EndpointChapterCreate_1, EndpointChapterUpdate_1, en_nz_9, FormInputLengths_3, Session_12, Component_55, Block_12, Dropdown_1, Form_2, LabelledTable_2, Placeholder_3, RadioRow_1, TextEditor_2, TextInput_6, Toast_3, TagsEditor_1, Objects_8, State_42) {
    ...
    exports.default = Component_55.default.Builder((component, state, workParams) => {
        ...
        const campaign = Session_12.default.Auth.author.map(component, author => author?.patreon_campaign);
        ...
        const tiers = State_42.default.Use(component, { campaign, visibilityStateIsPatreon })
        ...
        table.label(label => label.text.use('view/chapter-edit/shared/form/visibility-patreon-tier/label'))
            ...
            .content((content, label) => content.append(threshold = (0, Dropdown_1.default)()
            .tweak(dropdown => {
        ...
        function hasUnsavedChanges() {
            ...
            const basicFields = Objects_8.default.keys(getFormData()).filter(key => key !== 'custom_tags' && key !== 'global_tags' && key !== 'tier_id');
    ...
    exports.default = (0, ViewDefinition_3.default)({
        ...
        create(params, { initialChapterResponse, work }) {
            ...
            (0, Link_6.default)(`/work/${author?.vanity}/${work.vanity}`)
                ...
                .setContainsHeading()
                .appendTo(view.content);
            const chapterCount = (0, State_43.default)((Type_1.default.as('number', initialChapterResponse?.page_count) ?? work.chapter_count ?? 0) + 1);
            ...
            const paginator = view.paginator()
                ...
                const state = (0, State_43.default)(pageData === NEW_CHAPTER ? undefined : pageData);
...
define("endpoint/history/EndpointHistoryAddChapter", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_30 = __importDefault(Endpoint_30);
    exports.default = (0, Endpoint_30.default)('/history/add/{author}/{work}/chapter/{url}', 'post');
});
define("endpoint/patreon/EndpointPatreonPatronRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_31) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_31 = __importDefault(Endpoint_31);
    exports.default = (0, Endpoint_31.default)('/auth/patreon/patron/delete', 'post');
});
define("endpoint/reaction/EndpointReactChapter", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_32) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_32 = __importDefault(Endpoint_32);
    exports.default = (0, Endpoint_32.default)('/work/{author}/{work}/chapter/{url}/react/{type}', 'post');
});
define("endpoint/reaction/EndpointUnreactChapter", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_33) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_33 = __importDefault(Endpoint_33);
    exports.default = (0, Endpoint_33.default)('/work/{author}/{work}/chapter/{url}/unreact', 'post');
});
...
define("ui/component/Chapter", ["require", "exports", "lang/en-nz", "model/Chapters", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/ext/CanHasActionsMenu", "ui/component/core/Link", "ui/component/core/Timestamp", "utility/maths/Maths", "utility/State"], function (require, exports, en_nz_10, Chapters_2, Session_13, Component_58, Button_17, CanHasActionsMenu_2, Link_7, Timestamp_2, Maths_2, State_44) {
    ...
    function initActions(actions, chapter, work, author, isChapterView = false) {
        return actions
            .appendAction('patreon', State_44.default.get(chapter), (slot, chapter) => true
            && !isChapterView
            ...
            .appendAction('edit', Session_13.default.Auth.author, (slot, self) => true
            && author
            ...
            && (0, Button_17.default)()
                ...
                .event.subscribe('click', () => navigate.toURL(`/work/${author.vanity}/${work.vanity}/chapter/${State_44.default.value(chapter).url}/edit`)))
            .appendAction('delete', Session_13.default.Auth.author, (slot, self) => true
            && author
            && author.vanity === self?.vanity
            && (0, Button_17.default)()
                .type('flush')
                ...
                .event.subscribe('click', () => Chapters_2.default.delete(State_44.default.value(chapter))));
    }
...
define("endpoint/comment/EndpointCommentGetAllUnder", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_34) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_34 = __importDefault(Endpoint_34);
    exports.default = (0, Endpoint_34.default)('/comments/{under}', 'get');
});
define("endpoint/comment/EndpointCommentAdd", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_35) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_35 = __importDefault(Endpoint_35);
    exports.default = (0, Endpoint_35.default)('/comment/add/{under}', 'post');
});
define("endpoint/comment/EndpointCommentDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_36) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_36 = __importDefault(Endpoint_36);
    exports.default = (0, Endpoint_36.default)('/comment/{id}/delete', 'post');
});
define("endpoint/comment/EndpointCommentUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_37) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_37 = __importDefault(Endpoint_37);
    exports.default = (0, Endpoint_37.default)('/comment/{id}/update', 'post');
});
define("endpoint/reaction/EndpointReactComment", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_38) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_38 = __importDefault(Endpoint_38);
    exports.default = (0, Endpoint_38.default)('/comment/{comment_id}/react/{type}', 'post');
});
define("endpoint/reaction/EndpointUnreactComment", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_39) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_39 = __importDefault(Endpoint_39);
    exports.default = (0, Endpoint_39.default)('/comment/{comment_id}/unreact', 'post');
});
define("ui/component/Reaction", ["require", "exports", "ui/Component", "ui/component/core/Button", "utility/State"], function (require, exports, Component_59, Button_18, State_45) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Reaction = Component_59.default.Builder((component, type, reactionsIn = (0, State_45.default)(0), reactedIn = (0, State_45.default)(false)) => {
        const reactions = State_45.default.get(reactionsIn);
        const reacted = State_45.default.get(reactedIn);
        return component
            .style('reaction')
            ...
            if (commentData && !meta?.isRootComment) {
                ...
                if (commentData.edit) {
                    ...
                    (0, Component_60.default)()
                        ...
                        .appendTo(content);
                    (0, Slot_15.default)()
                        .use(Session_14.default.Auth.author, (slot, author) => {
                        if (!author)
                            return;
...
define("ui/component/Comments", ["require", "exports", "endpoint/comment/EndpointCommentGetAllUnder", "model/Session", "ui/Component", "ui/component/Comment", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/AbortPromise", "utility/State"], function (require, exports, EndpointCommentGetAllUnder_1, Session_15, Component_61, Comment_1, Block_13, Button_20, Slot_16, AbortPromise_4, State_46) {
    ...
    const Comments = Component_61.default.Builder((rawComponent, under, isRootComment) => {
        const block = rawComponent
            ...
            .extend(component => ({}));
        (0, Slot_16.default)()
            .use(Session_15.default.Auth.author, AbortPromise_4.default.asyncFunction(async (signal, slot, author) => {
            const comment = { comment_id: under };
            const comments = (0, State_46.default)([comment]);
            const authors = (0, State_46.default)(!author ? [] : [author]);
            if (author)
            ...
            const query = (0, State_46.default)(undefined);
...
define("endpoint/author/EndpointAuthorUpdateSettings", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_40) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_40 = __importDefault(Endpoint_40);
    exports.default = (0, Endpoint_40.default)('/author/update/settings', 'post');
});
define("utility/Settings", ["require", "exports", "endpoint/author/EndpointAuthorUpdateSettings", "model/Session", "utility/Define", "utility/State"], function (require, exports, EndpointAuthorUpdateSettings_1, Session_16, Define_5, State_47) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Settings) {
        const DEFS = [];
        const SETTINGS = State_47.default
            .JIT(() => {
            const settings = Session_16.default.Auth.author.value?.settings;
            if (!settings)
                return {};
            return JSON.parse(settings);
        })
            .observe(Session_16.default.Auth.author);
        ...
        function registerGroup(name, settings) {
            DEFS.push({
                ...
                settings: Object.values(settings).map((setting) => {
                    ...
                    Define_5.default.magic(state, 'value', {
                        get: () => State_47.default.getInternalValue(state),
                        set: (value) => {
                            const settings = SETTINGS.value;
                            if (value === settings[setting.name])
                                return;
                            settings[setting.name] = value ?? null;
                            const author = Session_16.default.Auth.author.value;
                            if (author) {
                                author.settings = JSON.stringify(settings);
                                Session_16.default.Auth.author.emit();
    ...
    exports.default = (0, ViewDefinition_4.default)({
        ...
        create(params, { workData, initialChapterResponse }) {
            ...
            (0, Link_9.default)(`/work/${author?.vanity}/${workData.vanity}`)
                ...
                .setContainsHeading()
                .appendTo(view.content);
            const chapterState = (0, State_48.default)(initialChapterResponse.data);
            const isOwn = Session_17.default.Auth.loggedInAs(view, params.author);
            const sufficientPledge = chapterState.mapManual(chapter => !chapter.insufficient_pledge);
            const shouldShowPatreon = State_48.default.Some(view, isOwn.truthy, sufficientPledge.falsy);
            ...
            const paginator = view.paginator()
                ...
                if (Session_17.default.Auth.loggedIn.value)
                ...
                if (isPatreon)
                    (0, Slot_17.default)().if(shouldShowPatreon, () => (0, Component_62.default)()
                        ...
                        if (!chapter.patreon)
                            return;
                        (0, Slot_17.default)()
                            .if(Session_17.default.Auth.loggedIn, slot => {
                            (0, Button_21.default)()
                                .style('view-type-chapter-block-patreon-header-button')
                                .text.bind(Session_17.default.Auth.author.map(slot, author => !author?.patreon_patron
        ...
        void ConfirmDialog_5.default.prompt(owner, {
            ...
            async tweak(dialog) {
                (0, Paragraph_3.default)()
                    ...
                    .appendTo(dialog.content);
                const patron = Session_17.default.Auth.author.map(dialog, author => author?.patreon_patron ?? undefined);
                const services = await (0, OAuthServices_3.default)((0, State_48.default)('none'));
                (0, OAuthService_3.default)(services.data.patreon, {
                    ...
                    .appendTo(dialog.content);
                async function relink() {
                    await (0, Popup_2.default)('Link Patron Account', Endpoint_41.default.path('/auth/patreon/patron/begin'), 600, 900)
                        .then(() => true).catch(err => { console.warn(err); return false; });
...
define("ui/view/debug/ButtonRegistry", ["require", "exports", "model/Session", "utility/Env"], function (require, exports, Session_18, Env_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/view/DebugView", ["require", "exports", "endpoint/auth/EndpointAuthServices", "model/Session", "ui/Component", "ui/component/core/Button", "ui/view/debug/ButtonRegistry", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Env", "utility/Objects", "utility/Popup"], function (require, exports, EndpointAuthServices_2, Session_19, Component_63, Button_22, ButtonRegistry_1, View_4, ViewDefinition_5, Env_8, Objects_9, Popup_3) {
    ...
    Objects_9 = __importDefault(Objects_9);
    ...
    exports.default = (0, ViewDefinition_5.default)({
        async create() {
            ...
            for (const service of Objects_9.default.values(OAuthServices.data ?? {})) {
                if (!service)
                    continue;
                (0, Button_22.default)()
                    .text.set(`OAuth ${service.name}`)
                    .event.subscribe('click', async () => {
                    await (0, Popup_3.default)(`OAuth ${service.name}`, service.url_begin, 600, 900)
                        .then(() => true).catch(err => { console.warn(err); return false; });
                ...
                (0, Button_22.default)()
                    ...
                    .event.subscribe('click', async () => {
                    const id = Session_19.default.Auth.get(service.id)?.id;
                    if (id === undefined)
                        return;
            ...
            (0, Button_22.default)()
                ...
                .event.subscribe('click', async () => {
                await (0, Popup_3.default)('Campaign OAuth', `${Env_8.default.API_ORIGIN}auth/patreon/campaign/begin`, 600, 900)
                    .then(() => true).catch(err => { console.warn(err); return false; });
                await Session_19.default.refresh();
            })
            ...
            (0, Button_22.default)()
                ...
                .event.subscribe('click', async () => {
                await (0, Popup_3.default)('Patron OAuth', `${Env_8.default.API_ORIGIN}auth/patreon/patron/begin`, 600, 900)
                    .then(() => true).catch(err => { console.warn(err); return false; });
                await Session_19.default.refresh();
            })
                .appendTo(patreonButtons);
...
define("endpoint/feed/EndpointFeedGetFollowed", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_42) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_42 = __importDefault(Endpoint_42);
    exports.default = (0, Endpoint_42.default)('/feed/get/followed', 'get');
});
define("ui/component/WorkFeed", ["require", "exports", "model/PagedListData", "ui/Component", "ui/component/core/Link", "ui/component/core/Paginator", "ui/component/Work", "utility/State"], function (require, exports, PagedListData_2, Component_64, Link_10, Paginator_3, Work_4, State_49) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const WorkFeed = Component_64.default.Builder((component) => {
        ...
        const feed = paginator.extend(feed => ({
            setFromEndpoint(endpoint) {
                const authors = (0, State_49.default)([]);
...
define("ui/component/core/Tabinator", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "utility/Objects", "utility/State"], function (require, exports, Component_65, Block_14, Button_24, Objects_10, State_50) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Tab = void 0;
    ...
    const Tabinator = Component_65.default.Builder((component) => {
        const activeTab = (0, State_50.default)(undefined);
        const tabs = (0, State_50.default)([]);
        const tabinator = component
            ...
            addTab(newTab) {
                ...
                (0, Objects_10.mutable)(newTab).tabinator = tabinator;
        ...
        (0, Slot_18.default)()
            ...
            const authors = (0, PagedListData_3.default)(25, {
                async get(page) {
                    ...
                    if (!slice.length)
                        return null;
                    const response = await EndpointAuthorsResolveReferences_1.default.query(undefined, { authors: slice.map(follow => follow.author).filterInPlace(Arrays_7.NonNullish) });
                    if (toast.handleError(response))
                        return false;
                    return response.data;
                },
...
define("ui/component/TagBlock", ["require", "exports", "lang/en-nz", "model/Follows", "model/Session", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/Tag"], function (require, exports, en_nz_13, Follows_5, Session_20, Tags_5, Component_67, Block_15, Button_25, Tag_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const TagBlock = Component_67.default.Builder((component, tag) => {
        ...
        block.setActionsMenu(popover => {
            Session_20.default.Auth.loggedIn.use(popover, loggedIn => {
                if (!loggedIn)
                    return;
                (0, Button_25.default)()
                    .type('flush')
...
define("ui/view/following/FollowingTagsTab", ["require", "exports", "model/Follows", "model/Tags", "ui/Component", "ui/component/core/Link", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "ui/component/TagBlock", "utility/AbortPromise", "utility/Arrays"], function (require, exports, Follows_6, Tags_6, Component_68, Link_13, Placeholder_6, Slot_19, Tabinator_2, TagBlock_1, AbortPromise_6, Arrays_8) {
    ...
    const FollowingTagsTab = Component_68.default.Builder((component, type) => {
        ...
        (0, Slot_19.default)()
            ...
            const tags = await Tags_6.default.resolve(follows.map(follow => follow.tag).filterInPlace(Arrays_8.NonNullish));
            if (!tags.length)
...
define("endpoint/work/EndpointWorksResolveReferences", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_44) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_44 = __importDefault(Endpoint_44);
    exports.default = (0, Endpoint_44.default)('/works/resolve', 'get');
});
define("ui/view/following/FollowingWorksTab", ["require", "exports", "endpoint/work/EndpointWorksResolveReferences", "model/Follows", "model/PagedListData", "model/Works", "ui/Component", "ui/component/core/Link", "ui/component/core/Paginator", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "ui/component/Work", "utility/AbortPromise", "utility/Arrays", "utility/State"], function (require, exports, EndpointWorksResolveReferences_1, Follows_7, PagedListData_4, Works_3, Component_69, Link_14, Paginator_5, Placeholder_7, Slot_20, Tabinator_3, Work_5, AbortPromise_7, Arrays_9, State_51) {
    ...
    const FollowingWorksTab = Component_69.default.Builder((component, type) => {
        ...
        (0, Slot_20.default)()
            ...
            const authors = (0, State_51.default)([]);
            const works = (0, PagedListData_4.default)(25, {
                async get(page) {
                    const slice = follows.slice(page * 25, (page + 1) * 25) ?? [];
                    if (!slice.length)
                        return null;
                    const response = await EndpointWorksResolveReferences_1.default.query(undefined, { works: slice.map(follow => Works_3.default.reference(follow.work)).filterInPlace(Arrays_9.NonNullish) });
                    if (toast.handleError(response))
                        return false;
                    authors.value.push(...response.data.authors);
                    authors.value.distinctInPlace(author => author.vanity);
...
define("endpoint/history/EndpointHistoryGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_45) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_45 = __importDefault(Endpoint_45);
    exports.default = (0, Endpoint_45.default)('/history/get', 'get');
});
...
define("endpoint/feed/EndpointFeedGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_46) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_46 = __importDefault(Endpoint_46);
    exports.default = (0, Endpoint_46.default)('/feed/get', 'get');
});
define("endpoint/feed/EndpointFeedGetAuthed", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_47) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_47 = __importDefault(Endpoint_47);
    exports.default = (0, Endpoint_47.default)('/feed/get/authed', 'get');
});
define("ui/view/NewView", ["require", "exports", "endpoint/feed/EndpointFeedGet", "endpoint/feed/EndpointFeedGetAuthed", "model/Session", "ui/component/core/Slot", "ui/component/WorkFeed", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, EndpointFeedGet_1, EndpointFeedGetAuthed_1, Session_21, Slot_21, WorkFeed_2, View_9, ViewDefinition_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_10.default)({
        create: () => {
            ...
            (0, Slot_21.default)()
                .use(Session_21.default.Auth.loggedIn, (slot, loggedIn) => (0, WorkFeed_2.default)()
...
define("endpoint/notification/EndpointNotificationMarkRead", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_48) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_48 = __importDefault(Endpoint_48);
    exports.default = (0, Endpoint_48.default)('/notifications/mark/read', 'post');
});
define("endpoint/notification/EndpointNotificationGetAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_49) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_49 = __importDefault(Endpoint_49);
    exports.default = (0, Endpoint_49.default)('/notifications/get/all', 'get');
});
define("endpoint/notification/EndpointNotificationGetCount", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_50) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_50 = __importDefault(Endpoint_50);
    exports.default = (0, Endpoint_50.default)('/notifications/get/count', 'get');
});
...
define("model/Notifications", ["require", "exports", "endpoint/notification/EndpointNotificationGetAll", "endpoint/notification/EndpointNotificationGetCount", "endpoint/notification/EndpointNotificationMarkRead", "endpoint/notification/EndpointNotificationMarkUnread", "model/PagedListData", "model/Session", "utility/State", "utility/Store", "utility/Time"], function (require, exports, EndpointNotificationGetAll_1, EndpointNotificationGetCount_1, EndpointNotificationMarkRead_1, EndpointNotificationMarkUnread_1, PagedListData_6, Session_22, State_52, Store_3, Time_9) {
    ...
    (function (Notifications) {
        Session_22.default.setClearedWithSessionChange('notifications', () => {
        ...
        Notifications.authors = (0, State_52.default)(Store_3.default.items.notifications?.authors ?? []);
        Notifications.works = (0, State_52.default)(Store_3.default.items.notifications?.works ?? []);
        Notifications.chapters = (0, State_52.default)(Store_3.default.items.notifications?.chapters ?? []);
        Notifications.comments = (0, State_52.default)(Store_3.default.items.notifications?.comments ?? []);
        Notifications.hasMore = (0, State_52.default)(Store_3.default.items.notifications?.hasMore ?? false);
        Notifications.unreadCount = (0, State_52.default)(Store_3.default.items.notifications?.unreadCount ?? 0);
        Notifications.lastUpdate = (0, State_52.default)(Store_3.default.items.notifications?.lastUpdate ?? 0);
        function clear() {
        ...
        async function checkNotifications() {
            ...
            if (!Session_22.default.Auth.author.value)
                return;
...
define("ui/component/Notification", ["require", "exports", "lang/en-nz", "model/Authors", "model/Chapters", "model/Comments", "model/Notifications", "model/TextBody", "model/Works", "ui/Component", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Timestamp", "utility/State"], function (require, exports, en_nz_14, Authors_2, Chapters_4, Comments_2, Notifications_1, TextBody_2, Works_5, Component_70, Button_26, Link_16, Timestamp_4, State_53) {
    ...
    const Notification = Component_70.default.Builder('a', (component, data) => {
        ...
        if (!translationFunction)
            return undefined;
        const read = (0, State_53.default)(data.read);
        ...
        const justMarkedUnread = (0, State_53.default)(false);
    ...
    exports.default = (0, ViewDefinition_12.default)({
        ...
        create(params, { tag }) {
            ...
            (0, WorkFeed_3.default)()
                .setFromEndpoint((Session_23.default.Auth.author.value ? EndpointFeedGetAuthed_2.default : EndpointFeedGet_2.default)
                .prep(undefined, {
...
define("endpoint/work/EndpointWorkCreate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_52) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_52 = __importDefault(Endpoint_52);
    exports.default = (0, Endpoint_52.default)('/work/create', 'post');
});
define("endpoint/work/EndpointWorkUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_53) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_53 = __importDefault(Endpoint_53);
    exports.default = (0, Endpoint_53.default)('/work/{author}/{vanity}/update', 'post');
});
define("ui/component/core/Textarea", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/ext/Input", "ui/utility/StringApplicator", "utility/State"], function (require, exports, en_nz_15, Component_72, Input_7, StringApplicator_6, State_54) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Textarea = Component_72.default.Builder((component) => {
        ...
        const state = (0, State_54.default)('');
        const touched = (0, State_54.default)(false);
        const input = component
            .and(Input_7.default)
            ...
            const response = await (() => {
                switch (type) {
                    ...
                    case 'update': {
                        if (!state.value)
                            return;
                        const authorVanity = Session_24.default.Auth.author.value?.vanity;
                        if (!authorVanity)
                            return new Error('Cannot update a work when not signed in');
...
define("ui/view/WorkEditView", ["require", "exports", "endpoint/work/EndpointWorkGet", "model/Works", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/InfoDialog", "ui/component/core/Slot", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "ui/view/work/WorkEditForm", "utility/State"], function (require, exports, EndpointWorkGet_3, Works_6, Component_74, ActionRow_5, Button_28, InfoDialog_2, Slot_22, View_12, ViewDefinition_13, ViewTransition_4, WorkEditForm_1, State_55) {
    ...
    exports.default = (0, ViewDefinition_13.default)({
        ...
        create(params, { work }) {
            ...
            const state = (0, State_55.default)(work);
            const editFormState = (0, State_55.default)(work);
...
define("ui/view/WorkView", ["require", "exports", "endpoint/chapter/EndpointChapterGetAll", "endpoint/chapter/EndpointChapterReorder", "endpoint/history/EndpointHistoryAddWork", "endpoint/work/EndpointWorkGet", "model/PagedListData", "model/Session", "ui/Component", "ui/component/Chapter", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Paginator", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/Work", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Errors", "utility/State"], function (require, exports, EndpointChapterGetAll_1, EndpointChapterReorder_1, EndpointHistoryAddWork_1, EndpointWorkGet_4, PagedListData_7, Session_25, Component_75, Chapter_3, Block_18, Button_29, Paginator_8, Placeholder_8, Slot_23, Work_7, View_13, ViewDefinition_14, Errors_3, State_56) {
    ...
    exports.default = (0, ViewDefinition_14.default)({
        ...
        create(params, { work: workData }) {
            ...
            if (Session_25.default.Auth.loggedIn.value)
            ...
            (0, Work_7.default)(workData, authorData)
                ...
                .setContainsHeading()
                .appendTo(view.content);
            const movingChapter = (0, State_56.default)(undefined);
            const chaptersListState = (0, State_56.default)(null);
            (0, Slot_23.default)()
                ...
                (0, Slot_23.default)()
                    ...
                    (0, Chapter_3.default)(movingChapterData, workData, authorData)
                        ...
                        .insertAction('reorder', 'before', 'delete', Session_25.default.Auth.author, (slot, self) => true
                ...
                .if(Session_25.default.Auth.author.map(popover, author => author?.vanity === params.author), () => (0, Button_29.default)()
                .setIcon('plus')
                .type('flush')
...
define("ui/utility/StringApplicator", ["require", "exports", "lang/en-nz", "utility/State"], function (require, exports, en_nz_17, State_57) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function BaseStringApplicator(host, defaultValue, set) {
        ...
        let unbind;
        const state = (0, State_57.default)(defaultValue);
        const result = makeApplicator(host);
...
define("ui/component/core/Button", ["require", "exports", "ui/Component", "ui/InputBus", "ui/utility/BrowserListener", "ui/utility/FontsListener", "ui/utility/TypeManipulator", "utility/State", "utility/Type"], function (require, exports, Component_76, InputBus_5, BrowserListener_1, FontsListener_1, TypeManipulator_3, State_58, Type_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Button = Component_76.default.Builder('button', (component) => {
        ...
        const disabled = State_58.default.Generator(() => !!disabledReasons.size);
        const hasSubtext = (0, State_58.default)(false);
        let icon;
...
define("ui/component/core/Label", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Form", "ui/component/core/Textarea", "ui/view/shared/component/View", "utility/State"], function (require, exports, Component_77, Button_30, Form_4, Textarea_2, View_14, State_59) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Label = Component_77.default.Builder('label', (label) => {
        ...
        return label
            .extend(label => ({
            textWrapper,
            for: (0, State_59.default)(undefined),
            setFor: inputName => {
            ...
            setInput: input => {
                ...
                const inputInvalidOwner = State_59.default.Owner.create();
                if (input)
                    State_59.default.Use(inputInvalidOwner, { invalid: input.invalid, touched: input.as(Textarea_2.default)?.touched })
...
define("ui/utility/AttributeManipulator", ["require", "exports", "lang/en-nz", "ui/utility/StringApplicator"], function (require, exports, en_nz_18, StringApplicator_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        const result = {
            ...
            refresh() {
                ...
                for (const attribute in translationHandlers) {
                    ...
                    const weave = typeof translationHandler === 'string' ? en_nz_18.default[translationHandler]() : translationHandler(en_nz_18.default, StringApplicator_8.QuiltHelper);
...
define("ui/Component", ["require", "exports", "lang/en-nz", "ui/utility/AnchorManipulator", "ui/utility/AttributeManipulator", "ui/utility/ClassManipulator", "ui/utility/EventManipulator", "ui/utility/FocusListener", "ui/utility/StringApplicator", "ui/utility/StyleManipulator", "ui/utility/TextManipulator", "ui/utility/Viewport", "utility/Arrays", "utility/Async", "utility/Define", "utility/Env", "utility/Errors", "utility/Objects", "utility/State", "utility/string/Strings"], function (require, exports, en_nz_19, AnchorManipulator_3, AttributeManipulator_1, ClassManipulator_1, EventManipulator_2, FocusListener_2, StringApplicator_9, StyleManipulator_1, TextManipulator_2, Viewport_6, Arrays_10, Async_5, Define_6, Env_9, Errors_4, Objects_11, State_60, Strings_4) {
    ...
    Define_6.default.magic(Element.prototype, 'component', {
        get() {
    ...
    function Component(type = 'span') {
        ...
        let component = {
            supers: (0, State_60.default)([]),
            isComponent: true,
            isInsertionDestination: true,
            element: document.createElement(type),
            removed: (0, State_60.default)(false),
            rooted: (0, State_60.default)(false),
            get tagName() {
            ...
            extendMagic: (property, magic) => {
                Define_6.default.magic(component, property, magic(component));
                return component;
            },
            extendJIT: (property, supplier) => {
                Define_6.default.magic(component, property, {
                    get: () => {
                        const value = supplier(component);
                        Define_6.default.set(component, property, value);
            ...
            get style() {
                return Define_6.default.set(component, 'style', (0, StyleManipulator_1.default)(component));
            },
            get classes() {
                return Define_6.default.set(component, 'classes', (0, ClassManipulator_1.default)(component));
            },
            get attributes() {
                return Define_6.default.set(component, 'attributes', (0, AttributeManipulator_1.default)(component));
            },
            get event() {
                return Define_6.default.set(component, 'event', (0, EventManipulator_2.default)(component));
            },
            get text() {
                return Define_6.default.set(component, 'text', (0, TextManipulator_2.default)(component));
            },
            get anchor() {
                return Define_6.default.set(component, 'anchor', (0, AnchorManipulator_3.default)(component));
            },
            get hovered() {
                return Define_6.default.set(component, 'hovered', (0, State_60.default)(false));
            },
            get focused() {
                return Define_6.default.set(component, 'focused', (0, State_60.default)(false));
            },
            get hasFocused() {
                return Define_6.default.set(component, 'hasFocused', (0, State_60.default)(false));
            },
            get hadFocusedLast() {
                return Define_6.default.set(component, 'hadFocusedLast', (0, State_60.default)(false));
            },
            get hoveredOrFocused() {
                return Define_6.default.set(component, 'hoveredOrFocused', State_60.default.Generator(() => component.hovered.value || component.focused.value)
                    .observe(component, component.hovered, component.focused));
            },
            get hoveredOrHasFocused() {
                return Define_6.default.set(component, 'hoveredOrHasFocused', State_60.default.Generator(() => component.hovered.value || component.hasFocused.value)
                    .observe(component, component.hovered, component.hasFocused));
            },
            get active() {
                return Define_6.default.set(component, 'active', (0, State_60.default)(false));
            },
            get id() {
                return Define_6.default.set(component, 'id', (0, State_60.default)(undefined));
            },
            get name() {
                return Define_6.default.set(component, 'name', (0, State_60.default)(undefined));
            },
            get rect() {
                const rectState = State_60.default.JIT(() => component.element.getBoundingClientRect());
                ...
                return Define_6.default.set(component, 'rect', rectState);
            },
            setId: id => {
                unuseIdState?.();
            ...
            append(...contents) {
                const elements = contents.filter(Arrays_10.Truthy).map(Component.element);
            ...
            getStateForClosest(builders) {
                const state = State_60.default.JIT(() => component.closest(builders));
                component.receiveAncestorInsertEvents();
                component.onRooted(() => {
                    state.markDirty();
            ...
            *getDescendants(builder) {
            ...
            get ariaLabel() {
                return Define_6.default.set(component, 'ariaLabel', (0, StringApplicator_9.default)(component, value => component.attributes.set('aria-label', value)));
            },
            ariaLabelledBy: labelledBy => {
                unuseAriaLabelledByIdState?.();
                if (labelledBy) {
                    const state = State_60.default.Generator(() => labelledBy.id.value ?? labelledBy.attributes.get('for'))
    ...
    (function (Component) {
        ...
        function wrap(element) {
            ...
            (0, Objects_11.mutable)(component).element = element;
            return component;
        }
        Component.wrap = wrap;
        ...
        function Builder(initialOrBuilder, builder) {
            ...
            async function ensureOriginalComponentNotSubscriptionOwner(original) {
                if (!original || !State_60.default.OwnerMetadata.hasSubscriptions(original))
                    return;
...
define("model/Session", ["require", "exports", "endpoint/auth/EndpointAuthDelete", "endpoint/session/EndpointSessionGet", "endpoint/session/EndpointSessionReset", "utility/Env", "utility/Popup", "utility/State", "utility/Store"], function (require, exports, EndpointAuthDelete_1, EndpointSessionGet_1, EndpointSessionReset_1, Env_10, Popup_4, State_61, Store_4) {
    ...
    var Session;
    (function (Session) {
        Session.has = (0, State_61.default)(false);
        ...
        function updateState() {
            ...
            Auth.authorisations.value = Store_4.default.items.session?.author?.authorisations ?? Store_4.default.items.session?.authorisations ?? [];
        ...
        let Auth;
        (function (Auth) {
            Auth.state = (0, State_61.default)('none');
            Auth.loggedIn = State_61.default.Generator(() => Auth.state.value === 'logged-in').observeManual(Auth.state);
            Auth.authorisations = (0, State_61.default)([]);
            Auth.author = (0, State_61.default)(undefined, false);
            function getAll() {
            ...
            async function auth(service) {
                await (0, Popup_4.default)(`Login Using ${service.name}`, service.url_begin, 600, 900)
                    .then(() => true).catch(err => { console.warn(err); return false; });
            ...
            async function requestDangerToken(type, service) {
                ...
                const result = await (0, Popup_4.default)(`Re-authenticate Using ${service.name}`, `${Env_10.default.API_ORIGIN}danger-token/request/${type}/${service.id}/begin`, 600, 900)
                    .then(() => true).catch(err => { console.warn(err); return false; });
...
define("ui/utility/PageListener", ["require", "exports", "utility/State"], function (require, exports, State_62) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_62 = __importDefault(State_62);
    var PageListener;
    (function (PageListener) {
        PageListener.visible = (0, State_62.default)(document.visibilityState === 'visible');
...
define("model/Manifest", ["require", "exports", "model/Session", "ui/utility/PageListener", "utility/State", "utility/Time"], function (require, exports, Session_26, PageListener_1, State_63, Time_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Manifest(definition) {
        ...
        const state = (0, State_63.default)(undefined, false);
        manifestStore();
        const result = Object.assign(state, {
            ...
            async getManifest(force) {
                ...
                if (!force && result.isFresh(state.value))
                    return state.value;
                if (definition.requiresAuthor && !Session_26.default.Auth.loggedIn.value)
                    return undefined;
        ...
        if (definition.refresh)
            ...
            setInterval(async () => {
                ...
                if (Date.now() - lastFetchAttempt < Time_10.default.seconds(60))
                    return;
...
define("ui/view/shared/component/ViewContainer", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Dialog", "ui/component/core/Loading", "ui/view/AccountView", "ui/view/ErrorView", "ui/view/RequireLoginView", "ui/view/shared/ext/ViewTransition", "utility/State"], function (require, exports, Session_27, Component_78, Button_32, Dialog_3, Loading_2, AccountView_3, ErrorView_1, RequireLoginView_1, ViewTransition_5, State_64) {
    ...
    const ViewContainer = () => {
        let cancelLogin;
        const state = (0, State_64.default)(undefined);
