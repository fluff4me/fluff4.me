...
define("ui/component/core/Slot", ["require", "exports", "ui/Component", "utility/State"], function (require, exports, Component_10, State_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/utility/StringApplicator", ["require", "exports", "lang/en-nz", "utility/State"], function (require, exports, en_nz_1, State_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function StringApplicator(host, defaultValueOrApply, apply) {
        ...
        let unbind;
        const result = {
            state: (0, State_7.default)(defaultValue),
            set: value => {
                unbind?.();
...
define("ui/component/core/ext/Input", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Popover", "ui/component/core/Slot", "ui/utility/StringApplicator", "utility/State"], function (require, exports, Component_11, Block_1, Popover_1, Slot_1, StringApplicator_1, State_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Input = Component_11.default.Extension((component) => {
        const hintText = (0, State_8.default)(undefined);
        const maxLength = (0, State_8.default)(undefined);
        const length = (0, State_8.default)(undefined);
        const unusedPercent = State_8.default.MapManual([length, maxLength], (length, maxLength) => length === undefined || !maxLength ? undefined : 1 - length / maxLength);
        const unusedChars = State_8.default.MapManual([length, maxLength], (length, maxLength) => length === undefined || !maxLength ? undefined : maxLength - length);
        const hasPopover = State_8.default.MapManual([hintText, maxLength], (hintText, maxLength) => !!hintText || !!maxLength);
        let popover;
        hasPopover.subscribeManual(hasPopover => {
            ...
            popover = (0, Popover_1.default)()
                ...
                .anchor.add("off right", `.\\${Block_1.BlockClasses.Main}`, "centre")
...
define("ui/component/core/Form", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Block", "ui/component/core/Button", "utility/State"], function (require, exports, Component_12, ActionRow_2, Block_2, Button_2, State_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Form = Component_12.default.Builder((form, label) => {
        ...
        const valid = State_9.default.Generator(() => form.element.checkValidity());
...
define("ui/component/core/Label", ["require", "exports", "ui/Component", "ui/component/core/Form", "ui/view/shared/component/View", "utility/State"], function (require, exports, Component_14, Form_1, View_1, State_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Label = Component_14.default.Builder("label", (label) => {
        ...
        return label
            .extend(label => ({
            for: (0, State_10.default)(undefined),
            setFor: inputName => {
...
define("ui/utility/AnchorManipulator", ["require", "exports", "ui/utility/Mouse", "ui/utility/Viewport"], function (require, exports, Mouse_3, Viewport_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/utility/TextManipulator", ["require", "exports", "ui/utility/StringApplicator"], function (require, exports, StringApplicator_3) {
    ...
    function TextManipulator(component) {
        return (0, StringApplicator_3.default)(component, value => {
...
define("ui/Component", ["require", "exports", "ui/utility/AnchorManipulator", "ui/utility/AttributeManipulator", "ui/utility/ClassManipulator", "ui/utility/EventManipulator", "ui/utility/FocusListener", "ui/utility/StringApplicator", "ui/utility/StyleManipulator", "ui/utility/TextManipulator", "ui/utility/Viewport", "utility/Define", "utility/Env", "utility/Errors", "utility/State", "utility/string/Strings"], function (require, exports, AnchorManipulator_1, AttributeManipulator_1, ClassManipulator_1, EventManipulator_1, FocusListener_2, StringApplicator_4, StyleManipulator_1, TextManipulator_1, Viewport_2, Define_3, Env_2, Errors_1, State_12, Strings_3) {
    ...
    function Component(type = "span") {
        ...
        let component = {
            ...
            get anchor() {
                return Define_3.default.set(component, "anchor", (0, AnchorManipulator_1.default)(component));
            },
            get hovered() {
...
define("ui/Announcer", ["require", "exports", "ui/Component"], function (require, exports, Component_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_23 = __importDefault(Component_23);
    var Announcer;
    (function (Announcer) {
        const assertive = (0, Component_23.default)()
            ...
            .appendTo(document.body);
        const polite = (0, Component_23.default)()
        ...
        function announceInternal(within, id, announcer) {
            ...
            announcer(keyOrHandler => {
                components.push((0, Component_23.default)("p")
...
define("ui/component/core/RadioButton", ["require", "exports", "ui/Component", "ui/component/core/Checkbutton"], function (require, exports, Component_24, Checkbutton_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_24 = __importDefault(Component_24);
    Checkbutton_2 = __importDefault(Checkbutton_2);
    exports.default = Component_24.default.Builder(() => {
...
define("ui/view/shared/ext/ViewTransition", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_25, Arrays_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (ViewTransition) {
        ...
        const PADDING = 100;
        Component_25.default.extend(component => component.extend(component => ({
            viewTransition(name) {
                if (name) {
...
define("ui/component/core/TextEditor", ["require", "exports", "lang/en-nz", "markdown-it", "model/Session", "prosemirror-commands", "prosemirror-dropcursor", "prosemirror-example-setup", "prosemirror-gapcursor", "prosemirror-history", "prosemirror-inputrules", "prosemirror-keymap", "prosemirror-markdown", "prosemirror-model", "prosemirror-schema-list", "prosemirror-state", "prosemirror-transform", "prosemirror-view", "ui/Announcer", "ui/Component", "ui/component/core/Button", "ui/component/core/Checkbutton", "ui/component/core/Dialog", "ui/component/core/ext/Input", "ui/component/core/Popover", "ui/component/core/RadioButton", "ui/component/core/Slot", "ui/utility/StringApplicator", "ui/utility/Viewport", "ui/view/shared/ext/ViewTransition", "utility/Arrays", "utility/Define", "utility/Objects", "utility/State", "utility/Store", "utility/string/MarkdownItHTML", "utility/Time", "w3c-keyname"], function (require, exports, en_nz_3, markdown_it_2, Session_4, prosemirror_commands_1, prosemirror_dropcursor_1, prosemirror_example_setup_1, prosemirror_gapcursor_1, prosemirror_history_1, prosemirror_inputrules_1, prosemirror_keymap_1, prosemirror_markdown_1, prosemirror_model_1, prosemirror_schema_list_1, prosemirror_state_1, prosemirror_transform_1, prosemirror_view_1, Announcer_1, Component_26, Button_5, Checkbutton_3, Dialog_2, Input_1, Popover_2, RadioButton_1, Slot_2, StringApplicator_5, Viewport_3, ViewTransition_1, Arrays_4, Define_4, Objects_3, State_19, Store_3, MarkdownItHTML_2, Time_4, w3c_keyname_1) {
    ...
    const schema = new prosemirror_model_1.Schema({
        nodes: Objects_3.default.filterNullish({
            ...
            heading: {
                ...
                content: "text*",
                toDOM(node) {
                    const heading = (0, Component_26.default)(`h${node.attrs.level}`);
    ...
    let globalid = 0;
    const TextEditor = Component_26.default.Builder((component) => {
        const id = globalid++;
        const isMarkdown = (0, State_19.default)(false);
        const content = (0, State_19.default)("");
        const isFullscreen = (0, State_19.default)(false);
        // eslint-disable-next-line prefer-const
        let editor;
        ...
        ////////////////////////////////////
        //#region Types
        const ToolbarButtonTypeMark = Component_26.default.Extension((component, type) => {
        ...
        const ToolbarButtonTypeNode = Component_26.default.Extension((component, type) => {
        ...
        const ToolbarButtonTypeOther = Component_26.default.Extension((component, type) => {
            return component
                .style(`text-editor-toolbar-${type}`)
                .ariaLabel.use(`component/text-editor/toolbar/button/${type}`);
        });
        ...
        ////////////////////////////////////
        //#region Components
        const ToolbarButtonGroup = Component_26.default.Builder(component => component
            .ariaRole("group")
            .style("text-editor-toolbar-button-group"));
        const ToolbarButton = Component_26.default.Builder((_, handler) => {
        ...
        const ToolbarCheckbutton = Component_26.default.Builder((_, state, toggler) => {
        ...
        const ToolbarRadioButton = Component_26.default.Builder((_, name, state, toggler) => {
        ...
        const ToolbarButtonPopover = Component_26.default.Builder((_, align) => {
            return (0, Button_5.default)()
        ...
        ////////////////////////////////////
        //#region Specifics
        const ToolbarButtonMark = Component_26.default.Builder((_, type) => {
            const mark = schema.marks[type];
        ...
        const ToolbarButtonAlign = Component_26.default.Builder((_, align) => {
        ...
        const ToolbarButtonBlockType = Component_26.default.Builder((_, type) => {
            const node = schema.nodes[type.replaceAll("-", "_")];
        ...
        const ToolbarButtonHeading = Component_26.default.Builder((_, level) => {
        ...
        const ToolbarButtonWrap = Component_26.default.Builder((_, type) => ToolbarButton(wrapper(schema.nodes[type.replaceAll("-", "_")]))
            .and(ToolbarButtonTypeNode, type));
        const ToolbarButtonList = Component_26.default.Builder((_, type) => ToolbarButton(listWrapper(schema.nodes[type.replaceAll("-", "_")]))
            .and(ToolbarButtonTypeNode, type));
        //#endregion
        ...
        const actualEditor = (0, Component_26.default)()
            .subviewTransition(viewTransitionName)
            .style("text-editor")
            .style.bind(isFullscreen, "text-editor--fullscreen")
            .event.subscribe("click", event => {
            const target = Component_26.default.get(event.target);
        ...
        editor = (0, Slot_2.default)()
            ...
            .append(actualEditor)
            .extend(editor => ({
            default: (0, StringApplicator_5.default)(editor, value => loadFromMarkdown(value)),
            toolbar,
            setRequired(required = true) {
        ...
        const contentWidth = State_19.default.Generator(() => `${editor.document?.element.scrollWidth ?? 0}px`)
            .observe(component, state, Viewport_3.default.size);
        const scrollbarProxy = (0, Component_26.default)()
            ...
            .appendTo(actualEditor);
        const fullscreenContentWidth = State_19.default.Generator(() => `${documentSlot.element.scrollWidth ?? 0}px`)
            .observe(component, state, Viewport_3.default.size);
        ...
        function createDefaultView(slot) {
            ...
            editor.mirror = view;
            editor.document = (0, Component_26.default)()
                .and(Input_1.default)
...
define("ui/component/core/TextInput", ["require", "exports", "ui/Component", "ui/component/core/ext/Input", "ui/utility/StringApplicator", "utility/State"], function (require, exports, Component_27, Input_2, StringApplicator_6, State_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const TextInput = Component_27.default.Builder("input", (component) => {
...
define("ui/view/account/AccountViewForm", ["require", "exports", "endpoint/author/EndpointAuthorCreate", "endpoint/author/EndpointAuthorUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/TextEditor", "ui/component/core/TextInput"], function (require, exports, EndpointAuthorCreate_1, EndpointAuthorUpdate_1, en_nz_4, FormInputLengths_1, Session_5, Component_28, Block_5, Form_2, LabelledTable_1, TextEditor_1, TextInput_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = Component_28.default.Builder((component, type) => {
...
define("ui/component/Author", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Slot"], function (require, exports, Component_29, Block_6, Slot_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_29 = __importDefault(Component_29);
    Block_6 = __importDefault(Block_6);
    Slot_4 = __importDefault(Slot_4);
    exports.default = Component_29.default.Builder((component, author) => {
        component
...
define("ui/component/core/Link", ["require", "exports", "ui/Component", "utility/Env"], function (require, exports, Component_30, Env_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_30 = __importDefault(Component_30);
    Env_4 = __importDefault(Env_4);
    const Link = Component_30.default.Builder("a", (component, route) => {
...
define("ui/component/core/Paginator", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/State"], function (require, exports, Component_31, Block_7, Button_7, Slot_5, State_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Paginator = Component_31.default.Builder((component) => {
        ...
        let pageContent = [];
        let pages = [];
        const cursor = (0, State_22.default)(0);
...
define("model/Tags", ["require", "exports", "endpoint/tag/EndpointTagManifest", "model/Manifest"], function (require, exports, EndpointTagManifest_1, Manifest_2) {
    ...
    const Tags = Object.assign((0, Manifest_2.default)({
        get() {
            return EndpointTagManifest_1.default.query();
        },
    }), { resolve });
...
define("ui/component/core/TextLabel", ["require", "exports", "ui/Component"], function (require, exports, Component_32) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_32 = __importDefault(Component_32);
    const TextLabel = Component_32.default.Builder((component) => {
        component.style("text-label");
        const label = (0, Component_32.default)()
            .style("text-label-label");
        const punctuation = (0, Component_32.default)()
            .style("text-label-punctuation")
            .text.set(": ");
        const content = (0, Component_32.default)()
...
define("ui/component/core/Timestamp", ["require", "exports", "ui/Component", "utility/State", "utility/Time"], function (require, exports, Component_33, State_23, Time_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_33 = __importDefault(Component_33);
    State_23 = __importDefault(State_23);
    Time_5 = __importDefault(Time_5);
    const Timestamp = Component_33.default.Builder((component, time) => {
        const state = (0, State_23.default)(new Date(time ?? Date.now()));
        ...
        return component
            ...
            .onRooted(component => {
            update();
            const interval = setInterval(update, Time_5.default.seconds(1));
            component.event.subscribe("remove", () => clearInterval(interval));
        });
        function update() {
            component.text.set(Time_5.default.relative(state.value.getTime(), { components: 2, secondsExclusive: true }));
        }
    });
    exports.default = Timestamp;
});
define("ui/component/Tag", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Link"], function (require, exports, Component_34, Button_8, Link_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Tag = Component_34.default.Builder("a", (component, tag) => {
        component
            .and(Link_1.default, `/tag/${toURL(tag.category)}/${toURL(tag.name)}`)
...
define("ui/component/Work", ["require", "exports", "model/Session", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/core/TextLabel", "ui/component/core/Timestamp", "ui/component/Tag"], function (require, exports, Session_7, Tags_1, Component_35, Block_8, Button_9, Link_2, Slot_6, TextLabel_1, Timestamp_1, Tag_1) {
    ...
    const Work = Component_35.default.Builder(async (component, work, author) => {
        ...
        (0, Slot_6.default)()
            ...
            .appendTo(block.content);
        let tagsWrapper;
        const tags = await Tags_1.default.resolve(work.global_tags);
        for (const tag of tags) {
            (0, Tag_1.default)(tag)
                .appendTo(tagsWrapper ??= (0, Component_35.default)()
                .style("work-tags")
                .appendTo(block.content));
        }
        ...
        create: async (params) => {
            ...
            await paginator.useEndpoint(worksQuery, async (slot, works) => {
                for (const workData of works) {
                    const work = await (0, Link_3.default)(`/work/${author.data.vanity}/${workData.vanity}`)
            ...
            paginator.orElse(slot => (0, Component_36.default)()
                .style("placeholder")
...
define("ui/view/chapter/ChapterEditForm", ["require", "exports", "endpoint/chapter/EndpointChapterCreate", "endpoint/chapter/EndpointChapterUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/TextEditor", "ui/component/core/TextInput"], function (require, exports, EndpointChapterCreate_1, EndpointChapterUpdate_1, en_nz_5, FormInputLengths_2, Session_9, Component_37, Block_9, Form_3, LabelledTable_2, TextEditor_2, TextInput_2) {
    ...
    exports.default = Component_37.default.Builder((component, state, workParams) => {
        ...
        const nameInput = (0, TextInput_2.default)()
            .setRequired()
    ...
    exports.default = (0, ViewDefinition_3.default)({
        ...
        create: async (params) => {
            ...
            if (chapter instanceof Error)
                throw chapter;
            const state = (0, State_24.default)(chapter?.data);
            const stateInternal = (0, State_24.default)(chapter?.data);
            (0, Slot_8.default)()
...
define("ui/view/shared/component/PaginatedView", ["require", "exports", "ui/Component", "ui/component/core/Paginator", "ui/view/shared/component/View"], function (require, exports, Component_38, Paginator_2, View_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_38 = __importDefault(Component_38);
    Paginator_2 = __importDefault(Paginator_2);
    View_5 = __importDefault(View_5);
    const PaginatedView = Component_38.default.Builder((_, id) => {
        let paginator;
        const urls = [];
...
define("ui/view/ChapterView", ["require", "exports", "endpoint/chapter/EndpointChapterGet", "endpoint/chapter/EndpointChapterGetPaged", "endpoint/work/EndpointWorkGet", "lang/en-nz", "ui/component/Work", "ui/view/shared/component/PaginatedView", "ui/view/shared/component/ViewDefinition", "utility/maths/Maths", "utility/State"], function (require, exports, EndpointChapterGet_2, EndpointChapterGetPaged_1, EndpointWorkGet_1, en_nz_6, Work_2, PaginatedView_1, ViewDefinition_4, Maths_1, State_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_4.default)({
        create: async (params) => {
            ...
            const work = await (0, Work_2.default)(workData, author);
            work
            ...
            const chapterState = (0, State_25.default)(initialChapterResponse.data);
...
define("ui/view/DebugView", ["require", "exports", "endpoint/auth/EndpointAuthServices", "model/Session", "ui/Component", "ui/component/core/Button", "ui/view/debug/ButtonRegistry", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Env", "utility/Objects", "utility/Popup"], function (require, exports, EndpointAuthServices_2, Session_11, Component_39, Button_12, ButtonRegistry_1, View_6, ViewDefinition_5, Env_6, Objects_4, Popup_2) {
    ...
    const Block = Component_39.default.Builder(component => component
        .style("debug-block"));
        ...
        async create() {
            ...
            profileButtons.append(createButton({
                ...
                async execute() {
                    ...
                    await ButtonRegistry_1.BUTTON_REGISTRY.createWork.execute("one big work", "made by <mention vanity=\"justonestory\">", "wow description", "bigstory", "Ongoing", "Public");
            ...
            profileButtons.append(createButton({
                ...
                async execute() {
                    await ButtonRegistry_1.BUTTON_REGISTRY.patreonSetThresholds.execute("justonestory", "bigstory", "Patreon", ["8", "9"], "4392761");
                },
            }));
...
define("ui/view/HomeView", ["require", "exports", "markdown-it", "ui/Component", "ui/component/core/Block", "ui/component/core/TextEditor", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Env", "utility/string/MarkdownItHTML"], function (require, exports, markdown_it_3, Component_40, Block_10, TextEditor_3, View_7, ViewDefinition_6, Env_7, MarkdownItHTML_3) {
    ...
    exports.default = (0, ViewDefinition_6.default)({
        create: () => {
            const view = (0, View_7.default)("home");
            ...
            if (Env_7.default.isDev) {
                (0, Component_40.default)("br").appendTo(block.content);
                const output = (0, Component_40.default)("div");
                (0, Component_40.default)("div")
...
define("ui/view/TagView", ["require", "exports", "model/Tags", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Errors"], function (require, exports, Tags_2, View_8, ViewDefinition_7, Errors_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_7.default)({
        create: async (params) => {
            const view = (0, View_8.default)("tag");
            const tag = await Tags_2.default.resolve(fromURL(params.category), fromURL(params.name));
            if (!tag)
...
define("endpoint/work/EndpointWorkCreate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_17 = __importDefault(Endpoint_17);
    exports.default = (0, Endpoint_17.default)("/work/create", "post");
});
define("endpoint/work/EndpointWorkUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_18 = __importDefault(Endpoint_18);
    exports.default = (0, Endpoint_18.default)("/work/{author}/{vanity}/update", "post");
});
define("ui/component/core/Textarea", ["require", "exports", "ui/Component", "ui/component/core/ext/Input", "ui/utility/StringApplicator", "utility/State"], function (require, exports, Component_41, Input_3, StringApplicator_7, State_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Textarea = Component_41.default.Builder((component) => {
        let shouldIgnoreInputEvent = false;
        const input = component
            .and(Input_3.default)
...
define("ui/view/work/WorkEditForm", ["require", "exports", "endpoint/work/EndpointWorkCreate", "endpoint/work/EndpointWorkUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/Textarea", "ui/component/core/TextEditor", "ui/component/core/TextInput"], function (require, exports, EndpointWorkCreate_1, EndpointWorkUpdate_1, en_nz_7, FormInputLengths_3, Session_12, Component_42, Block_11, Form_4, LabelledTable_3, Textarea_1, TextEditor_4, TextInput_3) {
    ...
    exports.default = Component_42.default.Builder((component, state) => {
        ...
        table.label(label => label.text.use("view/work-edit/shared/form/name/label"))
            .content((content, label) => content.append(nameInput.setLabel(label)));
        const vanityInput = (0, TextInput_3.default)()
            .placeholder.bind(nameInput.state
            .map(component, name => filterVanity(name)))
...
define("ui/view/WorkEditView", ["require", "exports", "endpoint/work/EndpointWorkGet", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/Slot", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "ui/view/work/WorkEditForm", "utility/State"], function (require, exports, EndpointWorkGet_2, ActionRow_5, Button_13, Slot_9, View_9, ViewDefinition_8, ViewTransition_4, WorkEditForm_1, State_27) {
    ...
    exports.default = (0, ViewDefinition_8.default)({
        ...
        create: async (params) => {
            const id = "work-edit";
            const view = (0, View_9.default)(id);
            const work = params && await EndpointWorkGet_2.default.query({ params });
            if (work instanceof Error)
                throw work;
            const state = (0, State_27.default)(work?.data);
            const stateInternal = (0, State_27.default)(work?.data);
            (0, Slot_9.default)()
...
define("endpoint/chapter/EndpointChapterGetAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_19) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_19 = __importDefault(Endpoint_19);
    exports.default = (0, Endpoint_19.default)("/work/{author}/{vanity}/chapters/list", "get");
});
define("ui/component/Chapter", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/ext/CanHasActionsMenuButton", "ui/component/core/Link", "ui/component/core/Timestamp", "utility/maths/Maths"], function (require, exports, Session_13, Component_43, Button_14, CanHasActionsMenuButton_2, Link_4, Timestamp_2, Maths_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Chapter = Component_43.default.Builder((component, chapter, work, author) => {
        component = (0, Link_4.default)(`/work/${author.vanity}/${work.vanity}/chapter/${chapter.url}`)
            .style("chapter");
        const chapterNumber = Maths_2.default.parseIntOrUndefined(chapter.url);
        const number = (0, Component_43.default)()
            .style("chapter-number")
            .text.set(chapterNumber ? `${chapterNumber.toLocaleString()}` : "")
            .appendTo(component);
        const chapterName = (0, Component_43.default)()
            .style("chapter-name")
            .text.set(chapter.name)
            .appendTo(component);
        const right = (0, Component_43.default)()
            .style("chapter-right")
            .appendTo(component);
...
define("ui/view/WorkView", ["require", "exports", "endpoint/chapter/EndpointChapterGetAll", "endpoint/work/EndpointWorkGet", "model/Session", "ui/Component", "ui/component/Chapter", "ui/component/core/Button", "ui/component/core/Paginator", "ui/component/core/Slot", "ui/component/Work", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Errors"], function (require, exports, EndpointChapterGetAll_1, EndpointWorkGet_3, Session_14, Component_44, Chapter_1, Button_15, Paginator_3, Slot_10, Work_3, View_10, ViewDefinition_9, Errors_3) {
    ...
    exports.default = (0, ViewDefinition_9.default)({
        create: async (params) => {
            const view = (0, View_10.default)("work");
            ...
            const work = await (0, Work_3.default)(workData, authorData);
            work
                .viewTransition("work-view-work")
                .setContainsHeading()
                .appendTo(view);
            const paginator = (0, Paginator_3.default)()
                ...
                .tweak(p => p.primaryActions.append((0, Slot_10.default)()
...
define("navigation/Routes", ["require", "exports", "navigation/Route", "ui/view/AccountView", "ui/view/AuthorView", "ui/view/ChapterEditView", "ui/view/ChapterView", "ui/view/DebugView", "ui/view/HomeView", "ui/view/TagView", "ui/view/WorkEditView", "ui/view/WorkView"], function (require, exports, Route_1, AccountView_1, AuthorView_1, ChapterEditView_1, ChapterView_1, DebugView_1, HomeView_1, TagView_1, WorkEditView_1, WorkView_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/view/ErrorView", ["require", "exports", "lang/en-nz", "ui/component/core/Heading", "ui/component/core/Paragraph", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, en_nz_8, Heading_2, Paragraph_3, View_11, ViewDefinition_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_10.default)({
        create: (params) => {
            const view = (0, View_11.default)("error");
...
define("ui/view/RequireLoginView", ["require", "exports", "ui/component/core/ActionRow", "ui/component/core/Block", "ui/component/core/Button", "ui/view/AccountView", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, ActionRow_6, Block_12, Button_16, AccountView_2, View_12, ViewDefinition_11) {
    ...
    exports.default = (0, ViewDefinition_11.default)({
        create: () => {
            const view = (0, View_12.default)("require-login");
...
define("ui/view/shared/component/ViewContainer", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Dialog", "ui/view/AccountView", "ui/view/ErrorView", "ui/view/RequireLoginView", "ui/view/shared/ext/ViewTransition"], function (require, exports, Session_15, Component_45, Button_17, Dialog_3, AccountView_3, ErrorView_1, RequireLoginView_1, ViewTransition_5) {
    ...
    const ViewContainer = () => {
        let cancelLogin;
        const container = (0, Component_45.default)()
...
define("navigation/Navigate", ["require", "exports", "navigation/Routes", "ui/view/ErrorView", "utility/Env"], function (require, exports, Routes_1, ErrorView_2, Env_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        const navigate = {
            ...
            setURL: (url) => {
                if (url !== location.pathname)
                    history.pushState({}, "", `${Env_8.default.URL_ORIGIN}${url.slice(1)}`);
            },
            toRawURL: (url) => {
...
define("ui/component/masthead/Flag", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_46, Arrays_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_46 = __importDefault(Component_46);
    Arrays_5 = __importDefault(Arrays_5);
    const Flag = Component_46.default.Builder((component) => {
        const stripes = Arrays_5.default.range(5)
            .map(i => (0, Component_46.default)()
...
define("ui/component/PrimaryNav", ["require", "exports", "ui/Component"], function (require, exports, Component_47) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_47 = __importDefault(Component_47);
    exports.default = Component_47.default.Builder(nav => {
        // Heading()
        // 	.text.set("hi")
        // 	.appendTo(nav)
        return nav;
...
define("ui/component/Sidebar", ["require", "exports", "ui/Component", "ui/component/core/Button", "utility/Env", "utility/Store"], function (require, exports, Component_48, Button_18, Env_9, Store_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Sidebar = Component_48.default.Builder("nav", (sidebar) => {
        sidebar.style("sidebar")
            .ariaLabel.use("masthead/primary-nav/alt");
        if (Env_9.default.ENVIRONMENT === "dev")
            (0, Button_18.default)()
                .text.set("Debug")
...
define("ui/component/Masthead", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/masthead/Flag", "ui/component/PrimaryNav", "ui/component/Sidebar", "ui/utility/Viewport", "utility/Env", "utility/Task"], function (require, exports, Session_16, Component_49, Button_19, Link_5, Slot_11, Flag_1, PrimaryNav_1, Sidebar_1, Viewport_4, Env_10, Task_3) {
    ...
    const Masthead = Component_49.default.Builder("header", (masthead, view) => {
        ...
        (0, Button_19.default)()
            ...
            .appendTo(masthead);
        let popover;
        const left = (0, Component_49.default)()
        ...
        const homeLink = (0, Link_5.default)("/")
            ...
            .append(flag)
            .append((0, Component_49.default)("img")
            .style("masthead-home-logo-wordmark")
            .ariaHidden()
            .attributes.set("src", `${Env_10.default.URL_ORIGIN}image/logo-wordmark.svg`)))
            .appendTo(left);
...
define("App", ["require", "exports", "lang/en-nz", "model/FormInputLengths", "model/Session", "navigation/Navigate", "style", "ui/Component", "ui/component/Masthead", "ui/InputBus", "ui/utility/FocusListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/Viewport", "ui/view/shared/component/ViewContainer", "utility/Async", "utility/Env", "utility/Store", "utility/Time"], function (require, exports, en_nz_9, FormInputLengths_4, Session_17, Navigate_1, style_2, Component_50, Masthead_1, InputBus_2, FocusListener_3, HoverListener_2, Mouse_4, Viewport_5, ViewContainer_1, Async_2, Env_11, Store_5, Time_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    async function App() {
        ...
        await Promise.race([
            ...
            Async_2.default.sleep(Time_6.default.seconds(2)),
        ]);
        ...
        const related = (0, Component_50.default)()
            .style("app-content-related");
        const content = (0, Component_50.default)()
            .style("app-content")
            .append(view, related);
        const app = (0, Component_50.default)()
            .style("app")
...
define("index", ["require", "exports", "utility/Arrays", "utility/DOMRect", "utility/Elements", "browser-source-map-support"], function (require, exports, Arrays_6, DOMRect_1, Elements_1, browser_source_map_support_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    void new Promise((resolve_1, reject_1) => { require(["App"], resolve_1, reject_1); }).then(__importStar).then(app => app.default());
});
define("ui/component/core/ActionHeading", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Heading"], function (require, exports, Component_51, ActionRow_7, Heading_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_51 = __importDefault(Component_51);
    ActionRow_7 = __importDefault(ActionRow_7);
    Heading_3 = __importDefault(Heading_3);
    const ActionHeading = Component_51.default.Builder((component) => {
