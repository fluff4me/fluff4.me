...
define("ui/component/core/Link", ["require", "exports", "ui/Component", "utility/Env"], function (require, exports, Component_21, Env_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Link = Component_21.default.Builder("a", (component, route) => {
...
define("ui/component/masthead/Flag", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_22, Arrays_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Flag = Component_22.default.Builder((component) => {
        const stripes = Arrays_3.default.range(5)
            .map(i => (0, Component_22.default)()
...
define("ui/component/Sidebar", ["require", "exports", "ui/Component", "utility/Store"], function (require, exports, Component_23, Store_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Sidebar = Component_23.default.Builder("nav", (sidebar) => {
...
define("ui/ViewContainer", ["require", "exports", "ui/Component", "ui/view/component/ViewTransition", "ui/view/ErrorView"], function (require, exports, Component_24, ViewTransition_5, ErrorView_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const ViewContainer = () => (0, Component_24.default)()
...
define("ui/component/Masthead", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Heading", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/masthead/Flag", "utility/Env"], function (require, exports, Session_6, Component_25, Button_5, Heading_3, Link_1, Slot_2, Flag_1, Env_6) {
    ...
    const Masthead = Component_25.default.Builder("header", (masthead, sidebar, view) => {
        ...
        (0, Button_5.default)()
            ...
            .appendTo(masthead);
        const left = (0, Component_25.default)()
            .append((0, Component_25.default)()
        ...
        const homeLink = (0, Link_1.default)("/")
            ...
            .style("masthead-home")
            .append(flag)
            .append((0, Component_25.default)("img")
...
define("App", ["require", "exports", "lang/en-nz", "model/Session", "navigation/Navigate", "style", "ui/Component", "ui/component/Masthead", "ui/component/Sidebar", "ui/UiEventBus", "ui/utility/FocusListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/Viewport", "ui/ViewContainer", "utility/Env", "utility/Store"], function (require, exports, en_nz_5, Session_7, Navigate_1, style_2, Component_26, Masthead_1, Sidebar_1, UiEventBus_1, FocusListener_2, HoverListener_1, Mouse_3, Viewport_2, ViewContainer_1, Env_7, Store_4) {
    ...
    async function App() {
        ...
        const related = (0, Component_26.default)()
            .style("app-content-related");
        const content = (0, Component_26.default)()
            .style("app-content")
            .append(view, related);
        const app = (0, Component_26.default)()
            .style("app")
...
define("ui/component/core/Popover", ["require", "exports", "ui/Component", "ui/utility/Mouse", "utility/Task"], function (require, exports, Component_27, Mouse_4, Task_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const FOCUS_TRAP = (0, Component_27.default)()
        .tabIndex("auto")
        .ariaHidden()
        .style.setProperty("display", "none")
        .prependTo(document.body);
    Component_27.default.extend(component => {
    ...
    const Popover = Component_27.default.Builder((popover) => {
        let unbind;
        return popover
            .style("popover")
            .tabIndex("programmatic")
