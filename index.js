...
define("ui/utility/Viewport", ["require", "exports", "utility/State"], function (require, exports, State_2) {
    ...
    var Viewport;
    (function (Viewport) {
        const jit = State_2.default.JIT(() => ({ w: window.innerWidth, h: window.innerHeight }));
        Viewport.size = jit;
        function listen() {
                    ...
                    for (const preference of locationPreference) {
                        ...
                        if (!xConf.sticky && tooltipBox.width < Viewport_1.default.size.value.w) {
                            const isXOffScreen = x - (alignment === "right" ? tooltipBox.width : 0) < 0
                                || x + (alignment === "right" ? 0 : tooltipBox.width - 10) > Viewport_1.default.size.value.w;
                            if (isXOffScreen) {
                                continue;
                            }
                        }
...
define("ui/Component", ["require", "exports", "ui/utility/AnchorManipulator", "ui/utility/AttributeManipulator", "ui/utility/ClassManipulator", "ui/utility/EventManipulator", "ui/utility/FocusListener", "ui/utility/StyleManipulator", "ui/utility/TextManipulator", "utility/Define", "utility/Errors", "utility/State"], function (require, exports, AnchorManipulator_1, AttributeManipulator_1, ClassManipulator_1, EventManipulator_1, FocusListener_1, StyleManipulator_1, TextManipulator_2, Define_2, Errors_1, State_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/LabelledRow", ["require", "exports", "ui/Component", "ui/component/core/Label", "ui/view/component/ViewTransition"], function (require, exports, Component_11, Label_1, ViewTransition_2) {
    ...
    const LabelledRow = Component_11.default.Builder((row) => {
        ...
        let label = (0, Label_1.AutoLabel)().appendTo(row);
...
define("ui/view/AuthorView", ["require", "exports", "ui/view/View", "ui/view/ViewDefinition"], function (require, exports, View_2, ViewDefinition_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/view/HomeView", ["require", "exports", "ui/view/View", "ui/view/ViewDefinition"], function (require, exports, View_4, ViewDefinition_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/Link", ["require", "exports", "ui/Component", "utility/Env"], function (require, exports, Component_20, Env_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Link = Component_20.default.Builder("a", (component, route) => {
...
define("ui/component/masthead/Flag", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_21, Arrays_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Flag = Component_21.default.Builder((component) => {
        const stripes = Arrays_3.default.range(5)
            .map(i => (0, Component_21.default)()
...
define("ui/component/Sidebar", ["require", "exports", "ui/Component", "utility/Store"], function (require, exports, Component_22, Store_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Sidebar = Component_22.default.Builder("nav", (sidebar) => {
...
define("ui/ViewContainer", ["require", "exports", "ui/Component", "ui/view/component/ViewTransition"], function (require, exports, Component_23, ViewTransition_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const ViewContainer = () => (0, Component_23.default)()
...
define("ui/component/Masthead", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Heading", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/masthead/Flag", "utility/Env"], function (require, exports, Session_6, Component_24, Button_5, Heading_3, Link_1, Slot_2, Flag_1, Env_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Masthead = Component_24.default.Builder("header", (masthead, sidebar, view) => {
        ...
        (0, Button_5.default)()
            ...
            .appendTo(masthead);
        const left = (0, Component_24.default)()
            .append((0, Component_24.default)()
            .and(Button_5.default)
        ...
        const homeLink = (0, Link_1.default)("/")
            ...
            .style("masthead-home")
            .append(flag)
            .append((0, Component_24.default)("img")
        ...
        (0, Component_24.default)()
            .style("masthead-search")
            .appendTo(masthead);
        (0, Component_24.default)()
            .style("masthead-user")
            .append((0, Button_5.default)()
...
define("App", ["require", "exports", "lang/en-nz", "model/Session", "navigation/Navigate", "style", "ui/Component", "ui/component/Masthead", "ui/component/Sidebar", "ui/UiEventBus", "ui/utility/FocusListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/Viewport", "ui/ViewContainer", "utility/Env", "utility/Store"], function (require, exports, en_nz_5, Session_7, Navigate_1, style_2, Component_25, Masthead_1, Sidebar_1, UiEventBus_1, FocusListener_2, HoverListener_1, Mouse_3, Viewport_2, ViewContainer_1, Env_7, Store_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    async function App() {
        ...
        Mouse_3.default.listen();
        Viewport_2.default.listen();
        ...
        const masthead = (0, Masthead_1.default)(sidebar, view);
        const related = (0, Component_25.default)()
            .style("app-content-related");
        const content = (0, Component_25.default)()
            .style("app-content")
            .append(view, related);
        const app = (0, Component_25.default)()
            .style("app")
...
define("index", ["require", "exports", "App", "utility/Arrays", "utility/DOMRect", "utility/Elements"], function (require, exports, App_1, Arrays_4, DOMRect_1, Elements_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (0, DOMRect_1.default)();
    Arrays_4.default.applyPrototypes();
...
define("ui/component/core/Popover", ["require", "exports", "ui/Component", "ui/utility/Mouse", "utility/Task"], function (require, exports, Component_26, Mouse_4, Task_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const FOCUS_TRAP = (0, Component_26.default)()
        .tabIndex("auto")
        .ariaHidden()
        .style.setProperty("display", "none")
        .prependTo(document.body);
    Component_26.default.extend(component => {
            ...
            popover: (event, initialiser) => {
                ...
                const popover = Popover()
                    ...
                    if (event.newState === "closed") {
                        isShown = false;
                        clickState = false;
                        Mouse_4.default.offMove(updatePopoverState);
                    }
                })
                    .appendTo(document.body);
                if (event === "hover")
                ...
                async function updatePopoverState() {
                    const shouldShow = false
                        ...
                        || (isShown && popover.rect.value.expand(100).intersects(Mouse_4.default.state.value))
                        || clickState;
                    if (component.hoveredOrFocused.value && !isShown)
                        Mouse_4.default.onMove(updatePopoverState);
                    if (!shouldShow)
                        Mouse_4.default.offMove(updatePopoverState);
                    if (!shouldShow)
    ...
    const Popover = Component_26.default.Builder((popover) => {
        let unbind;
        return popover
            .style("popover")
            .tabIndex("programmatic")
