...
define("ui/InputBus", ["require", "exports", "ui/Component", "utility/EventManager"], function (require, exports, Component_1, EventManager_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Component_1.default.extend(component => {
        component.extend(component => ({
            receiveFocusedClickEvents: () => component.classes.add(Classes.ReceiveFocusedClickEvents),
        }));
    });
    exports.HandlesKeyboardEvents = Component_1.default.Tag().setName('HandlesKeyboardEvents');
    exports.HandlesMouseEvents = Component_1.default.Tag().setName('HandlesMouseEvents');
        ...
        if (usedByInput) {
            if (e.type === 'keydown' && eventKey === 'Enter' && !event.shift && !event.alt) {
                ...
                if (form && (target.tagName.toLowerCase() === 'input' || target.closest('[contenteditable]')) && !event.ctrl) {
                    if (!Component_1.default.closest(exports.HandlesKeyboardEvents, target))
                        e.preventDefault();
                }
                else {
                    form?.requestSubmit();
...
define("ui/utility/BrowserListener", ["require", "exports", "utility/State"], function (require, exports, State_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_1 = __importDefault(State_1);
    var BrowserListener;
    (function (BrowserListener) {
        BrowserListener.isWebkit = (0, State_1.default)(/AppleWebKit/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent));
...
define("utility/DevServer", ["require", "exports", "utility/Env"], function (require, exports, Env_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/utility/StyleManipulator", ["require", "exports", "style", "utility/DevServer", "utility/Env", "utility/Script", "utility/State", "utility/Style"], function (require, exports, style_1, DevServer_1, Env_2, Script_1, State_4, Style_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    DevServer_1.default.onMessage('updateStyle', async () => {
        ...
        void Style_1.default.reload(`${Env_2.default.URL_ORIGIN}style/index.css`);
        await Script_1.default.reload(`${Env_2.default.URL_ORIGIN}style/index.js`);
...
define("endpoint/author/EndpointAuthorDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_1 = __importDefault(Endpoint_1);
    exports.default = (0, Endpoint_1.default)('/author/delete', 'post')
        .noResponse();
});
...
define("utility/Store", ["require", "exports", "utility/State"], function (require, exports, State_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Store {
        ...
        static get state() {
            ...
            return statesProxy ??= new Proxy({}, {
                ...
                get(_, key) {
                    return s[key] ??= (0, State_5.default)(Store.get(key));
                },
            });
        }
        static get full() {
...
define("model/Session", ["require", "exports", "endpoint/auth/EndpointAuthDelete", "endpoint/session/EndpointSessionGet", "endpoint/session/EndpointSessionReset", "utility/Env", "utility/Popup", "utility/State", "utility/Store"], function (require, exports, EndpointAuthDelete_1, EndpointSessionGet_1, EndpointSessionReset_1, Env_3, Popup_1, State_6, Store_2) {
    ...
    var Session;
    (function (Session) {
        Session.has = (0, State_6.default)(false);
            ...
            if (Store_2.default.items.session?.created !== session.data?.created)
                for (const keyOrHandler of clearedWithSessionChange)
                    if (typeof keyOrHandler === 'function')
                        ...
                        Store_2.default.delete(keyOrHandler);
        ...
        function updateState() {
            Session.has.value = !!Store_2.default.items.session;
            ...
            Auth.authorisations.value = Store_2.default.items.session?.author?.authorisations ?? Store_2.default.items.session?.authorisations ?? [];
        ...
        let Auth;
        (function (Auth) {
            Auth.state = (0, State_6.default)('none');
            Auth.loggedIn = State_6.default.Generator(() => Auth.state.value === 'logged-in').observeManual(Auth.state);
            Auth.authorisations = (0, State_6.default)([]);
            Auth.author = (0, State_6.default)(undefined, false);
            function getAll() {
            ...
            Auth.get = get;
            function loggedInAs(owner, authorVanity) {
                return Auth.author.map(owner, author => author?.vanity === authorVanity);
            }
            Auth.loggedInAs = loggedInAs;
...
define("endpoint/auth/EndpointAuthServices", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_5 = __importDefault(Endpoint_5);
    exports.default = (0, Endpoint_5.default)('/auth/services', 'get');
});
...
define("ui/component/core/Checkbutton", ["require", "exports", "ui/Component", "ui/component/core/Button", "utility/State"], function (require, exports, Component_2, Button_1, State_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Checkbutton = Component_2.default.Builder('label', (component) => {
        const input = (0, Component_2.default)('input')
            .style('checkbutton-input')
            .attributes.set('type', 'checkbox');
        const inputElement = input.element;
        const state = (0, State_7.default)(false);
        let unuse;
...
define("ui/component/auth/OAuthService", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Checkbutton", "utility/Objects", "utility/State"], function (require, exports, Session_1, Component_3, Checkbutton_1, Objects_1, State_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const OAuthService = Component_3.default.Builder((component, service, definition) => {
        const authedAtStart = !!Session_1.default.Auth.get(service.name);
        const authorisationState = _
            ?? definition?.authorisationState
            ?? Session_1.default.Auth.authorisations.map(component, authorisations => authorisations.find(authorisation => authorisation.service === service.name));
        const isAuthed = State_8.default.Truthy(component, authorisationState);
        const button = component
            ...
            .append((0, Component_3.default)('img')
            .style('oauth-service-icon')
            .attributes.set('src', service.icon))
            .append((0, Component_3.default)()
        ...
        (0, Objects_1.mutable)(button).stateIndicatorWrapper = (0, Component_3.default)()
            .style('oauth-service-state-wrapper')
            .style.bind(button.hoveredOrFocused, 'oauth-service-state-wrapper--focus')
            .appendTo(button);
        (0, Objects_1.mutable)(button).stateIndicator = (0, Component_3.default)()
            .style('oauth-service-state')
            .style.bind(isAuthed, 'oauth-service-state--authenticated')
            .style.bind(State_8.default.Map(button, [button.hoveredOrFocused, button.disabled], (focus, disabled) => focus && !disabled), 'oauth-service-state--focus')
            .appendTo(button.stateIndicatorWrapper);
        const username = (0, Component_3.default)()
        ...
        button.onRooted(() => {
            button.event.subscribe('click', async (event) => {
                ...
                if (await definition?.onClick?.(button))
                    return;
                const auth = Session_1.default.Auth.get(service.name);
                if (auth)
...
define("ui/component/core/ActionRow", ["require", "exports", "ui/Component"], function (require, exports, Component_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_4 = __importDefault(Component_4);
    const ActionRow = Component_4.default.Builder((row) => {
        ...
        return row
            ...
            .extendJIT('left', row => (0, Component_4.default)()
            .style('action-row-left')
            .prependTo(row))
            .extendJIT('middle', row => {
            const middle = (0, Component_4.default)()
...
define("ui/component/core/ext/ComponentInsertionTransaction", ["require", "exports", "utility/State"], function (require, exports, State_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function ComponentInsertionTransaction(component, onEnd) {
        ...
        const closed = (0, State_9.default)(false);
        let removed = false;
        const result = {
...
define("ui/utility/FocusListener", ["require", "exports", "utility/State"], function (require, exports, State_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_10 = __importDefault(State_10);
    var FocusListener;
    (function (FocusListener) {
        FocusListener.hasFocus = (0, State_10.default)(false);
        FocusListener.focused = (0, State_10.default)(undefined);
        FocusListener.focusedLast = (0, State_10.default)(undefined);
...
define("ui/utility/Mouse", ["require", "exports", "utility/State"], function (require, exports, State_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Mouse) {
        const pos = { x: 0, y: 0 };
        Mouse.state = (0, State_11.default)(pos);
...
define("ui/utility/TypeManipulator", ["require", "exports", "utility/State"], function (require, exports, State_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_12 = __importDefault(State_12);
    const TypeManipulator = Object.assign(function (host, onAdd, onRemove) {
        const state = (0, State_12.default)(new Set());
...
define("ui/utility/Viewport", ["require", "exports", "utility/State", "utility/Style"], function (require, exports, State_13, Style_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Viewport;
    (function (Viewport) {
        Viewport.size = State_13.default.JIT(() => ({ w: window.innerWidth, h: window.innerHeight }));
        Viewport.mobile = State_13.default.JIT(owner => {
            const result = State_13.default.Use(owner, {
        ...
        Viewport.tablet = State_13.default.JIT(owner => {
            const result = State_13.default.Use(owner, {
...
define("ui/component/core/Popover", ["require", "exports", "ui/Component", "ui/InputBus", "ui/utility/FocusListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/TypeManipulator", "ui/utility/Viewport", "utility/Objects", "utility/State", "utility/Task"], function (require, exports, Component_5, InputBus_1, FocusListener_1, HoverListener_1, Mouse_2, TypeManipulator_1, Viewport_1, Objects_2, State_14, Task_2) {
    ...
    Component_5.default.extend(component => {
        component.extend((component) => ({
            ...
            setPopover: (popoverEvent, initialiser) => {
                ...
                component.ariaLabel.bind(ariaLabel.mapManual(ariaLabel => (quilt, { arg }) => quilt['component/popover/button'](arg(ariaLabel), arg(ariaRole))));
                popover.ariaLabel.bind(ariaLabel.mapManual(ariaLabel => (quilt, { arg }) => quilt['component/popover'](arg(ariaLabel))));
    ...
    const Popover = Component_5.default.Builder((component) => {
        let mousePadding;
        let unbind;
        ...
        const popover = component
            ...
            popoverHasFocus: FocusListener_1.default.focused.map(popover, focused => !focused ? 'no-focus'
...
define("ui/component/core/Slot", ["require", "exports", "ui/Component", "ui/component/core/ext/ComponentInsertionTransaction", "utility/AbortPromise", "utility/State"], function (require, exports, Component_6, ComponentInsertionTransaction_1, AbortPromise_1, State_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/ext/CanHasActionsMenu", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Popover", "ui/component/core/Slot", "ui/utility/Viewport", "utility/Objects"], function (require, exports, Component_7, Button_2, Popover_1, Slot_1, Viewport_2, Objects_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ActionsMenu = Component_7.default.Builder((component) => {
    ...
    const CanHasActionsMenu = Component_7.default.Extension((component, popoverInitialiser) => {
...
define("ui/utility/MarkdownContent", ["require", "exports", "ui/Component", "utility/string/Markdown"], function (require, exports, Component_8, Markdown_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Component_8.default.extend(component => component.extend(component => ({
        setMarkdownContent(markdown, maxLength) {
            ...
            if (component.element.lastElementChild?.tagName.length === 2 && component.element.lastElementChild.tagName[0] === 'H')
                (0, Component_8.default)('p').appendTo(component);
            return component;
        },
    })));
...
define("ui/component/core/Heading", ["require", "exports", "ui/Component", "ui/utility/MarkdownContent", "ui/utility/TextManipulator", "utility/Define", "utility/maths/Maths", "utility/State"], function (require, exports, Component_9, MarkdownContent_1, TextManipulator_1, Define_2, Maths_1, State_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Component_9.default.extend(component => component.extend(component => ({
    ...
    const Heading = Component_9.default.Builder('h1', (component) => {
        component.style('heading');
        const textWrapper = (0, Component_9.default)()
            .style('heading-text')
            .appendTo(component);
        Define_2.default.set(component, 'text', (0, TextManipulator_1.default)(component, textWrapper));
        let initial = true;
        let aestheticLevel;
        let aestheticStyle;
        const resizeRange = (0, State_16.default)(undefined);
        State_16.default.Map(component, [component.text.state, resizeRange], (...args) => args)
        ...
        return component.extend(heading => ({
            ...
            setResizeRange(minLength, maxLength) {
                if (State_16.default.is(maxLength))
                ...
                return heading;
                function getResizeRange(maxLength) {
    ...
    MarkdownContent_1.default.handle(element => {
        ...
        return () => {
            ...
            Component_9.default.removeContents(heading.element);
...
define("ui/component/core/Link", ["require", "exports", "navigation/RoutePath", "ui/Component", "ui/InputBus", "ui/utility/MarkdownContent", "utility/Env", "utility/State"], function (require, exports, RoutePath_1, Component_10, InputBus_2, MarkdownContent_2, Env_4, State_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Link = Component_10.default.Builder('a', (component, route) => {
        component
            .and(InputBus_2.HandlesMouseEvents)
            .style('link');
        const canNavigate = (0, State_17.default)(true);
...
define("ui/component/core/Block", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/ext/CanHasActionsMenu", "ui/component/core/Heading", "ui/component/core/Link", "ui/component/core/Paragraph", "ui/utility/TypeManipulator", "utility/State"], function (require, exports, Component_12, ActionRow_1, CanHasActionsMenu_1, Heading_1, Link_1, Paragraph_1, TypeManipulator_2, State_18) {
    ...
    const Block = Component_12.default.Builder((component) => {
        let header;
        let footer;
        ...
        const block = component
            ...
            content: (0, Component_12.default)().style('block-content').appendTo(component),
            footer: undefined,
            ...
            .tweak(block => block
            .style.bindFrom(State_18.default.MapManual([isLink, block.type.state], (link, types) => [...types].map((t) => `block${link ? '--link' : ''}--type-${t}`))))
            .extendJIT('header', block => header = (0, Component_12.default)('hgroup')
            .style('block-header')
            ...
            .extendJIT('primaryActions', block => (0, Component_12.default)().style('block-actions-primary').appendTo(block.header))
...
define("ui/component/auth/OAuthServices", ["require", "exports", "endpoint/auth/EndpointAuthServices", "model/Session", "ui/Component", "ui/component/auth/OAuthService", "ui/component/core/Block", "ui/component/core/Placeholder", "ui/component/core/Slot", "utility/Objects", "utility/State"], function (require, exports, EndpointAuthServices_1, Session_2, Component_14, OAuthService_1, Block_1, Placeholder_1, Slot_2, Objects_4, State_19) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Objects_4 = __importStar(Objects_4);
    State_19 = __importDefault(State_19);
    const OAuthServices = Component_14.default.Builder(async (component, state, reauthDangerToken) => {
        const block = component
            .and(Block_1.default)
        ...
        const list = (0, Component_14.default)()
        ...
        (0, Objects_4.mutable)(block).data = services.data;
        (0, Slot_2.default)()
            .use(Session_2.default.has, (slot, session) => {
            if (!session)
                return (0, Component_14.default)()
            ...
            for (const service of Objects_4.default.values(services.data))
                if (!service.disabled)
                    if (!reauthDangerToken || Session_2.default.Auth.isAuthed(service))
                        (0, OAuthService_1.default)(service, {
                            async onClick(button) {
                                if (!reauthDangerToken)
                                    return false;
                                if (!Session_2.default.Auth.canRequestDangerToken())
                                    return true;
                                const granted = await Session_2.default.Auth.requestDangerToken(reauthDangerToken, service);
                                if (granted)
...
define("ui/component/core/Dialog", ["require", "exports", "ui/Component", "utility/State"], function (require, exports, Component_15, State_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_15 = __importDefault(Component_15);
    State_20 = __importDefault(State_20);
    const Dialog = Component_15.default.Builder(() => {
        const opened = (0, State_20.default)(false);
        const willOpen = (0, State_20.default)(false);
        const willClose = (0, State_20.default)(false);
        let modal = true;
        let unbind;
...
define("ui/component/core/BlockDialog", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Dialog", "utility/Task"], function (require, exports, Component_16, Block_2, Dialog_1, Task_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const BlockDialog = Component_16.default.Builder((component) => {
        const dialog = component.and(Dialog_1.default).and(Block_2.default)
            .viewTransition(false)
            .style.remove('block');
        dialog
            .style('dialog-block-wrapper')
            .style.bind(dialog.opened.not, 'dialog-block-wrapper--closed');
        const block = (0, Block_2.default)()
            .style('dialog-block')
...
define("utility/Errors", ["require", "exports"], function (require, exports) {
    ...
    (function (Errors) {
        ...
        Errors.create = (message) => Object.assign(new Error(message), { code: 600 });
    })(Errors || (Errors = {}));
    exports.default = Errors;
});
define("ui/component/core/ConfirmDialog", ["require", "exports", "model/Session", "ui/Component", "ui/component/auth/OAuthServices", "ui/component/core/BlockDialog", "ui/component/core/Button", "ui/component/core/Paragraph", "ui/utility/StringApplicator", "utility/Errors", "utility/State"], function (require, exports, Session_3, Component_17, OAuthServices_1, BlockDialog_1, Button_3, Paragraph_2, StringApplicator_1, Errors_1, State_21) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ConfirmDialog = Object.assign(Component_17.default.Builder(async (component, definition) => {
        ...
        if (definition?.cancelButtonTranslation === false && definition.confirmButtonTranslation === false)
            throw Errors_1.default.create('At least one ConfirmDialog button must be enabled');
        const state = (0, State_21.default)(undefined);
...
define("ui/component/core/Form", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Block", "ui/component/core/Button", "utility/State"], function (require, exports, Component_18, ActionRow_2, Block_3, Button_4, State_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Form = Component_18.default.Builder((component, label) => {
        ...
        const valid = State_22.default.Generator(() => (form.element).checkValidity());
        ...
        return form
            ...
            .style.bind(State_22.default.Every(form, submitButtonWrapper.hovered, submitButton.disabled), 'button--disabled--hover')
            .style.bind(State_22.default.Every(form, submitButtonWrapper.active, submitButton.disabled), 'button--disabled--active')));
    });
    exports.default = Form;
});
define("endpoint/author/EndpointAuthorCreate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_6 = __importDefault(Endpoint_6);
    exports.default = (0, Endpoint_6.default)('/author/create', 'post');
});
define("endpoint/author/EndpointAuthorUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_7 = __importDefault(Endpoint_7);
    exports.default = (0, Endpoint_7.default)('/author/update', 'post');
});
...
define("ui/component/core/LabelledTable", ["require", "exports", "ui/Component", "ui/component/core/LabelledRow", "ui/component/core/Slot"], function (require, exports, Component_20, LabelledRow_1, Slot_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
            ...
            label: initialiser => {
                ...
                return factory ??= {
                    ...
                    content: contentInitialiser => {
                        ...
                        if (state)
                            (0, Slot_3.default)().if(state, create).else(() => { orElse?.(); }).appendTo(table);
                        else
...
define("ui/component/core/ProgressWheel", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/Slot", "utility/State"], function (require, exports, en_nz_1, Component_21, Slot_4, State_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ProgressWheel = Object.assign(ProgressWheelBuilder, {
        Length(length, maxLength) {
            const unusedPercent = State_23.default.MapManual([length, maxLength], (length, maxLength) => length === undefined || !maxLength ? undefined : 1 - length / maxLength);
            const unusedChars = State_23.default.MapManual([length, maxLength], (length, maxLength) => length === undefined || !maxLength ? undefined : maxLength - length);
            return Slot_4.default.using(State_23.default.UseManual({ unusedPercent, unusedChars }), (slot, { unusedPercent, unusedChars }) => unusedPercent === undefined || unusedChars === undefined ? undefined
...
define("ui/utility/AnchorManipulator", ["require", "exports", "ui/utility/Mouse", "ui/utility/Viewport", "utility/State", "utility/Time"], function (require, exports, Mouse_3, Viewport_3, State_24, Time_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function AnchorManipulator(host) {
        ...
        let refCache;
        const location = (0, State_24.default)(undefined);
...
define("ui/component/core/ext/Input", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Popover", "ui/component/core/ProgressWheel", "ui/component/core/Slot", "ui/utility/AnchorManipulator", "ui/utility/StringApplicator", "ui/utility/Viewport", "utility/State"], function (require, exports, Component_22, Block_4, Popover_2, ProgressWheel_1, Slot_5, AnchorManipulator_1, StringApplicator_2, Viewport_4, State_25) {
    ...
    const Input = Object.assign(Component_22.default.Extension((component) => {
        const hintText = (0, State_25.default)(undefined);
        const maxLength = (0, State_25.default)(undefined);
        const length = (0, State_25.default)(undefined);
        const invalid = (0, State_25.default)('');
        const popoverOverride = (0, State_25.default)(false);
        const hasPopover = State_25.default.MapManual([hintText, maxLength, popoverOverride], (hintText, maxLength, override) => override || !!hintText || !!maxLength);
        let popover;
        hasPopover.subscribeManual(hasPopover => {
            ...
            popover = (0, Popover_2.default)()
                ...
                if (popoverOverride.value)
                    return;
                Slot_5.default.using(hintText, (slot, hintText) => !hintText ? undefined : createHintText(hintText))
                    .appendTo(popover);
        ...
        const customInvalidMessage = (0, State_25.default)(undefined);
        ...
        const input = component.extend(component => ({
            required: (0, State_25.default)(false),
            ...
            setMaxLength(newLength) {
                if (State_25.default.is(newLength))
...
define("ui/component/core/TextInput", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/ext/Input", "ui/utility/StringApplicator", "utility/State"], function (require, exports, en_nz_2, Component_23, Input_1, StringApplicator_3, State_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const TextInput = Component_23.default.Builder('input', (component) => {
        ...
        let filterFunction;
        const state = (0, State_26.default)('');
...
define("ui/view/shared/ext/ViewTransition", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_28, Arrays_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/TextEditor", ["require", "exports", "lang/en-nz", "model/Session", "prosemirror-commands", "prosemirror-dropcursor", "prosemirror-example-setup", "prosemirror-gapcursor", "prosemirror-history", "prosemirror-inputrules", "prosemirror-keymap", "prosemirror-markdown", "prosemirror-model", "prosemirror-schema-list", "prosemirror-state", "prosemirror-transform", "prosemirror-view", "ui/Announcer", "ui/Component", "ui/component/core/Button", "ui/component/core/Checkbutton", "ui/component/core/Dialog", "ui/component/core/ext/Input", "ui/component/core/Popover", "ui/component/core/RadioButton", "ui/component/core/Slot", "ui/InputBus", "ui/utility/MarkdownContent", "ui/utility/StringApplicator", "ui/utility/Viewport", "ui/view/shared/ext/ViewTransition", "utility/Arrays", "utility/Define", "utility/Env", "utility/Objects", "utility/State", "utility/Store", "utility/string/Markdown", "utility/Time", "w3c-keyname"], function (require, exports, en_nz_3, Session_4, prosemirror_commands_1, prosemirror_dropcursor_1, prosemirror_example_setup_1, prosemirror_gapcursor_1, prosemirror_history_1, prosemirror_inputrules_1, prosemirror_keymap_1, prosemirror_markdown_1, prosemirror_model_1, prosemirror_schema_list_1, prosemirror_state_1, prosemirror_transform_1, prosemirror_view_1, Announcer_1, Component_29, Button_5, Checkbutton_3, Dialog_2, Input_2, Popover_3, RadioButton_1, Slot_6, InputBus_3, MarkdownContent_3, StringApplicator_4, Viewport_5, ViewTransition_1, Arrays_3, Define_3, Env_5, Objects_5, State_27, Store_3, Markdown_2, Time_3, w3c_keyname_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (0, Define_3.default)(prosemirror_model_1.ResolvedPos.prototype, 'closest', function (node, attrsOrStartingAtDepth, startingAtDepth) {
    ...
    (0, Define_3.default)(prosemirror_model_1.Node.prototype, 'matches', function (type, attrs) {
        if (type !== undefined && this.type !== type)
            return false;
        return attrs === undefined || this.hasAttrs(attrs);
    });
    (0, Define_3.default)(prosemirror_model_1.Node.prototype, 'hasAttrs', function (attrs) {
        for (const [attr, val] of Object.entries(attrs))
            if (this.attrs[attr] !== val)
                return false;
        return true;
    });
    (0, Define_3.default)(prosemirror_model_1.Node.prototype, 'pos', function (document) {
        if (document === this)
            return 0;
        let result;
    ...
    (0, Define_3.default)(prosemirror_model_1.Node.prototype, 'parent', function (document) {
        if (document === this)
            return undefined;
    ...
    (0, Define_3.default)(prosemirror_model_1.Node.prototype, 'depth', function (document) {
        if (document === this)
            return 0;
        // eslint-disable-next-line @typescript-eslint/no-this-alias
        const searchNode = this;
    ...
    (0, Define_3.default)(prosemirror_model_1.Fragment.prototype, 'pos', function (document) {
        let result;
        document.descendants((node, pos) => {
            if (result !== undefined)
                return false;
    ...
    (0, Define_3.default)(prosemirror_model_1.Fragment.prototype, 'range', function (document) {
    ...
    (0, Define_3.default)(prosemirror_model_1.Fragment.prototype, 'parent', function (document) {
    ...
    (0, Define_3.default)(prosemirror_transform_1.Transform.prototype, 'stripNodeType', function (from, type) {
        // eslint-disable-next-line @typescript-eslint/no-this-alias
        const tr = this;
    ...
    const TextEditor = Component_29.default.Builder((component) => {
        const id = globalid++;
        const isMarkdown = (0, State_27.default)(false);
        const content = (0, State_27.default)('');
        const isFullscreen = (0, State_27.default)(false);
        const minimal = (0, State_27.default)(false);
        const isMinimal = State_27.default.MapManual([minimal, content], (minimal, content) => minimal && !content.trim());
        // eslint-disable-next-line prefer-const
        let editor;
        const state = (0, State_27.default)(undefined);
        ////////////////////////////////////
        ...
        editor = component
            .and(Slot_6.default)
            .and(Input_2.default)
            .and(InputBus_3.HandlesKeyboardEvents)
            ...
            useMarkdown: () => {
                clearLocal();
                return !state.value ? '' : MarkdownContent_3.default.trim(markdownSerializer.serialize(state.value?.doc));
            },
        ...
        const documentSlot = (0, Slot_6.default)();
        documentSlot
            ...
            return createDefaultView((0, Slot_6.default)().appendTo(slot));
        })
            .appendTo(actualEditor);
        const contentWidth = State_27.default.Generator(() => `${editor.document?.element.scrollWidth ?? 0}px`)
        ...
        const scrollbarProxy = (0, Component_29.default)()
            ...
            .appendTo(actualEditor);
        const fullscreenContentWidth = State_27.default.Generator(() => `${documentSlot.element.scrollWidth ?? 0}px`)
            .observe(component, state, Viewport_5.default.size);
        ...
        function saveLocal(name = editor.document?.name.value, doc) {
            ...
            Store_3.default.items.textEditorDrafts = [
                ...
                ...(Store_3.default.items.textEditorDrafts ?? [])
                    ...
                    && Date.now() - draft.created < Time_3.default.days(1) // keep old drafts only if they were made in the last day
                    && true),
            ]
...
define("ui/component/core/toast/ToastList", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/toast/Toast", "utility/Async", "utility/Task", "utility/Time"], function (require, exports, Session_5, Component_30, Toast_1, Async_2, Task_4, Time_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ToastList = Component_30.default.Builder((component) => {
        ...
        async function lifecycle(toast, component) {
            ...
            await Promise.race([
                ...
                Async_2.default.sleep(Time_4.default.seconds(1)),
            ]);
            wrapper.remove();
        }
    });
...
define("ui/view/account/AccountViewForm", ["require", "exports", "endpoint/author/EndpointAuthorCreate", "endpoint/author/EndpointAuthorUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/LabelledTextInputBlock", "ui/component/core/TextEditor", "ui/component/core/TextInput", "ui/component/core/toast/Toast", "ui/component/VanityInput"], function (require, exports, EndpointAuthorCreate_1, EndpointAuthorUpdate_1, en_nz_4, FormInputLengths_1, Session_6, Component_33, Block_5, Form_1, LabelledTable_1, LabelledTextInputBlock_1, TextEditor_1, TextInput_3, Toast_2, VanityInput_1) {
    ...
    exports.default = Component_33.default.Builder((component, type) => {
        ...
        const nameInput = (0, TextInput_3.default)()
            ...
            .setMaxLength(FormInputLengths_1.default.map(table, lengths => lengths?.author.name));
        ...
        const vanityInput = (0, VanityInput_1.default)()
            ...
            .setMaxLength(FormInputLengths_1.default.map(table, lengths => lengths?.author.vanity));
        ...
        const pronounsInput = (0, TextInput_3.default)()
            ...
            .setMaxLength(FormInputLengths_1.default.map(table, lengths => lengths?.author.pronouns));
        ...
        const descriptionInput = (0, TextEditor_1.default)()
            ...
            .setMaxLength(FormInputLengths_1.default.map(table, lengths => lengths?.author.description));
        ...
        (0, LabelledTextInputBlock_1.default)()
            ...
            .setMaxLength(FormInputLengths_1.default.map(table, lengths => lengths?.author.support_link)))
            ...
            .setMaxLength(FormInputLengths_1.default.map(table, lengths => lengths?.author.support_message)))
            .appendTo(table);
...
define("endpoint/patreon/EndpointPatreonCampaignRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_8 = __importDefault(Endpoint_8);
    exports.default = (0, Endpoint_8.default)('/patreon/campaign/remove', 'post');
});
define("ui/view/account/AccountViewPatreonCampaign", ["require", "exports", "endpoint/Endpoint", "endpoint/patreon/EndpointPatreonCampaignRemove", "model/Session", "ui/Component", "ui/component/auth/OAuthService", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/ConfirmDialog", "ui/component/core/Heading", "ui/component/core/Slot", "utility/Popup"], function (require, exports, Endpoint_9, EndpointPatreonCampaignRemove_1, Session_7, Component_34, OAuthService_2, Block_6, Button_6, ConfirmDialog_1, Heading_2, Slot_7, Popup_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_9 = __importDefault(Endpoint_9);
    EndpointPatreonCampaignRemove_1 = __importDefault(EndpointPatreonCampaignRemove_1);
    Session_7 = __importDefault(Session_7);
    Component_34 = __importDefault(Component_34);
    OAuthService_2 = __importDefault(OAuthService_2);
    ...
    exports.default = Component_34.default.Builder((component, patreon) => {
        ...
        const campaign = Session_7.default.Auth.author.map(block, author => author?.patreon_campaign ?? undefined);
        (0, Component_34.default)()
            .style('view-type-account-patreon-campaign-oauth-row')
            .append((0, OAuthService_2.default)(patreon, {
        ...
        async function relink() {
            await (0, Popup_2.default)('Link Patreon Campaign', Endpoint_9.default.path('/auth/patreon/campaign/begin'), 600, 900)
                .then(() => true).catch(err => { console.warn(err); return false; });
            await Session_7.default.refresh();
        }
        async function unlink() {
            const shouldUnlink = await ConfirmDialog_1.default.prompt(component, {
            ...
            if (!shouldUnlink)
                return;
            await EndpointPatreonCampaignRemove_1.default.query();
            await Session_7.default.refresh();
        }
    });
});
define("ui/component/core/Breadcrumbs", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Heading", "ui/component/core/Link", "utility/State"], function (require, exports, Component_35, Button_7, Heading_3, Link_2, State_28) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Breadcrumbs = Component_35.default.Builder((component) => {
        const pathComponent = (0, Component_35.default)()
            .style('breadcrumbs-path', 'breadcrumbs-path--hidden')
            .viewTransition('breadcrumbs-path');
        let title;
        const backButton = (0, State_28.default)(undefined);
        const breadcrumbs = component.style('breadcrumbs')
            ...
            setBackButton(route, initialiser) {
                ...
                if (!route)
                    return breadcrumbs;
                backButton.value = (0, Link_2.default)(route)
                    .and(Button_7.default)
                    .type('flush')
            ...
            .extendJIT('meta', breadcrumbs => (0, Component_35.default)()
            .viewTransition('breadcrumbs-meta')
            .style('breadcrumbs-meta')
            .prependTo(breadcrumbs))
            .extendJIT('info', breadcrumbs => (0, Component_35.default)()
            .prependTo(breadcrumbs.meta))
            .extendJIT('title', breadcrumbs => title = (0, Heading_3.default)()
            .style('breadcrumbs-title')
            .setAestheticStyle(false)
            .prependTo(breadcrumbs.info))
            .extendJIT('description', breadcrumbs => (0, Component_35.default)()
            .style('breadcrumbs-description')
            .appendTo(breadcrumbs.info))
            .extendJIT('actions', breadcrumbs => (0, Component_35.default)()
...
define("ui/view/shared/ext/ViewTitle", ["require", "exports", "ui/Component"], function (require, exports, Component_36) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_36 = __importDefault(Component_36);
    exports.default = Component_36.default.Tag();
});
define("ui/view/shared/component/View", ["require", "exports", "ui/Component", "ui/component/core/Breadcrumbs", "ui/component/core/Heading", "ui/view/shared/ext/ViewTitle", "utility/State"], function (require, exports, Component_37, Breadcrumbs_1, Heading_4, ViewTitle_1, State_29) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_37 = __importDefault(Component_37);
    Breadcrumbs_1 = __importDefault(Breadcrumbs_1);
    Heading_4 = __importDefault(Heading_4);
    ViewTitle_1 = __importDefault(ViewTitle_1);
    State_29 = __importDefault(State_29);
    const View = Component_37.default.Builder((component, id) => {
        const content = (0, Component_37.default)().style('view-content');
        return component
            ...
            const state = (0, State_29.default)(undefined);
            ...
            function updateTitleComponent() {
                state.value = _
                    ...
                    ?? view.getFirstDescendant(ViewTitle_1.default)
                    ?? view.getFirstDescendant(Heading_4.default);
            }
        });
    });
...
define("ui/view/AccountView", ["require", "exports", "endpoint/author/EndpointAuthorDelete", "model/Session", "ui/component/auth/OAuthServices", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/ConfirmDialog", "ui/component/core/Slot", "ui/view/account/AccountViewForm", "ui/view/account/AccountViewPatreonCampaign", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "utility/State"], function (require, exports, EndpointAuthorDelete_1, Session_8, OAuthServices_2, ActionRow_3, Button_8, ConfirmDialog_2, Slot_8, AccountViewForm_1, AccountViewPatreonCampaign_1, View_1, ViewDefinition_1, ViewTransition_2, State_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    AccountViewPatreonCampaign_1 = __importDefault(AccountViewPatreonCampaign_1);
    ...
    exports.default = (0, ViewDefinition_1.default)({
        async load() {
            const state = (0, State_30.default)(Session_8.default.Auth.state.value);
        ...
        create(_, { state, services }) {
            ...
            Session_8.default.Auth.author.use(view, author => view.breadcrumbs.setBackButton(!author?.vanity ? undefined : `/author/${author.vanity}`, button => button.subText.set(author?.name)));
            (0, Slot_8.default)()
                .use(state, () => createForm()?.subviewTransition(id))
                .appendTo(view.content);
            (0, Slot_8.default)()
                .use(state, (slot, state) => state === 'logged-in'
                && (0, AccountViewPatreonCampaign_1.default)(services.data.patreon).subviewTransition(id))
                .appendTo(view.content);
            ...
            (0, Slot_8.default)()
                ...
                .appendTo(view.content);
            Session_8.default.Auth.state.subscribe(view, () => ViewTransition_2.default.perform('subview', id, updateAuthState));
            updateAuthState();
            return view;
            function updateAuthState(newState = Session_8.default.Auth.state.value) {
                ...
                switch (state.value) {
                    case 'logged-in':
                        return (0, ActionRow_3.default)()
                            ...
                            .event.subscribe('click', () => Session_8.default.reset()))
                            .append((0, Button_8.default)()
                            .text.use('view/account/action/delete')
                            .event.subscribe('click', async () => {
                            const result = await ConfirmDialog_2.default.prompt(view, { dangerToken: 'delete-account' });
                            if (!result)
                                return;
                            const response = await EndpointAuthorDelete_1.default.query();
                            if (toast.handleError(response))
                                return;
                            return Session_8.default.reset();
                        })));
                }
            }
        },
...
define("endpoint/author/EndpointAuthorGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_10 = __importDefault(Endpoint_10);
    exports.default = (0, Endpoint_10.default)('/author/{vanity}/get', 'get');
});
define("endpoint/work/EndpointWorkGetAllAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_11 = __importDefault(Endpoint_11);
    exports.default = (0, Endpoint_11.default)('/works/{author}', 'get');
});
define("model/PagedData", ["require", "exports", "ui/utility/EventManipulator", "utility/Objects", "utility/State"], function (require, exports, EventManipulator_1, Objects_6, State_31) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const PagedData = Object.assign(function (definition) {
        const pageCount = (0, State_31.default)(undefined);
        const pages = (0, State_31.default)([], false); // .setId('PagedData pages')
        const result = {
            pageCount,
            event: undefined,
            get pages() {
            ...
            get(page) {
                ...
                if (existing === undefined || existing === false) {
                    pages.value[page] = Promise.resolve(definition.get(page))
                        .then(data => {
                        if (!State_31.default.is(pages.value[page])) { // if it's already a State, it's been updated before this, don't overwrite
                            let newState;
                            if (State_31.default.is(data)) {
                                newState = (0, State_31.default)(null, false); // .setId(`PagedData page ${page} get 1`)
                                newState.bindManual(data);
                            }
                            else
                                newState = (0, State_31.default)(data, false); // .setId(`PagedData page ${page} get 2`)
            ...
            set(page, data, isLastPage) {
                if (State_31.default.is(pages.value[page]))
                    pages.value[page].value = data;
                else
                    pages.value[page] = (0, State_31.default)(data, false); // .setId(`PagedData page ${page} set`)
                if (isLastPage)
            ...
            async get(page) {
                ...
                if (dismantler) {
                    ...
                    for (const [key, value] of Object.entries(auxiliary)) {
                        if (value === content)
                            continue;
                        const state = aux[key] ??= (0, State_31.default)([]);
...
define("model/PagedListData", ["require", "exports", "model/PagedData", "utility/State"], function (require, exports, PagedData_1, State_32) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
            ...
            resized(resizePageSize) {
                ...
                list.rawPages.subscribeManual(() => {
                    ...
                    for (let i = 0; i < pages.length; i++) {
                        ...
                        function setPage(value) {
                            const state = pages[i] = (0, State_32.default)(null, false); // .setId('PagedListData subscribeManual setPage')
                            if (State_32.default.is(value))
                ...
                function getPage(page) {
                    ...
                    for (let i = startPageInSource; i < endPageInSource; i++) {
                        ...
                        if (i >= startPageInSource && i < endPageInSource && (!rawPage || (State_32.default.is(rawPage) && rawPage.value === false))) {
                ...
                function resolveData(sourcePages, startIndex, endIndex) {
                    ...
                    return State_32.default.Generator(() => data, false).observeManual(...sourcePages); // .setId('PagedListData resolveData')
                }
            },
            //#endregion
            ////////////////////////////////////
            ...
            async get(page) {
                ...
                if (dismantler) {
                    ...
                    for (const [key, value] of Object.entries(auxiliary)) {
                        if (value === content)
                            continue;
                        const state = aux[key] ??= (0, State_32.default)([]);
                        const mutableContent = content;
                        mutableContent[key] ??= state;
                        result[key] ??= state;
                        Object.assign(result, { aux });
...
define("endpoint/follow/EndpointFollowAdd", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_12 = __importDefault(Endpoint_12);
    exports.default = {
        Author: (0, Endpoint_12.default)('/follow/author/{vanity}', 'post'),
        Work: (0, Endpoint_12.default)('/follow/work/{vanity}', 'post'),
        Tag: (0, Endpoint_12.default)('/follow/tag/{vanity}', 'post'),
        Category: (0, Endpoint_12.default)('/follow/category/{vanity}', 'post'),
    };
});
define("endpoint/follow/EndpointFollowAddWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_13 = __importDefault(Endpoint_13);
    exports.default = (0, Endpoint_13.default)('/follow/work/{author}/{vanity}', 'post');
});
define("endpoint/follow/EndpointFollowGetManifest", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_14 = __importDefault(Endpoint_14);
    exports.default = (0, Endpoint_14.default)('/following', 'get');
});
define("endpoint/follow/EndpointFollowRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_15 = __importDefault(Endpoint_15);
    exports.default = {
        Author: (0, Endpoint_15.default)('/unfollow/author/{vanity}', 'post'),
        Work: (0, Endpoint_15.default)('/unfollow/work/{vanity}', 'post'),
        Tag: (0, Endpoint_15.default)('/unfollow/tag/{vanity}', 'post'),
        Category: (0, Endpoint_15.default)('/unfollow/category/{vanity}', 'post'),
    };
});
define("endpoint/follow/EndpointFollowRemoveWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_16 = __importDefault(Endpoint_16);
    exports.default = (0, Endpoint_16.default)('/unfollow/work/{author}/{vanity}', 'post');
});
define("endpoint/follow/EndpointIgnoreAdd", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_17 = __importDefault(Endpoint_17);
    exports.default = {
        Author: (0, Endpoint_17.default)('/ignore/author/{vanity}', 'post'),
        Work: (0, Endpoint_17.default)('/ignore/work/{vanity}', 'post'),
        Tag: (0, Endpoint_17.default)('/ignore/tag/{vanity}', 'post'),
        Category: (0, Endpoint_17.default)('/ignore/category/{vanity}', 'post'),
    };
});
define("endpoint/follow/EndpointIgnoreAddWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_18 = __importDefault(Endpoint_18);
    exports.default = (0, Endpoint_18.default)('/ignore/work/{author}/{vanity}', 'post');
});
define("endpoint/follow/EndpointIgnoreRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_19) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_19 = __importDefault(Endpoint_19);
    exports.default = {
        Author: (0, Endpoint_19.default)('/unignore/author/{vanity}', 'post'),
        Work: (0, Endpoint_19.default)('/unignore/work/{vanity}', 'post'),
        Tag: (0, Endpoint_19.default)('/unignore/tag/{vanity}', 'post'),
        Category: (0, Endpoint_19.default)('/unignore/category/{vanity}', 'post'),
    };
});
define("endpoint/follow/EndpointIgnoreRemoveWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_20 = __importDefault(Endpoint_20);
    exports.default = (0, Endpoint_20.default)('/unignore/work/{author}/{vanity}', 'post');
});
define("ui/utility/PageListener", ["require", "exports", "utility/State"], function (require, exports, State_33) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_33 = __importDefault(State_33);
    var PageListener;
    (function (PageListener) {
        PageListener.visible = (0, State_33.default)(document.visibilityState === 'visible');
...
define("model/Manifest", ["require", "exports", "model/Session", "ui/utility/PageListener", "utility/State", "utility/Time"], function (require, exports, Session_9, PageListener_1, State_34, Time_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Session_9 = __importDefault(Session_9);
    PageListener_1 = __importDefault(PageListener_1);
    ...
    function Manifest(definition) {
        ...
        const state = (0, State_34.default)(undefined, false);
        manifestStore();
        const result = Object.assign(state, {
            isFresh(manifest) {
                return !!manifest
                    && (false
                        ...
                        || !PageListener_1.default.visible.value);
            },
            async getManifest(force) {
                ...
                if (!force && result.isFresh(state.value))
                    return state.value;
                if (definition.requiresAuthor && !Session_9.default.Auth.loggedIn.value)
                    return undefined;
        ...
        if (definition.refresh)
            ...
            setInterval(async () => {
                ...
                if (Date.now() - lastFetchAttempt < Time_5.default.seconds(60))
                    return;
...
define("endpoint/work/EndpointWorkDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_21) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_21 = __importDefault(Endpoint_21);
    exports.default = (0, Endpoint_21.default)('/work/{author}/{vanity}/delete', 'post');
});
define("model/Works", ["require", "exports", "endpoint/work/EndpointWorkDelete", "ui/component/core/ConfirmDialog"], function (require, exports, EndpointWorkDelete_1, ConfirmDialog_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = Object.assign(Works, {
        async delete(work, owner) {
            if (!work)
                return true;
            const result = await ConfirmDialog_3.default.prompt(owner ?? null, { dangerToken: 'delete-work' });
            if (!result)
                return false;
...
define("ui/component/core/ExternalLink", ["require", "exports", "navigation/RoutePath", "ui/Component", "ui/InputBus", "ui/utility/MarkdownContent", "utility/Env"], function (require, exports, RoutePath_2, Component_38, InputBus_4, MarkdownContent_4, Env_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_38 = __importDefault(Component_38);
    MarkdownContent_4 = __importDefault(MarkdownContent_4);
    Env_6 = __importDefault(Env_6);
    const ExternalLink = Component_38.default.Builder('a', (component, href) => {
        component
            .and(InputBus_4.HandlesMouseEvents)
...
define("ui/component/Author", ["require", "exports", "lang/en-nz", "model/Follows", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/ExternalLink", "ui/component/core/Placeholder", "ui/component/core/Slot"], function (require, exports, en_nz_5, Follows_1, Session_10, Component_39, Block_7, Button_9, ExternalLink_1, Placeholder_2, Slot_9) {
    ...
    exports.default = Component_39.default.Builder((component, author) => {
        component
        ...
        block.description
            .append((0, Component_39.default)()
            .style('author-vanity')
            .text.set(`@${author.vanity}`))
            .append(author.pronouns && (0, Slot_9.default)()
            .text.append(' · ')
            .append((0, Component_39.default)()
            .style('author-pronouns')
            .text.set(author.pronouns)));
        if (author.description)
            (0, Component_39.default)()
                .style('author-description')
                .append((0, Slot_9.default)().tweak(slot => {
        ...
        block.setActionsMenu(popover => {
            Session_10.default.Auth.author.use(popover, self => {
                ...
                else if (Session_10.default.Auth.loggedIn.value) {
                    (0, Button_9.default)()
                        .type('flush')
...
define("ui/component/core/Flag", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_40, Arrays_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_40 = __importDefault(Component_40);
    Arrays_4 = __importDefault(Arrays_4);
    const Flag = Component_40.default.Builder((component) => {
        const stripes = Arrays_4.default.range(5)
            .map(i => (0, Component_40.default)()
...
define("ui/component/core/Loading", ["require", "exports", "ui/Component", "ui/component/core/Flag"], function (require, exports, Component_41, Flag_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_41 = __importDefault(Component_41);
    Flag_1 = __importDefault(Flag_1);
    const Loading = Component_41.default.Builder((component) => {
        return component.and(Flag_1.default)
            .style('loading-flag')
            .wave('loading', true);
    });
    exports.default = Loading;
});
define("ui/component/core/Paginator", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Loading", "ui/component/core/Popover", "ui/component/core/Slot", "ui/view/shared/ext/ViewTransition", "utility/Async", "utility/State", "utility/string/Strings", "utility/Style"], function (require, exports, Component_42, Block_8, Button_10, Loading_1, Popover_4, Slot_10, ViewTransition_3, Async_3, State_35, Strings_2, Style_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Paginator = Component_42.default.Builder((component) => {
        ...
        const scrollAnchorBottom = (0, Component_42.default)()
        ...
        const cursor = (0, State_35.default)(0);
        const allData = (0, State_35.default)(undefined, false);
        ...
        const currentData = (0, State_35.default)(false, false);
        let settingId = Symbol();
        State_35.default.Use(component, { cursor, allData }).use(component, async ({ cursor, allData }) => {
            if (!allData)
        ...
        const isLastPage = State_35.default.Map(component, [cursor, pageCount], (cursor, pageCount) => cursor + 1 >= (pageCount ?? Infinity));
        // first
        (0, Button_10.default)()
            .setIcon('angles-left')
            .type('icon')
        ...
        (0, Slot_10.default)()
            ...
            const wrapper = (0, Slot_10.default)().appendTo(slot);
            const pages = [];
            ...
            function Page(pageNumber) {
                const viewTransitionName = `paginator-page${Strings_2.default.uid()}`;
                const page = (0, Slot_10.default)()
                    .style('paginator-page');
                function newContent() {
                    page.removeContents();
                    return (0, Slot_10.default)()
                        .style.remove('slot')
                ...
                void Promise.resolve(pageContent).then(pageContent => {
                    pageContent.use(slot, async (content) => {
                        ...
                        if (hasContent) {
                            ViewTransition_3.default.perform('subview', viewTransitionName, () => {
                                initialiser?.(newContent(), content, pageNumber, data, paginator);
                            });
                            return;
                        }
                        page.removeContents();
            ...
            function scrollIntoView(direction, instant = false) {
                if (!direction || scrollOption === false)
                    return;
                if (component.closest(Popover_4.default))
                    return;
        ...
        function RetryDialog(retry) {
            return (0, Component_42.default)()
                .style('paginator-error')
                .append((0, Component_42.default)()
                .style('paginator-error-text')
                .text.use('component/paginator/error'))
                .append((0, Button_10.default)()
                .type('primary')
...
define("ui/component/core/TextLabel", ["require", "exports", "ui/Component"], function (require, exports, Component_43) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_43 = __importDefault(Component_43);
    const TextLabel = Component_43.default.Builder((component) => {
        component.style("text-label");
        const label = (0, Component_43.default)()
            .style("text-label-label");
        const punctuation = (0, Component_43.default)()
            .style("text-label-punctuation")
            .text.set(": ");
        const content = (0, Component_43.default)()
...
define("ui/component/core/Timestamp", ["require", "exports", "ui/Component", "utility/State", "utility/Time"], function (require, exports, Component_44, State_36, Time_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_44 = __importDefault(Component_44);
    State_36 = __importDefault(State_36);
    Time_7 = __importDefault(Time_7);
    const Timestamp = Component_44.default.Builder((component, time) => {
        let translation;
        const state = (0, State_36.default)(new Date(time ?? Date.now()));
...
define("endpoint/tag/EndpointTagManifest", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_22 = __importDefault(Endpoint_22);
    exports.default = (0, Endpoint_22.default)('/manifest/tags', 'get');
});
...
define("ui/component/core/ext/Draggable", ["require", "exports", "ui/Component", "utility/maths/Vector2", "utility/State"], function (require, exports, Component_45, Vector2_1, State_37) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const isDraggingAnyDraggable = (0, State_37.default)(false);
    const Draggable = Object.assign(Component_45.default.Extension((component, definition = {}) => {
        component.style('draggable');
        const state = (0, State_37.default)(DragState.None);
        const overrideStickyDistance = (0, State_37.default)(undefined);
        const overrideDelay = (0, State_37.default)(undefined);
        const stickyDistance = State_37.default.MapManual([overrideStickyDistance, definition.stickyDistance], (override, base) => override ?? base ?? 0);
        const delay = State_37.default.MapManual([overrideDelay, definition.delay], (override, base) => override ?? base ?? 0);
...
define("ui/component/Tag", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/ext/Draggable", "ui/component/core/Link"], function (require, exports, Component_46, Button_11, Draggable_1, Link_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Tag = Object.assign(Component_46.default.Builder('a', (component, tag) => {
        ...
        const categoryWrapper = typeof tag === 'string'
            ...
            : (0, Component_46.default)()
                ...
                .appendTo(component);
        const nameWrapper = (0, Component_46.default)()
            .style('tag-name')
        ...
        Category: Component_46.default
            .Builder('button', (component, category) => component.and(Tag, { category: category.name, name: '...', description: { body: category.description } }))
            .setName('TagCategory'),
    });
    exports.default = Tag;
});
define("ui/component/core/ext/Sortable", ["require", "exports", "ui/Component", "ui/component/core/ext/Draggable", "utility/Arrays", "utility/maths/Vector2", "utility/State"], function (require, exports, Component_47, Draggable_2, Arrays_5, Vector2_2, State_38) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const isSortingAnySortable = (0, State_38.default)(false);
    const Sortable = Object.assign(Component_47.default.Extension((component, definition) => {
        const sorting = (0, State_38.default)(false);
        const sortDelay = (0, State_38.default)(definition.sortDelay ?? 0);
        const stickyDistance = (0, State_38.default)(definition.stickyDistance ?? 0);
        const order = (0, State_38.default)([]);
...
define("ui/utility/Applicator", ["require", "exports", "utility/State"], function (require, exports, State_39) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Applicator(host, defaultValueOrApply, apply) {
        ...
        function makeApplicator(host) {
            return {
                state: (0, State_39.default)(defaultValue),
                set: value => {
                    unbind?.();
                    setInternal(value);
                    return host;
...
define("ui/component/TagsEditor", ["require", "exports", "lang/en-nz", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/ext/Input", "ui/component/core/ext/Sortable", "ui/component/core/ProgressWheel", "ui/component/core/Slot", "ui/component/core/TextInput", "ui/component/Tag", "ui/utility/AnchorManipulator", "ui/utility/Applicator", "utility/AbortPromise", "utility/Mouse", "utility/State", "utility/string/Strings"], function (require, exports, en_nz_6, Tags_1, Component_48, Block_9, Input_4, Sortable_1, ProgressWheel_2, Slot_11, TextInput_4, Tag_1, AnchorManipulator_2, Applicator_1, AbortPromise_2, Mouse_4, State_40, Strings_3) {
    ...
    const TagsEditor = Component_48.default.Builder((component) => {
        const tagsState = (0, State_40.default)({ global_tags: [], custom_tags: [] });
        ////////////////////////////////////
        //#region Current
        const tagsContainer = (0, Slot_11.default)()
        ...
        //#endregion
        ////////////////////////////////////
        const inputWrapper = (0, Component_48.default)()
        ...
        ////////////////////////////////////
        //#region Suggestions
        const hasOrHadFocus = State_40.default.Some(component, component.hasFocused, component.hadFocusedLast);
        const suggestions = (0, Slot_11.default)()
            .style('tags-editor-suggestions')
            .use(State_40.default.UseManual({
            tags: tagsState,
            filter: input.state,
            focus: hasOrHadFocus,
        ...
        //#endregion
        ////////////////////////////////////
        const hiddenInput = (0, Component_48.default)('input')
            .style('tags-editor-validity-pipe-input')
            .tabIndex('programmatic')
            .attributes.set('type', 'text')
            .setName(`tags-editor-validity-pipe-input-${Math.random().toString(36).slice(2)}`);
        const maxLengthGlobal = (0, State_40.default)(undefined);
        const maxLengthCustom = (0, State_40.default)(undefined);
        const editor = component
            ...
            setMaxLengthGlobal(maxLength) {
                if (State_40.default.is(maxLength))
        ...
        editor.setCustomHintPopover(popover => popover
            ...
            .anchor.reset()
            .anchor.from(input)
            .anchor.add('off right', `.${Block_9.BlockClasses.Main}`, 'centre', AnchorManipulator_2.AllowYOffscreen));
...
define("ui/component/Tags", ["require", "exports", "model/Tags", "ui/Component", "ui/component/core/Slot", "ui/component/Tag", "utility/AbortPromise", "utility/State"], function (require, exports, Tags_2, Component_49, Slot_12, Tag_2, AbortPromise_3, State_41) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Tags = Component_49.default.Builder((component) => {
        const state = (0, State_41.default)(undefined);
        let definition;
        (0, Slot_12.default)()
            ...
            return tags?.length && (0, Component_49.default)()
            ...
            .appendTo(component);
        (0, Slot_12.default)()
            .use(state.map(component, state => state?.custom_tags), (slot, customTags) => customTags?.length && (0, Component_49.default)()
...
define("ui/component/Work", ["require", "exports", "lang/en-nz", "model/Follows", "model/FormInputLengths", "model/Session", "model/Works", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/core/TextLabel", "ui/component/core/Timestamp", "ui/component/Tags"], function (require, exports, en_nz_7, Follows_2, FormInputLengths_2, Session_11, Works_2, Component_50, Block_10, Button_12, Link_4, Slot_13, TextLabel_1, Timestamp_1, Tags_3) {
    ...
    const Work = Component_50.default.Builder((component, work, author, notFullOverride) => {
        ...
        (0, Slot_13.default)()
            ...
            if (!isFlush)
                (0, Component_50.default)()
                    ...
                    .append((0, Slot_13.default)().tweak(slot => {
        ...
        if (work.visibility === 'Private')
            block.footer.right.append((0, Component_50.default)().style('timestamp', 'work-timestamp').text.use('work/state/private'));
        else if (!work.chapter_count_public)
            block.footer.right.append((0, Component_50.default)().style('timestamp', 'work-timestamp').text.use('work/state/private-no-chapters'));
        ...
        block.setActionsMenu((popover, button) => {
            if (author && author.vanity === Session_11.default.Auth.author.value?.vanity) {
                (0, Button_12.default)()
                    .type('flush')
                    .setIcon('pencil')
            ...
            else if (Session_11.default.Auth.loggedIn.value) {
                (0, Button_12.default)()
                    .type('flush')
    ...
    exports.default = (0, ViewDefinition_2.default)({
        ...
        create(params, { author }) {
            ...
            (0, Paginator_1.default)()
                ...
                .append((0, Slot_14.default)()
                .if(Session_12.default.Auth.author.map(popover, author => author?.vanity === params.vanity), () => (0, Button_13.default)()
                .type('flush')
                .setIcon('plus')
                ...
                .type('flush')
                .appendTo(slot))))
                .orElse(slot => (0, Block_11.default)()
                .type('flush')
                .tweak(block => (0, Component_51.default)()
                .style('placeholder')
...
define("endpoint/chapter/EndpointChapterDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_23 = __importDefault(Endpoint_23);
    exports.default = (0, Endpoint_23.default)('/work/{author}/{work}/chapter/{url}/delete', 'post');
});
define("endpoint/chapter/EndpointChapterGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_24) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_24 = __importDefault(Endpoint_24);
    exports.default = (0, Endpoint_24.default)('/work/{author}/{work}/chapter/{url}/get', 'get');
});
define("endpoint/chapter/EndpointChapterGetPaged", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_25 = __importDefault(Endpoint_25);
    exports.default = (0, Endpoint_25.default)('/work/{author}/{work}/chapters/paged', 'get');
});
...
define("model/Chapters", ["require", "exports", "endpoint/chapter/EndpointChapterDelete", "ui/component/core/ConfirmDialog"], function (require, exports, EndpointChapterDelete_1, ConfirmDialog_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    EndpointChapterDelete_1 = __importDefault(EndpointChapterDelete_1);
    ConfirmDialog_4 = __importDefault(ConfirmDialog_4);
    var Chapters;
    (function (Chapters) {
    ...
    exports.default = Object.assign(Chapters, {
        async delete(chapter, owner) {
            if (!chapter)
                return true;
            const result = await ConfirmDialog_4.default.prompt(owner ?? null, { dangerToken: 'delete-chapter' });
            if (!result)
                return false;
...
define("ui/component/core/InfoDialog", ["require", "exports", "ui/Component", "ui/component/core/BlockDialog", "ui/component/core/Button", "ui/utility/StringApplicator", "utility/State"], function (require, exports, Component_52, BlockDialog_2, Button_14, StringApplicator_5, State_42) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("endpoint/chapter/EndpointChapterCreate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_27) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_27 = __importDefault(Endpoint_27);
    exports.default = (0, Endpoint_27.default)('/work/{author}/{vanity}/chapter/create', 'post');
});
define("endpoint/chapter/EndpointChapterUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_28) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_28 = __importDefault(Endpoint_28);
    exports.default = (0, Endpoint_28.default)('/work/{author}/{work}/chapter/{url}/update', 'post');
});
...
define("ui/component/core/Dropdown", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/Button", "ui/component/core/Checkbutton", "ui/component/core/ext/Input", "ui/component/core/RadioButton", "ui/component/core/TextInput", "ui/utility/Applicator", "ui/utility/StringApplicator", "utility/Arrays", "utility/Async", "utility/Functions", "utility/State"], function (require, exports, en_nz_8, Component_53, Button_15, Checkbutton_4, Input_5, RadioButton_2, TextInput_5, Applicator_2, StringApplicator_6, Arrays_6, Async_4, Functions_1, State_43) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.CheckDropdown = exports.RadioDropdown = void 0;
    en_nz_8 = __importDefault(en_nz_8);
    Component_53 = __importDefault(Component_53);
    Button_15 = __importDefault(Button_15);
    Checkbutton_4 = __importDefault(Checkbutton_4);
    ...
    const Dropdown = Component_53.default.Builder((component, definition) => {
        const dropdown = component.and(Input_5.default)
            .style('dropdown');
        const selection = (0, State_43.default)(undefined);
        const options = {};
        let optionIndex = 0;
        let popover;
        (0, Button_15.default)()
            ...
            ? en_nz_8.default['shared/form/dropdown/selection/none']()
            : (_
                ?? definition.translateSelection?.(dropdown, state)
                ?? en_nz_8.default['shared/form/dropdown/selection/join'](...Arrays_6.default.resolve(state)
                    .map(id => Functions_1.default.resolve(options[id]?.translation, id))
                    .map(translation => Functions_1.default.resolve(translation, en_nz_8.default, StringApplicator_6.QuiltHelper))))))
        ...
        popover.visible.subscribeManual(async (visible) => {
            await Async_4.default.sleep(20);
            if (visible)
                input.focus();
        });
        ...
        dropdown
            ...
            options,
            selection: selection,
            default: (0, Applicator_2.default)(dropdown, (id) => selection.value = id),
            add(id, optionDefinition) {
                const button = definition.createButton()
                    ...
                    .setId(id)
                    .setName(labelFor)
                    .text.bind(Functions_1.default.resolve(optionDefinition.translation, id))
                    .use(selection.mapManual(selected => Arrays_6.default.resolve(selected).includes(id)))
                    .receiveFocusedClickEvents()
                    .tweak(button => button.as(Checkbutton_4.default)?.event.subscribe('click', event => {
                    input.focus();
                    event.preventDefault();
                    event.stopImmediatePropagation();
                    const isRadio = button.is(RadioButton_2.default);
                    if (isRadio)
                        popover.hide();
                    if (!selection.value)
                        selection.value = [id];
                    else {
                        const current = Arrays_6.default.resolve(selection.value);
                ...
                const filteredOut = State_43.default.Map(button, [input.state, button.checked], (filter, selected) => !selected && !!filter && !button.element.textContent?.includes(filter));
                button.style.bind(filteredOut, 'dropdown-option--filtered-out');
                if (button.is(RadioButton_2.default))
    ...
    exports.RadioDropdown = (Component_53.default.Builder((component, definition) => {
        return component.and(Dropdown, { createButton: RadioButton_2.default, ...definition });
    }).setName('RadioDropdown'));
    exports.CheckDropdown = (Component_53.default.Builder((component, definition) => {
        return component.and(Dropdown, { createButton: Checkbutton_4.default, ...definition });
    }).setName('CheckDropdown'));
});
define("ui/component/core/RadioRow", ["require", "exports", "ui/Component", "ui/component/core/ext/Input", "ui/component/core/RadioButton", "ui/utility/Applicator", "utility/State"], function (require, exports, Component_54, Input_6, RadioButton_3, Applicator_3, State_44) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_54 = __importDefault(Component_54);
    Input_6 = __importDefault(Input_6);
    RadioButton_3 = __importDefault(RadioButton_3);
    Applicator_3 = __importDefault(Applicator_3);
    State_44 = __importDefault(State_44);
    const RadioRow = Component_54.default.Builder((component) => {
        const selection = (0, State_44.default)(undefined);
        const options = {};
        let labelFor;
        const row = component.and(Input_6.default)
            .style('radio-row')
            .ariaRole('group')
            .extend(row => ({
            selection,
            default: (0, Applicator_3.default)(row, (id) => selection.value = id),
            add(id, initialiser) {
                const button = options[id] = (0, RadioButton_3.default)()
...
define("ui/view/chapter/ChapterEditForm", ["require", "exports", "endpoint/chapter/EndpointChapterCreate", "endpoint/chapter/EndpointChapterUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Dropdown", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/Placeholder", "ui/component/core/RadioRow", "ui/component/core/TextEditor", "ui/component/core/TextInput", "ui/component/core/toast/Toast", "ui/component/TagsEditor", "ui/utility/StringApplicator", "utility/Arrays", "utility/Functions", "utility/Objects", "utility/State"], function (require, exports, EndpointChapterCreate_1, EndpointChapterUpdate_1, en_nz_9, FormInputLengths_3, Session_13, Component_55, Block_12, Dropdown_1, Form_2, LabelledTable_2, Placeholder_3, RadioRow_1, TextEditor_2, TextInput_6, Toast_3, TagsEditor_1, StringApplicator_7, Arrays_7, Functions_2, Objects_7, State_45) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Arrays_7 = __importStar(Arrays_7);
    Functions_2 = __importDefault(Functions_2);
    Objects_7 = __importDefault(Objects_7);
    State_45 = __importDefault(State_45);
    exports.default = Component_55.default.Builder((component, state, workParams) => {
        ...
        state.use(form, chapter => form.setName(en_nz_9.default[`view/chapter-edit/${formType}/title`](chapter?.url).toString()));
        ...
        const nameInput = (0, TextInput_6.default)()
            ...
            .setMaxLength(FormInputLengths_3.default.map(table, lengths => lengths?.chapter.name));
        ...
        const tagsEditor = (0, TagsEditor_1.default)()
            .default.bind(state)
            .setMaxLengthGlobal(FormInputLengths_3.default.map(table, lengths => lengths?.work_tags.global))
            .setMaxLengthCustom(FormInputLengths_3.default.map(table, lengths => lengths?.work_tags.custom));
        ...
        const notesBeforeInput = (0, TextEditor_2.default)()
            ...
            .setMaxLength(FormInputLengths_3.default.map(table, lengths => lengths?.chapter.notes))
            .setMinimalByDefault();
        ...
        const campaign = Session_13.default.Auth.author.map(component, author => author?.patreon_campaign);
        ...
        const tiers = State_45.default.Use(component, { campaign, visibilityStateIsPatreon })
            .map(component, ({ campaign, visibilityStateIsPatreon }) => campaign && visibilityStateIsPatreon ? campaign.tiers : undefined);
        let threshold;
        table.label(label => label.text.use('view/chapter-edit/shared/form/visibility-patreon-tier/label'))
            ...
            .content((content, label) => content.append(threshold = (0, Dropdown_1.CheckDropdown)({
            translateSelection(dropdown, selection) {
                const selectedTiers = selection
                    .map(id => tiers.value?.find(tier => tier.tier_id === id))
                    .filter(Arrays_7.NonNullish)
                    .sort((a, b) => a.amount - b.amount);
                if (!selectedTiers.length)
                    return en_nz_9.default['view/chapter-edit/shared/form/visibility-patreon-tier/selection/none']();
                if (tiers.value?.length === selectedTiers.length)
                    return en_nz_9.default['view/chapter-edit/shared/form/visibility-patreon-tier/selection/all']();
                ...
                if (tiers.value?.every(tier => tier.amount <= firstSelectedTier.amount || selection.includes(tier.tier_id))) {
                    const tierTranslation = Functions_2.default.resolve(dropdown.options[firstSelectedTier.tier_id].translation, firstSelectedTier.tier_id);
                    const resolvedTranslation = Functions_2.default.resolve(tierTranslation, en_nz_9.default, StringApplicator_7.QuiltHelper);
                    return en_nz_9.default['view/chapter-edit/shared/form/visibility-patreon-tier/selection/tier-and-up'](resolvedTranslation);
                }
                return undefined;
            },
        })
            ...
            tiers.use(dropdown, tiers => {
                ...
                for (const tier of tiers ?? [])
                    dropdown.add(tier.tier_id, {
                        translation: en_nz_9.default['shared/term/patreon-tier']({
                            NAME: tier.tier_name,
            ...
            ?? [chapter?.patreon?.tier.tier_id].filter(Arrays_7.NonNullish)))
            .setLabel(label)));
        form.event.subscribe('submit', async (event) => {
            event.preventDefault();
            await save();
        ...
        function getFormData() {
            return {
                ...
                tier_id: Arrays_7.default.resolve(threshold?.selection.value)[0],
        ...
        function hasUnsavedChanges() {
            ...
            const basicFields = Objects_7.default.keys(getFormData()).filter(key => key !== 'custom_tags' && key !== 'global_tags' && key !== 'tier_id' && key !== 'tier_ids');
            ...
            const stateTiers = _
                ...
                ?? [state.value.patreon?.tier.tier_id].filter(Arrays_7.NonNullish);
            ...
            const response = await (() => {
                switch (formType) {
                    ...
                    case 'update': {
                        if (!state.value)
                            return;
                        const authorVanity = Session_13.default.Auth.author.value?.vanity;
                        if (!authorVanity)
...
define("ui/view/shared/component/PaginatedView", ["require", "exports", "ui/Component", "ui/component/core/Paginator", "ui/view/shared/component/View"], function (require, exports, Component_56, Paginator_2, View_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_56 = __importDefault(Component_56);
    Paginator_2 = __importDefault(Paginator_2);
    View_3 = __importDefault(View_3);
    const PaginatedView = Component_56.default.Builder((_, id) => {
        let paginator;
        const urls = [];
...
define("ui/view/ChapterEditView", ["require", "exports", "endpoint/chapter/EndpointChapterDelete", "endpoint/chapter/EndpointChapterGet", "endpoint/chapter/EndpointChapterGetPaged", "endpoint/work/EndpointWorkGet", "model/Chapters", "model/PagedData", "ui/Component", "ui/component/core/Button", "ui/component/core/InfoDialog", "ui/component/core/Link", "ui/component/Work", "ui/view/chapter/ChapterEditForm", "ui/view/shared/component/PaginatedView", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTitle", "utility/State", "utility/Type"], function (require, exports, EndpointChapterDelete_2, EndpointChapterGet_1, EndpointChapterGetPaged_1, EndpointWorkGet_1, Chapters_1, PagedData_2, Component_57, Button_16, InfoDialog_1, Link_6, Work_2, ChapterEditForm_1, PaginatedView_1, ViewDefinition_3, ViewTitle_2, State_46, Type_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    ViewTitle_2 = __importDefault(ViewTitle_2);
    ...
    exports.default = (0, ViewDefinition_3.default)({
        ...
        async load(params) {
            ...
            if (workResponse instanceof Error)
                throw workResponse;
            const owner = (0, Component_57.default)();
            if (!params.url)
        ...
        create(params, { initialChapterResponse, work }) {
            ...
            (0, Link_6.default)(`/work/${author?.vanity}/${work.vanity}`)
                ...
                .setContainsHeading()
                .appendTo(view.content);
            const chapterCount = (0, State_46.default)((Type_1.default.as('number', initialChapterResponse?.page_count) ?? work.chapter_count ?? 0) + 1);
            ...
            const paginator = view.paginator()
                ...
                const owner = pageOwners[page] = (0, Component_57.default)();
                const state = (0, State_46.default)(pageData === NEW_CHAPTER ? undefined : pageData);
                ...
                const form = (0, ChapterEditForm_1.default)(state, Chapters_1.default.work(params))
                    .tweak(form => form.title.and(ViewTitle_2.default))
...
define("endpoint/history/EndpointHistoryAddChapter", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_29) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_29 = __importDefault(Endpoint_29);
    exports.default = (0, Endpoint_29.default)('/history/add/{author}/{work}/chapter/{url}', 'post');
});
define("endpoint/patreon/EndpointPatreonPatronRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_30 = __importDefault(Endpoint_30);
    exports.default = (0, Endpoint_30.default)('/auth/patreon/patron/delete', 'post');
});
define("endpoint/reaction/EndpointReactChapter", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_31) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_31 = __importDefault(Endpoint_31);
    exports.default = (0, Endpoint_31.default)('/work/{author}/{work}/chapter/{url}/react/{type}', 'post');
});
define("endpoint/reaction/EndpointUnreactChapter", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_32) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_32 = __importDefault(Endpoint_32);
    exports.default = (0, Endpoint_32.default)('/work/{author}/{work}/chapter/{url}/unreact', 'post');
});
...
define("ui/component/Chapter", ["require", "exports", "lang/en-nz", "model/Chapters", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/ext/CanHasActionsMenu", "ui/component/core/Link", "ui/component/core/Timestamp", "utility/maths/Maths", "utility/State"], function (require, exports, en_nz_10, Chapters_2, Session_14, Component_58, Button_17, CanHasActionsMenu_2, Link_7, Timestamp_2, Maths_2, State_47) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function initActions(actions, chapter, work, author, isChapterView = false) {
        return actions
            .appendAction('patreon', State_47.default.get(chapter), (slot, chapter) => true
            && !isChapterView
            && chapter.visibility === 'Patreon'
            && chapter.patreon
            && (0, Component_58.default)()
                .style('chapter-patreon-tier', 'patreon-icon-after')
                .text.set(en_nz_10.default['shared/term/patreon-tier']({
                NAME: chapter.patreon.tiers[0].tier_name,
                PRICE: `$${((chapter.patreon.tiers[0].amount ?? 0) / 100).toFixed(2)}`,
            })))
            .appendAction('edit', Session_14.default.Auth.author, (slot, self) => true
            && author
            ...
            && (0, Button_17.default)()
                ...
                .event.subscribe('click', () => navigate.toURL(`/work/${author.vanity}/${work.vanity}/chapter/${State_47.default.value(chapter).url}/edit`)))
            .appendAction('delete', Session_14.default.Auth.author, (slot, self) => true
            && author
            && author.vanity === self?.vanity
            && (0, Button_17.default)()
                .type('flush')
                ...
                .event.subscribe('click', () => Chapters_2.default.delete(State_47.default.value(chapter))));
    }
    const Chapter = Object.assign(Component_58.default.Builder((component, chapter, work, author) => {
        ...
        const number = (0, Component_58.default)()
            .style('chapter-number')
            .text.set(chapterNumber ? `${chapterNumber.toLocaleString()}` : '')
            .appendTo(component);
        const chapterName = (0, Component_58.default)()
            .style('chapter-name')
            .text.set(chapter.name)
            .appendTo(component);
        const right = (0, Component_58.default)()
            .style('chapter-right')
            .appendTo(component);
        let timestamp;
        if (chapter.visibility === 'Private')
            timestamp = (0, Component_58.default)()
...
define("endpoint/comment/EndpointCommentGetAllUnder", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_33) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_33 = __importDefault(Endpoint_33);
    exports.default = (0, Endpoint_33.default)('/comments/{under}', 'get');
});
define("endpoint/comment/EndpointCommentAdd", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_34) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_34 = __importDefault(Endpoint_34);
    exports.default = (0, Endpoint_34.default)('/comment/add/{under}', 'post');
});
define("endpoint/comment/EndpointCommentDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_35) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_35 = __importDefault(Endpoint_35);
    exports.default = (0, Endpoint_35.default)('/comment/{id}/delete', 'post');
});
define("endpoint/comment/EndpointCommentUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_36) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_36 = __importDefault(Endpoint_36);
    exports.default = (0, Endpoint_36.default)('/comment/{id}/update', 'post');
});
define("endpoint/reaction/EndpointReactComment", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_37) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_37 = __importDefault(Endpoint_37);
    exports.default = (0, Endpoint_37.default)('/comment/{comment_id}/react/{type}', 'post');
});
define("endpoint/reaction/EndpointUnreactComment", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_38) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_38 = __importDefault(Endpoint_38);
    exports.default = (0, Endpoint_38.default)('/comment/{comment_id}/unreact', 'post');
});
define("ui/component/Reaction", ["require", "exports", "ui/Component", "ui/component/core/Button", "utility/State"], function (require, exports, Component_59, Button_18, State_48) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Reaction = Component_59.default.Builder((component, type, reactionsIn = (0, State_48.default)(0), reactedIn = (0, State_48.default)(false)) => {
        const reactions = State_48.default.get(reactionsIn);
        const reacted = State_48.default.get(reactedIn);
        return component
            .style('reaction')
            .append((0, Button_18.default)()
...
define("ui/component/Comment", ["require", "exports", "endpoint/comment/EndpointCommentAdd", "endpoint/comment/EndpointCommentDelete", "endpoint/comment/EndpointCommentUpdate", "endpoint/reaction/EndpointReactComment", "endpoint/reaction/EndpointUnreactComment", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/core/TextEditor", "ui/component/core/Timestamp", "ui/component/Reaction"], function (require, exports, EndpointCommentAdd_1, EndpointCommentDelete_1, EndpointCommentUpdate_1, EndpointReactComment_1, EndpointUnreactComment_1, en_nz_11, FormInputLengths_4, Session_15, Component_60, ActionRow_4, Button_19, Link_8, Slot_15, TextEditor_3, Timestamp_3, Reaction_1) {
    ...
    const Comment = Component_60.default.Builder((component, source, commentData, meta) => {
        const comment = component.and(Slot_15.default)
            .style('comment')
            .extend(comment => ({}));
        ...
        comment.use(comments, (slot, commentsData) => {
            ...
            if (commentData && !meta?.isRootComment) {
                const header = (0, Component_60.default)('header')
                ...
                (0, Link_8.default)(!author?.vanity ? undefined : `/author/${author.vanity}`)
                    ...
                    .text.set(author?.name ?? en_nz_11.default['comment/deleted/author']().toString())
                    .appendTo(header);
                const time = commentData.edited_time ?? commentData.created_time;
                if (time)
                    (0, Timestamp_3.default)(time)
                        .style('comment-header-timestamp')
                        .setTranslation(!commentData.edited_time ? undefined : en_nz_11.default['comment/timestamp/edited'])
                        .appendTo(header);
                if (commentData.edit) {
                    ////////////////////////////////////
                    ...
                    const textEditor = (0, TextEditor_3.default)()
                        ...
                        .setMaxLength(FormInputLengths_4.default.map(slot, lengths => lengths?.comment.body))
                        .hint.use('comment/hint')
                        .appendTo(content);
                    textEditor.content.use(header, markdown => commentData.body = { body: markdown });
                    const footer = (0, Component_60.default)('footer').and(ActionRow_4.default)
                    ...
                    (0, Component_60.default)()
                        .style('comment-body')
                        .setMarkdownContent(commentData.body?.body ? commentData.body
                        : en_nz_11.default['comment/deleted/body']().toString())
                        .appendTo(content);
                    (0, Slot_15.default)()
                        .use(Session_15.default.Auth.author, (slot, author) => {
                        if (!author)
                            return;
                        const footer = (0, Component_60.default)('footer')
            ...
            const childrenWrapper = (0, Component_60.default)()
...
define("ui/component/Comments", ["require", "exports", "endpoint/comment/EndpointCommentGetAllUnder", "model/Session", "ui/Component", "ui/component/Comment", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/AbortPromise", "utility/State"], function (require, exports, EndpointCommentGetAllUnder_1, Session_16, Component_61, Comment_1, Block_13, Button_20, Slot_16, AbortPromise_4, State_49) {
    ...
    const Comments = Component_61.default.Builder((rawComponent, under, isRootComment) => {
        const block = rawComponent
            ...
            .extend(component => ({}));
        (0, Slot_16.default)()
            .use(Session_16.default.Auth.author, AbortPromise_4.default.asyncFunction(async (signal, slot, author) => {
            const comment = { comment_id: under };
            const comments = (0, State_49.default)([comment]);
            const authors = (0, State_49.default)(!author ? [] : [author]);
            if (author)
            ...
            const query = (0, State_49.default)(undefined);
            ...
            if (signal.aborted)
                return;
            (0, Slot_16.default)()
                .if(query.truthy, () => (0, Button_20.default)()
...
define("endpoint/author/EndpointAuthorUpdateSettings", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_39) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_39 = __importDefault(Endpoint_39);
    exports.default = (0, Endpoint_39.default)('/author/update/settings', 'post');
});
define("utility/Settings", ["require", "exports", "endpoint/author/EndpointAuthorUpdateSettings", "model/Session", "utility/Define", "utility/State"], function (require, exports, EndpointAuthorUpdateSettings_1, Session_17, Define_4, State_50) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    EndpointAuthorUpdateSettings_1 = __importDefault(EndpointAuthorUpdateSettings_1);
    ...
    (function (Settings) {
        const DEFS = [];
        const SETTINGS = State_50.default
            .JIT(() => {
            const settings = Session_17.default.Auth.author.value?.settings;
            if (!settings)
                return {};
            return JSON.parse(settings);
        })
            .observe(Session_17.default.Auth.author);
        ...
        Settings.get = get;
        function registerGroup(name, settings) {
            DEFS.push({
                name,
                settings: Object.values(settings).map((setting) => {
                    const state = SETTINGS.mapManual((settings) => settings[setting.name] ?? setting.default);
                    Define_4.default.magic(state, 'value', {
                        get: () => State_50.default.getInternalValue(state),
                        set: (value) => {
                            const settings = SETTINGS.value;
                            if (value === settings[setting.name])
                                return;
                            settings[setting.name] = value ?? null;
                            const author = Session_17.default.Auth.author.value;
                            if (author) {
                                author.settings = JSON.stringify(settings);
                                Session_17.default.Auth.author.emit();
                                EndpointAuthorUpdateSettings_1.default.query({ body: { settings: author.settings } });
                            }
                        },
                    });
                    return Object.assign(setting, { value: state });
                }),
            });
            return settings;
        }
        Settings.registerGroup = registerGroup;
    })(Settings || (Settings = {}));
    Object.assign(window, { Settings });
    exports.default = Settings;
});
define("ui/view/ChapterView", ["require", "exports", "endpoint/chapter/EndpointChapterGet", "endpoint/chapter/EndpointChapterGetPaged", "endpoint/Endpoint", "endpoint/history/EndpointHistoryAddChapter", "endpoint/patreon/EndpointPatreonPatronRemove", "endpoint/reaction/EndpointReactChapter", "endpoint/reaction/EndpointUnreactChapter", "endpoint/work/EndpointWorkGet", "model/Chapters", "model/PagedData", "model/Session", "model/TextBody", "ui/Component", "ui/component/auth/OAuthService", "ui/component/auth/OAuthServices", "ui/component/Chapter", "ui/component/Comments", "ui/component/core/Button", "ui/component/core/ConfirmDialog", "ui/component/core/ExternalLink", "ui/component/core/Heading", "ui/component/core/Link", "ui/component/core/Paragraph", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/Reaction", "ui/component/Tags", "ui/component/Work", "ui/view/shared/component/PaginatedView", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTitle", "utility/maths/Maths", "utility/Popup", "utility/Settings", "utility/State"], function (require, exports, EndpointChapterGet_2, EndpointChapterGetPaged_2, Endpoint_40, EndpointHistoryAddChapter_1, EndpointPatreonPatronRemove_1, EndpointReactChapter_1, EndpointUnreactChapter_1, EndpointWorkGet_2, Chapters_3, PagedData_3, Session_18, TextBody_1, Component_62, OAuthService_3, OAuthServices_3, Chapter_1, Comments_1, Button_21, ConfirmDialog_5, ExternalLink_2, Heading_5, Link_9, Paragraph_3, Placeholder_4, Slot_17, Reaction_2, Tags_4, Work_3, PaginatedView_2, ViewDefinition_4, ViewTitle_3, Maths_3, Popup_3, Settings_1, State_51) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    EndpointPatreonPatronRemove_1 = __importDefault(EndpointPatreonPatronRemove_1);
    ...
    OAuthService_3 = __importDefault(OAuthService_3);
    OAuthServices_3 = __importDefault(OAuthServices_3);
    Chapter_1 = __importDefault(Chapter_1);
    Comments_1 = __importDefault(Comments_1);
    Button_21 = __importDefault(Button_21);
    ConfirmDialog_5 = __importDefault(ConfirmDialog_5);
    ...
    exports.default = (0, ViewDefinition_4.default)({
        ...
        create(params, { workData, initialChapterResponse }) {
            ...
            view.breadcrumbs.setBackButton(`/work/${params.author}/${params.work}`, button => button.subText.set(workData.name));
            (0, Link_9.default)(`/work/${author?.vanity}/${workData.vanity}`)
                ...
                .setContainsHeading()
                .appendTo(view.content);
            const chapterState = (0, State_51.default)(initialChapterResponse.data);
            const isOwn = Session_18.default.Auth.loggedInAs(view, params.author);
            const sufficientPledge = chapterState.mapManual(chapter => !chapter.insufficient_pledge);
            const shouldShowPatreon = State_51.default.Some(view, isOwn.truthy, sufficientPledge.falsy);
            ...
            const paginator = view.paginator()
                ...
                .type('flush')
                .event.subscribe('PageError', Session_18.default.refresh)
                .tweak(paginator => {
                paginator.title
                    .and(ViewTitle_3.default)
                ...
                const number = chapterState.mapManual(chapter => Maths_3.default.parseIntOrUndefined(chapter.url));
                (0, Slot_17.default)()
                    .if(number.mapManual(number => number !== undefined), () => (0, Heading_5.default)()
                    .setAestheticStyle(false)
                ...
                if (Session_18.default.Auth.loggedIn.value)
                ...
                if (chapter.notes_before || chapter.global_tags?.length || chapter.custom_tags?.length)
                    (0, Component_62.default)()
                        ...
                        .prepend(chapter.notes_before && (0, Component_62.default)()
                        .style('view-type-chapter-block-notes-label')
                        .text.use('view/chapter/notes/label'))
                        .append((chapter.global_tags?.length || chapter.custom_tags?.length) && (0, Component_62.default)()
                ...
                if (isPatreon)
                    (0, Slot_17.default)().if(shouldShowPatreon, () => (0, Component_62.default)()
                        ...
                        if (!chapter.patreon)
                            return;
                        (0, Slot_17.default)()
                            .if(Session_18.default.Auth.loggedIn, slot => {
                            (0, Button_21.default)()
                                .style('view-type-chapter-block-patreon-header-button')
                                .text.bind(Session_18.default.Auth.author.map(slot, author => !author?.patreon_patron
                                ...
                                .appendTo(slot);
                            (0, ExternalLink_2.default)(chapter.patreon?.campaign.url)
                ...
                if (chapter.notes_after)
                    (0, Component_62.default)()
                        ...
                        .prepend(chapter.notes_after && (0, Component_62.default)()
                        .style('view-type-chapter-block-notes-label')
                        .text.use('view/chapter/notes/label'))
                        .appendTo(slot);
                (0, Slot_17.default)()
                    .if(isOwn, () => isPatreon && (0, Component_62.default)()
            ...
            paginator.setActionsMenu(popover => Chapter_1.default.initActions(popover, chapterState, workData, author, true));
            ...
            (0, Slot_17.default)()
                .if(sufficientPledge, () => (0, Reaction_2.default)('love', reactions, reacted)
                .event.subscribe('click', async () => {
                if (!author?.vanity)
                    return;
    ...
    function authAsPatron(owner) {
        void ConfirmDialog_5.default.prompt(owner, {
            ...
            async tweak(dialog) {
                (0, Paragraph_3.default)()
                    ...
                    .appendTo(dialog.content);
                const patron = Session_18.default.Auth.author.map(dialog, author => author?.patreon_patron ?? undefined);
                const services = await (0, OAuthServices_3.default)((0, State_51.default)('none'));
                (0, OAuthService_3.default)(services.data.patreon, {
                    ...
                    .appendTo(dialog.content);
                async function relink() {
                    await (0, Popup_3.default)('Link Patron Account', Endpoint_40.default.path('/auth/patreon/patron/begin'), 600, 900)
                        .then(() => true).catch(err => { console.warn(err); return false; });
                    await Session_18.default.refresh();
                }
                async function unlink() {
                    await EndpointPatreonPatronRemove_1.default.query();
                    await Session_18.default.refresh();
                }
            },
        });
...
define("ui/view/debug/ButtonRegistry", ["require", "exports", "model/Session", "utility/Env"], function (require, exports, Session_19, Env_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.BUTTON_REGISTRY = {
        createAuthor: {
            ...
            async execute(name, vanity, description, pronouns, feedback_preference_critique, feedback_preference_dont_hold_back, feedback_preference_typos) {
                ...
                await Session_19.default.refresh();
            },
        },
        updateAuthor: {
            name: 'Update Author',
...
define("ui/view/DebugView", ["require", "exports", "endpoint/auth/EndpointAuthServices", "model/Session", "ui/Component", "ui/component/core/Button", "ui/view/debug/ButtonRegistry", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Env", "utility/Objects", "utility/Popup"], function (require, exports, EndpointAuthServices_2, Session_20, Component_63, Button_22, ButtonRegistry_1, View_4, ViewDefinition_5, Env_8, Objects_8, Popup_4) {
    ...
    Popup_4 = __importDefault(Popup_4);
    const Block = Component_63.default.Builder(component => component
        .style('debug-block'));
    exports.default = (0, ViewDefinition_5.default)({
        async create() {
            const view = (0, View_4.default)('debug');
            const createButton = (implementation, ...args) => {
                return (0, Button_22.default)()
            ...
            for (const service of Objects_8.default.values(OAuthServices.data ?? {})) {
                ...
                (0, Button_22.default)()
                    ...
                    .event.subscribe('click', async () => {
                    await (0, Popup_4.default)(`OAuth ${service.name}`, service.url_begin, 600, 900)
                        .then(() => true).catch(err => { console.warn(err); return false; });
                    await Session_20.default.refresh();
                })
                    .appendTo(oauthDiv);
                (0, Button_22.default)()
                    .text.set(`UnOAuth ${service.name}`)
                    .event.subscribe('click', async () => {
                    const id = Session_20.default.Auth.get(service.id)?.id;
                    if (id === undefined)
                        return;
            ...
            (0, Button_22.default)()
                ...
                .event.subscribe('click', async () => {
                await (0, Popup_4.default)('Campaign OAuth', `${Env_8.default.API_ORIGIN}auth/patreon/campaign/begin`, 600, 900)
                    .then(() => true).catch(err => { console.warn(err); return false; });
                await Session_20.default.refresh();
            })
            ...
            (0, Button_22.default)()
                ...
                .event.subscribe('click', async () => {
                await (0, Popup_4.default)('Patron OAuth', `${Env_8.default.API_ORIGIN}auth/patreon/patron/begin`, 600, 900)
                    .then(() => true).catch(err => { console.warn(err); return false; });
                await Session_20.default.refresh();
            })
                .appendTo(patreonButtons);
...
define("endpoint/feed/EndpointFeedGetFollowed", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_41) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_41 = __importDefault(Endpoint_41);
    exports.default = (0, Endpoint_41.default)('/feed/get/followed', 'get');
});
define("ui/component/WorkFeed", ["require", "exports", "model/PagedListData", "ui/Component", "ui/component/core/Link", "ui/component/core/Paginator", "ui/component/Work", "utility/State"], function (require, exports, PagedListData_2, Component_64, Link_10, Paginator_3, Work_4, State_52) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const WorkFeed = Component_64.default.Builder((component) => {
        ...
        const feed = paginator.extend(feed => ({
            setFromEndpoint(endpoint) {
                const authors = (0, State_52.default)([]);
        ...
        paginator.orElse(slot => (0, Component_64.default)()
            .style('placeholder')
    ...
    exports.default = (0, ViewDefinition_6.default)({
        create: () => {
            ...
            (0, Link_11.default)('/following')
                .and(Button_23.default)
                .type('flush')
                .setIcon('circle-check')
                .text.bind(Follows_3.default.map(view, () => en_nz_12.default['view/shared/info/following'](Follows_3.default.getTotalFollowing())))
                .appendTo(view.breadcrumbs.actions);
            (0, Link_11.default)('/ignoring')
                .and(Button_23.default)
                .type('flush')
                .setIcon('ban')
                .text.bind(Follows_3.default.map(view, () => en_nz_12.default['view/shared/info/ignoring'](Follows_3.default.getTotalIgnoring())))
                .appendTo(view.breadcrumbs.actions);
...
define("ui/component/core/Tabinator", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "utility/Objects", "utility/State"], function (require, exports, Component_65, Block_14, Button_24, Objects_9, State_53) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Tab = void 0;
    ...
    exports.Tab = Component_65.default.Builder((component) => {
        const content = (0, Component_65.default)()
            .style('tabinator-panel')
            .ariaRole('tabpanel')
            .setRandomId();
        const tab = component.and(Button_24.default)
            .type('flush')
            .style('tabinator-tab')
            .ariaRole('tab')
            .setRandomId()
        ...
        .setName('Tab');
    const Tabinator = Component_65.default.Builder((component) => {
        const activeTab = (0, State_53.default)(undefined);
        const tabs = (0, State_53.default)([]);
...
define("ui/view/following/FollowingAuthorsTab", ["require", "exports", "endpoint/author/EndpointAuthorsResolveReferences", "model/Follows", "model/PagedListData", "ui/Component", "ui/component/Author", "ui/component/core/Link", "ui/component/core/Paginator", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "utility/AbortPromise", "utility/Arrays"], function (require, exports, EndpointAuthorsResolveReferences_1, Follows_4, PagedListData_3, Component_66, Author_2, Link_12, Paginator_4, Placeholder_5, Slot_18, Tabinator_1, AbortPromise_5, Arrays_8) {
    ...
    const FollowingAuthorsTab = Component_66.default.Builder((component, type) => {
        ...
        (0, Slot_18.default)()
            ...
            const authors = (0, PagedListData_3.default)(25, {
                async get(page) {
                    ...
                    if (!slice.length)
                        return null;
                    const response = await EndpointAuthorsResolveReferences_1.default.query(undefined, { authors: slice.map(follow => follow.author).filterInPlace(Arrays_8.NonNullish) });
                    if (toast.handleError(response))
                        return false;
                    return response.data;
                },
...
define("ui/component/TagBlock", ["require", "exports", "lang/en-nz", "model/Follows", "model/Session", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/Tag"], function (require, exports, en_nz_13, Follows_5, Session_21, Tags_5, Component_67, Block_15, Button_25, Tag_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const TagBlock = Component_67.default.Builder((component, tag) => {
        const block = component
            .and(Block_15.default)
            .style('tag-block')
            .extend(tab => ({}));
        const id = Tags_5.default.toId(tag);
        block.header.style('tag-block-header');
        block.setActionsMenu(popover => {
            Session_21.default.Auth.loggedIn.use(popover, loggedIn => {
                if (!loggedIn)
                    return;
                (0, Button_25.default)()
                    .type('flush')
                    ...
                    ? en_nz_13.default['tag/action/label/unfollow']()
                    : en_nz_13.default['tag/action/label/follow']()))
                ...
                (0, Button_25.default)()
                    ...
                    ? en_nz_13.default['tag/action/label/unignore']()
                    : en_nz_13.default['tag/action/label/ignore']()))
                    .event.subscribe('click', () => Follows_5.default.toggleIgnoringTag(id))
                    .appendTo(popover);
            });
        });
        const info = (0, Component_67.default)()
...
define("ui/view/following/FollowingTagsTab", ["require", "exports", "model/Follows", "model/Tags", "ui/Component", "ui/component/core/Link", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "ui/component/TagBlock", "utility/AbortPromise", "utility/Arrays"], function (require, exports, Follows_6, Tags_6, Component_68, Link_13, Placeholder_6, Slot_19, Tabinator_2, TagBlock_1, AbortPromise_6, Arrays_9) {
    ...
    const FollowingTagsTab = Component_68.default.Builder((component, type) => {
        ...
        (0, Slot_19.default)()
            ...
            const tags = await Tags_6.default.resolve(follows.map(follow => follow.tag).filterInPlace(Arrays_9.NonNullish));
            if (!tags.length)
                return (0, Placeholder_6.default)()
...
define("ui/view/following/FollowingWorksTab", ["require", "exports", "endpoint/work/EndpointWorksResolveReferences", "model/Follows", "model/PagedListData", "model/Works", "ui/Component", "ui/component/core/Link", "ui/component/core/Paginator", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "ui/component/Work", "utility/AbortPromise", "utility/Arrays", "utility/State"], function (require, exports, EndpointWorksResolveReferences_1, Follows_7, PagedListData_4, Works_3, Component_69, Link_14, Paginator_5, Placeholder_7, Slot_20, Tabinator_3, Work_5, AbortPromise_7, Arrays_10, State_54) {
    ...
    const FollowingWorksTab = Component_69.default.Builder((component, type) => {
        ...
        (0, Slot_20.default)()
            ...
            const authors = (0, State_54.default)([]);
            const works = (0, PagedListData_4.default)(25, {
                async get(page) {
                    const slice = follows.slice(page * 25, (page + 1) * 25) ?? [];
                    if (!slice.length)
                        return null;
                    const response = await EndpointWorksResolveReferences_1.default.query(undefined, { works: slice.map(follow => Works_3.default.reference(follow.work)).filterInPlace(Arrays_10.NonNullish) });
                    if (toast.handleError(response))
                        return false;
                    authors.value.push(...response.data.authors);
                    authors.value.distinctInPlace(author => author.vanity);
            ...
            (0, Paginator_5.default)()
                ...
                .orElse(slot => (0, Placeholder_7.default)()
...
define("endpoint/history/EndpointHistoryGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_44) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_44 = __importDefault(Endpoint_44);
    exports.default = (0, Endpoint_44.default)('/history/get', 'get');
});
            ...
            (0, Paginator_6.default)()
                ...
                for (const historyItem of history) {
                    ...
                    (0, Chapter_2.default)({ ...historyItem.chapter, time_last_update: historyItem.view_time }, work, author)
                        ...
                        .appendTo(currentChapterBlock ??= (0, Block_16.default)()
...
define("endpoint/feed/EndpointFeedGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_45) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_45 = __importDefault(Endpoint_45);
    exports.default = (0, Endpoint_45.default)('/feed/get', 'get');
});
...
define("ui/view/NewView", ["require", "exports", "endpoint/feed/EndpointFeedGet", "endpoint/feed/EndpointFeedGetAuthed", "model/Session", "ui/component/core/Slot", "ui/component/WorkFeed", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, EndpointFeedGet_1, EndpointFeedGetAuthed_1, Session_22, Slot_21, WorkFeed_2, View_9, ViewDefinition_10) {
    ...
    exports.default = (0, ViewDefinition_10.default)({
        create: () => {
            ...
            (0, Slot_21.default)()
                .use(Session_22.default.Auth.loggedIn, (slot, loggedIn) => (0, WorkFeed_2.default)()
...
define("endpoint/notification/EndpointNotificationMarkRead", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_47) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_47 = __importDefault(Endpoint_47);
    exports.default = (0, Endpoint_47.default)('/notifications/mark/read', 'post');
});
define("endpoint/notification/EndpointNotificationGetAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_48) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_48 = __importDefault(Endpoint_48);
    exports.default = (0, Endpoint_48.default)('/notifications/get/all', 'get');
});
define("endpoint/notification/EndpointNotificationGetCount", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_49) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_49 = __importDefault(Endpoint_49);
    exports.default = (0, Endpoint_49.default)('/notifications/get/count', 'get');
});
define("endpoint/notification/EndpointNotificationMarkUnread", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_50) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_50 = __importDefault(Endpoint_50);
    exports.default = (0, Endpoint_50.default)('/notifications/mark/unread', 'post');
});
define("model/Notifications", ["require", "exports", "endpoint/notification/EndpointNotificationGetAll", "endpoint/notification/EndpointNotificationGetCount", "endpoint/notification/EndpointNotificationMarkRead", "endpoint/notification/EndpointNotificationMarkUnread", "model/PagedListData", "model/Session", "utility/State", "utility/Store", "utility/Time"], function (require, exports, EndpointNotificationGetAll_1, EndpointNotificationGetCount_1, EndpointNotificationMarkRead_1, EndpointNotificationMarkUnread_1, PagedListData_6, Session_23, State_55, Store_4, Time_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Notifications) {
        Session_23.default.setClearedWithSessionChange('notifications', () => {
        ...
        let simpleCache = Store_4.default.items.notifications?.cache ?? [];
        const pageSize = 25;
        Notifications.cache = (0, PagedListData_6.default)(pageSize, {
            async get(page) {
                ...
                if (simpleCache.length < start) {
                    ...
                    Notifications.authors.value = [...Store_4.default.items.notifications?.authors ?? [], ...data.authors];
                    Notifications.works.value = [...Store_4.default.items.notifications?.works ?? [], ...data.works];
                    Notifications.chapters.value = [...Store_4.default.items.notifications?.chapters ?? [], ...data.chapters];
                    Notifications.comments.value = [...Store_4.default.items.notifications?.comments ?? [], ...data.comments];
                    Store_4.default.items.notifications = {
                        ...Store_4.default.items.notifications,
                        cache: simpleCache,
        ...
        Notifications.authors = (0, State_55.default)(Store_4.default.items.notifications?.authors ?? []);
        Notifications.works = (0, State_55.default)(Store_4.default.items.notifications?.works ?? []);
        Notifications.chapters = (0, State_55.default)(Store_4.default.items.notifications?.chapters ?? []);
        Notifications.comments = (0, State_55.default)(Store_4.default.items.notifications?.comments ?? []);
        Notifications.hasMore = (0, State_55.default)(Store_4.default.items.notifications?.hasMore ?? false);
        Notifications.unreadCount = (0, State_55.default)(Store_4.default.items.notifications?.unreadCount ?? 0);
        Notifications.lastUpdate = (0, State_55.default)(Store_4.default.items.notifications?.lastUpdate ?? 0);
        function clear() {
            if (Store_4.default.items.notifications)
                Store_4.default.items.notifications = { ...Store_4.default.items.notifications, lastCheck: 0, lastUpdate: 0 };
        }
        Notifications.clear = clear;
        function check() {
            if (Store_4.default.items.notifications)
                Store_4.default.items.notifications = { ...Store_4.default.items.notifications, lastCheck: 0 };
        ...
        async function checkNotifications() {
            ...
            if (!Session_23.default.Auth.author.value)
                return;
            let notifications = Store_4.default.items.notifications;
            const now = Date.now();
            if (now - (notifications?.lastCheck ?? 0) < Time_9.default.minutes(1))
                return;
            notifications ??= {};
            notifications.lastCheck = Date.now();
            Store_4.default.items.notifications = notifications;
            let resolve;
...
define("ui/component/Notification", ["require", "exports", "lang/en-nz", "model/Authors", "model/Chapters", "model/Comments", "model/Notifications", "model/TextBody", "model/Works", "ui/Component", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Timestamp", "utility/State"], function (require, exports, en_nz_14, Authors_2, Chapters_4, Comments_2, Notifications_1, TextBody_2, Works_5, Component_70, Button_26, Link_16, Timestamp_4, State_56) {
    ...
    const notificationQuilt = en_nz_14.default;
    const Notification = Component_70.default.Builder('a', (component, data) => {
        const translationFunction = notificationQuilt[`notification/${data.type}`];
        if (!translationFunction)
            return undefined;
        const read = (0, State_56.default)(data.read);
        ...
        const justMarkedUnread = (0, State_56.default)(false);
        const readButton = (0, Button_26.default)()
            .setIcon('check')
            .type('icon')
        ...
        (0, Component_70.default)()
            .style('notification-label')
            .append((0, Component_70.default)().text.set(translationFunction?.({ TRIGGERED_BY, AUTHOR, WORK, CHAPTER })), document.createTextNode('   '), (0, Timestamp_4.default)(data.created_time).style('notification-timestamp'))
            .appendTo(notification);
        const comment = Comments_2.default.resolve(data.comment, Notifications_1.default.comments.value);
        if (comment) {
            (0, Component_70.default)()
                .style('markdown')
                .append(comment.body && (0, Component_70.default)('blockquote')
...
define("ui/component/NotificationList", ["require", "exports", "endpoint/notification/EndpointNotificationMarkRead", "model/Notifications", "ui/Component", "ui/component/core/Button", "ui/component/core/Paginator", "ui/component/Notification"], function (require, exports, EndpointNotificationMarkRead_2, Notifications_2, Component_71, Button_27, Paginator_7, Notification_1) {
    ...
    const NotificationList = Component_71.default.Builder(async (component, onlyUnread, pageSize) => {
    ...
    exports.default = (0, ViewDefinition_12.default)({
        ...
        create(params, { tag }) {
            ...
            (0, WorkFeed_3.default)()
                .setFromEndpoint((Session_24.default.Auth.author.value ? EndpointFeedGetAuthed_2.default : EndpointFeedGet_2.default)
                .prep(undefined, {
...
define("endpoint/work/EndpointWorkCreate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_51) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_51 = __importDefault(Endpoint_51);
    exports.default = (0, Endpoint_51.default)('/work/create', 'post');
});
define("endpoint/work/EndpointWorkUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_52) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_52 = __importDefault(Endpoint_52);
    exports.default = (0, Endpoint_52.default)('/work/{author}/{vanity}/update', 'post');
});
define("ui/component/core/Textarea", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/ext/Input", "ui/utility/StringApplicator", "utility/State"], function (require, exports, en_nz_15, Component_72, Input_7, StringApplicator_8, State_57) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    en_nz_15 = __importDefault(en_nz_15);
    Component_72 = __importDefault(Component_72);
    Input_7 = __importDefault(Input_7);
    StringApplicator_8 = __importDefault(StringApplicator_8);
    State_57 = __importDefault(State_57);
    const Textarea = Component_72.default.Builder((component) => {
        let shouldIgnoreInputEvent = false;
        const contenteditable = (0, Component_72.default)()
            .style('text-input', 'text-area')
            .attributes.set('contenteditable', 'plaintext-only')
            .ariaRole('textbox')
            .attributes.set('aria-multiline', 'true');
        const hiddenInput = (0, Component_72.default)('input')
            .style('text-area-validity-pipe-input')
            .tabIndex('programmatic')
            .attributes.set('type', 'text')
            .setName(`text-area-validity-pipe-input-${Math.random().toString(36).slice(2)}`);
        const state = (0, State_57.default)('');
        const touched = (0, State_57.default)(false);
        const input = component
            .and(Input_7.default)
            ...
            touched,
            state,
            default: (0, StringApplicator_8.default)(input, value => {
                if (input.value === '') {
                    input.value = value ?? '';
                    state.value = value ?? '';
                    input.length.asMutable?.setValue(value?.length ?? 0);
            ...
            placeholder: (0, StringApplicator_8.default)(input, value => {
...
define("ui/view/work/WorkEditForm", ["require", "exports", "endpoint/work/EndpointWorkCreate", "endpoint/work/EndpointWorkUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/RadioRow", "ui/component/core/Textarea", "ui/component/core/TextEditor", "ui/component/core/TextInput", "ui/component/core/toast/Toast", "ui/component/TagsEditor", "ui/component/VanityInput"], function (require, exports, EndpointWorkCreate_1, EndpointWorkUpdate_1, en_nz_16, FormInputLengths_5, Session_25, Component_73, Block_17, Form_3, LabelledTable_3, RadioRow_2, Textarea_1, TextEditor_4, TextInput_7, Toast_4, TagsEditor_2, VanityInput_2) {
    ...
    TextInput_7 = __importDefault(TextInput_7);
    TagsEditor_2 = __importDefault(TagsEditor_2);
    exports.default = Component_73.default.Builder((component, state) => {
        ...
        const vanityInput = (0, TextInput_7.default)()
            ...
            .setMaxLength(FormInputLengths_5.default.map(table, lengths => lengths?.work.vanity));
        ...
        const descriptionInput = (0, Textarea_1.default)()
            ...
            .setMaxLength(FormInputLengths_5.default.map(table, lengths => lengths?.work.description));
        ...
        const synopsisInput = (0, TextEditor_4.default)()
            ...
            .setMaxLength(FormInputLengths_5.default.map(table, lengths => lengths?.work.synopsis));
        ...
        const tagsEditor = (0, TagsEditor_2.default)()
            .default.bind(state)
            .setMaxLengthGlobal(FormInputLengths_5.default.map(table, lengths => lengths?.work_tags.global))
            .setMaxLengthCustom(FormInputLengths_5.default.map(table, lengths => lengths?.work_tags.custom));
            ...
            const response = await (() => {
                switch (type) {
                    ...
                    case 'update': {
                        if (!state.value)
                            return;
                        const authorVanity = Session_25.default.Auth.author.value?.vanity;
                        if (!authorVanity)
                            return new Error('Cannot update a work when not signed in');
...
define("ui/view/WorkEditView", ["require", "exports", "endpoint/work/EndpointWorkGet", "model/Works", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/InfoDialog", "ui/component/core/Slot", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "ui/view/work/WorkEditForm", "utility/State"], function (require, exports, EndpointWorkGet_3, Works_6, Component_74, ActionRow_5, Button_28, InfoDialog_2, Slot_22, View_12, ViewDefinition_13, ViewTransition_4, WorkEditForm_1, State_58) {
    ...
    State_58 = __importDefault(State_58);
    exports.default = (0, ViewDefinition_13.default)({
        ...
        async load(params) {
            ...
            if (response instanceof Error)
                throw response;
            const owner = (0, Component_74.default)();
        ...
        create(params, { work }) {
            ...
            const state = (0, State_58.default)(work);
            const editFormState = (0, State_58.default)(work);
            ...
            (0, Slot_22.default)()
                .use(state, () => createActionRow()?.subviewTransition(id))
                .appendTo(view.content);
            editFormState.subscribe(view, work => ViewTransition_4.default.perform('subview', id, () => state.value = work));
            return view;
            function createActionRow() {
...
define("endpoint/chapter/EndpointChapterGetAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_53) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_53 = __importDefault(Endpoint_53);
    exports.default = (0, Endpoint_53.default)('/work/{author}/{vanity}/chapters/list', 'get');
});
define("endpoint/chapter/EndpointChapterReorder", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_54) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_54 = __importDefault(Endpoint_54);
    exports.default = (0, Endpoint_54.default)('/work/{author}/{work}/chapter/{url}/reorder', 'post');
});
define("endpoint/history/EndpointHistoryAddWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_55) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_55 = __importDefault(Endpoint_55);
    exports.default = (0, Endpoint_55.default)('/history/add/{author}/{vanity}', 'post');
});
define("ui/view/WorkView", ["require", "exports", "endpoint/chapter/EndpointChapterGetAll", "endpoint/chapter/EndpointChapterReorder", "endpoint/history/EndpointHistoryAddWork", "endpoint/work/EndpointWorkGet", "model/PagedListData", "model/Session", "ui/Component", "ui/component/Chapter", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Paginator", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/Work", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Errors", "utility/State"], function (require, exports, EndpointChapterGetAll_1, EndpointChapterReorder_1, EndpointHistoryAddWork_1, EndpointWorkGet_4, PagedListData_7, Session_26, Component_75, Chapter_3, Block_18, Button_29, Paginator_8, Placeholder_8, Slot_23, Work_7, View_13, ViewDefinition_14, Errors_3, State_59) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    State_59 = __importDefault(State_59);
    exports.default = (0, ViewDefinition_14.default)({
        ...
        create(params, { work: workData }) {
            ...
            if (Session_26.default.Auth.loggedIn.value)
            ...
            (0, Work_7.default)(workData, authorData)
                ...
                .setContainsHeading()
                .appendTo(view.content);
            const movingChapter = (0, State_59.default)(undefined);
            const chaptersListState = (0, State_59.default)(null);
            (0, Slot_23.default)()
                ...
                (0, Slot_23.default)()
                    ...
                    (0, Chapter_3.default)(movingChapterData, workData, authorData)
                        ...
                        .insertAction('reorder', 'before', 'delete', Session_26.default.Auth.author, (slot, self) => true
                ...
                .type('flush')
                .tweak(block => (0, Placeholder_8.default)()
                .text.use('view/work/chapters/content/empty')
                .appendTo(block.content))
                .appendTo(slot))
                .setActionsMenu(popover => popover
                .append((0, Slot_23.default)()
                .if(Session_26.default.Auth.author.map(popover, author => author?.vanity === params.author), () => (0, Button_29.default)()
                .setIcon('plus')
                .type('flush')
...
define("ui/utility/StringApplicator", ["require", "exports", "lang/en-nz", "utility/State"], function (require, exports, en_nz_17, State_60) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.QuiltHelper = exports.Quilt = void 0;
    en_nz_17 = __importStar(en_nz_17);
    State_60 = __importDefault(State_60);
    Object.assign(window, { quilt: en_nz_17.default });
    var Quilt;
    (function (Quilt) {
        function fake(text) {
    ...
    (function (QuiltHelper) {
        ...
        function arg(arg) {
            ...
            if (typeof arg === 'function')
                arg = arg(en_nz_17.default, QuiltHelper);
            if (typeof arg === 'string' && arg in en_nz_17.default)
                arg = en_nz_17.default[arg]();
            return arg;
        }
        QuiltHelper.arg = arg;
        function toString(arg) {
            if (State_60.default.is(arg))
                arg = arg.value;
            if (typeof arg !== 'function') {
                const key = arg;
                arg = () => en_nz_17.default[key]();
            }
            return arg(en_nz_17.default, QuiltHelper).toString();
        }
        ...
        function renderWeft(weft) {
            ...
            if (Array.isArray(weft.content))
                ...
                if (!en_nz_17.WeavingArg.isRenderable(weft.content))
    ...
    function BaseStringApplicator(host, defaultValue, set) {
        ...
        let unbind;
        const state = (0, State_60.default)(defaultValue);
        const result = makeApplicator(host);
            ...
            return {
                ...
                use: translation => {
                    ...
                    if (typeof translation === 'string') {
                        translationHandler = undefined;
                        setInternal(en_nz_17.default[translation]());
                        return host;
                    }
                ...
                bind: state => {
                    ...
                    if (typeof state === 'function')
                        state = state(en_nz_17.default, QuiltHelper);
                    if (!State_60.default.is(state)) {
                        setInternal(state);
                        return host;
                    }
                    unbind = state?.use(host, state => {
                        if (typeof state === 'function')
                            state = state(en_nz_17.default, QuiltHelper);
                        setInternal(state);
                    });
                ...
                refresh: () => {
                    if (!translationHandler)
                        return;
                    setInternal(translationHandler(en_nz_17.default, QuiltHelper));
                },
                rehost: makeApplicator,
            };
        }
...
define("ui/utility/TextManipulator", ["require", "exports", "ui/utility/StringApplicator"], function (require, exports, StringApplicator_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    StringApplicator_9 = __importDefault(StringApplicator_9);
    function TextManipulator(component, target = component) {
        return apply(StringApplicator_9.default.Nodes(component, nodes => {
        ...
        function apply(applicator) {
            ...
            return Object.assign(applicator, {
                prepend(text) {
                    target.prepend(...StringApplicator_9.default.render(text));
                    return component;
                },
                append(text) {
                    target.append(...StringApplicator_9.default.render(text));
                    return component;
                },
                rehost(component) {
...
define("ui/component/core/Button", ["require", "exports", "ui/Component", "ui/InputBus", "ui/utility/BrowserListener", "ui/utility/FontsListener", "ui/utility/TypeManipulator", "utility/State", "utility/Type"], function (require, exports, Component_76, InputBus_5, BrowserListener_1, FontsListener_1, TypeManipulator_3, State_61, Type_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    State_61 = __importDefault(State_61);
    Type_2 = __importDefault(Type_2);
    const Button = Component_76.default.Builder('button', (component) => {
        const disabledReasons = new Set();
        const disabled = State_61.default.Generator(() => !!disabledReasons.size);
        const hasSubtext = (0, State_61.default)(false);
        let icon;
        const unuseDisabledStateMap = new WeakMap();
        let unuseIconState;
        const button = component
            .and(InputBus_5.HandlesMouseEvents)
        ...
        function setIcon(newIcon) {
            ...
            button.icon ??= (0, Component_76.default)()
                .style('button-icon')
...
define("ui/component/core/Label", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Form", "ui/component/core/Textarea", "ui/view/shared/component/View", "utility/State"], function (require, exports, Component_77, Button_30, Form_4, Textarea_2, View_14, State_62) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Textarea_2 = __importDefault(Textarea_2);
    View_14 = __importDefault(View_14);
    State_62 = __importDefault(State_62);
    const Label = Component_77.default.Builder('label', (label) => {
        label.style('label');
        const textWrapper = (0, Component_77.default)()
            .style('label-text')
            .appendTo(label);
        const infoButton = (0, Button_30.default)()
        ...
        return label
            .extend(label => ({
            textWrapper,
            for: (0, State_62.default)(undefined),
            setFor: inputName => {
            ...
            setInput: input => {
                ...
                const inputInvalidOwner = State_62.default.Owner.create();
                if (input)
                    State_62.default.Use(inputInvalidOwner, { invalid: input.invalid, touched: input.as(Textarea_2.default)?.touched })
                        .use(inputInvalidOwner, ({ invalid, touched }) => label.style.toggle(!!invalid && (touched ?? true), 'label--invalid'));
    ...
    let globalI = 0;
    exports.AutoLabel = Component_77.default.Builder('label', (component) => {
        const i = globalI++;
...
define("ui/utility/AttributeManipulator", ["require", "exports", "lang/en-nz", "ui/utility/StringApplicator", "utility/State"], function (require, exports, en_nz_18, StringApplicator_10, State_63) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    en_nz_18 = __importDefault(en_nz_18);
    State_63 = __importDefault(State_63);
    function AttributeManipulator(component) {
        ...
        const result = {
            ...
            get(attribute) {
                return attributeStates.compute(attribute, () => (0, State_63.default)(component.element.getAttribute(attribute) ?? undefined));
            },
            append(...attributes) {
                for (const attribute of attributes) {
            ...
            refresh() {
                ...
                for (const attribute in translationHandlers) {
                    ...
                    const weave = typeof translationHandler === 'string' ? en_nz_18.default[translationHandler]() : translationHandler(en_nz_18.default, StringApplicator_10.QuiltHelper);
...
define("ui/Component", ["require", "exports", "lang/en-nz", "ui/utility/AnchorManipulator", "ui/utility/AttributeManipulator", "ui/utility/ClassManipulator", "ui/utility/EventManipulator", "ui/utility/FocusListener", "ui/utility/StringApplicator", "ui/utility/StyleManipulator", "ui/utility/TextManipulator", "ui/utility/Viewport", "utility/Arrays", "utility/Async", "utility/Define", "utility/Env", "utility/Errors", "utility/Objects", "utility/State", "utility/string/Strings"], function (require, exports, en_nz_19, AnchorManipulator_3, AttributeManipulator_1, ClassManipulator_1, EventManipulator_2, FocusListener_2, StringApplicator_11, StyleManipulator_1, TextManipulator_2, Viewport_6, Arrays_11, Async_5, Define_5, Env_9, Errors_4, Objects_10, State_64, Strings_4) {
    ...
    StringApplicator_11 = __importDefault(StringApplicator_11);
    ...
    Errors_4 = __importDefault(Errors_4);
    State_64 = __importDefault(State_64);
    ...
    function Component(type = 'span') {
        ...
        let component = {
            supers: (0, State_64.default)([]),
            isComponent: true,
            isInsertionDestination: true,
            element: document.createElement(type),
            removed: (0, State_64.default)(false),
            rooted: (0, State_64.default)(false),
            get tagName() {
            ...
            get hovered() {
                return Define_5.default.set(component, 'hovered', (0, State_64.default)(false));
            },
            get focused() {
                return Define_5.default.set(component, 'focused', (0, State_64.default)(false));
            },
            get hasFocused() {
                return Define_5.default.set(component, 'hasFocused', (0, State_64.default)(false));
            },
            get hadFocusedLast() {
                return Define_5.default.set(component, 'hadFocusedLast', (0, State_64.default)(false));
            },
            get hoveredOrFocused() {
                return Define_5.default.set(component, 'hoveredOrFocused', State_64.default.Generator(() => component.hovered.value || component.focused.value)
                    .observe(component, component.hovered, component.focused));
            },
            get hoveredOrHasFocused() {
                return Define_5.default.set(component, 'hoveredOrHasFocused', State_64.default.Generator(() => component.hovered.value || component.hasFocused.value)
                    .observe(component, component.hovered, component.hasFocused));
            },
            get active() {
                return Define_5.default.set(component, 'active', (0, State_64.default)(false));
            },
            get id() {
                return Define_5.default.set(component, 'id', (0, State_64.default)(undefined));
            },
            get name() {
                return Define_5.default.set(component, 'name', (0, State_64.default)(undefined));
            },
            get rect() {
                const rectState = State_64.default.JIT(() => component.element.getBoundingClientRect());
            ...
            setRandomId: () => {
                component.setId(Strings_4.default.uid());
                return component;
            },
            setName: name => {
                unuseNameState?.();
            ...
            append(...contents) {
                const elements = contents.filter(Arrays_11.Truthy).map(Component.element);
            ...
            getStateForClosest(builders) {
                const state = State_64.default.JIT(() => component.closest(builders));
                component.receiveAncestorInsertEvents();
                component.onRooted(() => {
                    state.markDirty();
            ...
            *getDescendants(builder) {
            ...
            get ariaLabel() {
                return Define_5.default.set(component, 'ariaLabel', (0, StringApplicator_11.default)(component, value => component.attributes.set('aria-label', value)));
            },
            ariaLabelledBy: labelledBy => {
                unuseAriaLabelledByIdState?.();
                if (labelledBy) {
                    const state = State_64.default.Generator(() => labelledBy.id.value ?? labelledBy.attributes.get('for'))
        ...
        en_nz_19.WeavingArg.setRenderable(component);
        for (const extension of componentExtensionsRegistry)
            extension(component);
        if (!Component.is(component))
            throw Errors_4.default.Impossible();
    ...
    (function (Component) {
        ...
        function Builder(initialOrBuilder, builder) {
            ...
            async function ensureOriginalComponentNotSubscriptionOwner(original) {
                if (!original || !State_64.default.OwnerMetadata.hasSubscriptions(original))
                    return;
        ...
        function Extension(builder) {
            return {
                ...
                from: builder,
                setName(newName) {
                    (0, Objects_10.mutable)(this).name = addKebabCase(newName);
                    return this;
                },
            };
        }
        ...
        function getBuilderName() {
            const stack = Strings_4.default.shiftLine((new Error().stack ?? ''), 3);
...
define("utility/State", ["require", "exports", "utility/Arrays", "utility/Define", "utility/Functions"], function (require, exports, Arrays_12, Define_6, Functions_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Define_6 = __importDefault(Define_6);
    Functions_3 = __importDefault(Functions_3);
    ...
    function State(defaultValue, equals) {
        ...
        const result = {
            ...
            subscribe: (owner, subscriber) => {
                ...
                if (!ownerClosedState || ownerClosedState.value)
                    return Functions_3.default.NO_OP;
                function cleanup() {
            ...
            get nonNullish() {
                return Define_6.default.set(result, 'nonNullish', State
                    .Generator(() => result.value !== undefined && result.value !== null)
                    .observeManual(result));
            },
            get truthy() {
                return Define_6.default.set(result, 'truthy', State
        ...
        function getNot() {
            const not = State
                .Generator(() => !result.value)
                .observeManual(result);
            Define_6.default.set(result, 'not', not);
            Define_6.default.set(result, 'falsy', not);
            return not;
        }
    }
    (function (State) {
        ...
        function Generator(generate, equals) {
            ...
            Define_6.default.magic(result, 'value', {
        ...
        function Map(owner, inputs, outputGenerator, equals) {
            return Generator(() => outputGenerator(...inputs.map(input => input?.value)), equals)
                .observe(owner, ...inputs.filter(Arrays_12.NonNullish));
        }
        State.Map = Map;
        function MapManual(inputs, outputGenerator, equals) {
            return Generator(() => outputGenerator(...inputs.map(input => input?.value)), equals)
                .observeManual(...inputs.filter(Arrays_12.NonNullish));
        }
        ...
        function Use(owner, input) {
            return Generator(() => Object.entries(input).toObject(([key, state]) => [key, state?.value]))
                .observe(owner, ...Object.values(input).filter(Arrays_12.NonNullish));
        }
        State.Use = Use;
        function UseManual(input) {
            return Generator(() => Object.entries(input).toObject(([key, state]) => [key, state?.value]))
                .observeManual(...Object.values(input).filter(Arrays_12.NonNullish));
        }
        State.UseManual = UseManual;
    })(State || (State = {}));
    exports.default = State;
});
define("utility/Env", ["require", "exports", "utility/State"], function (require, exports, State_65) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_65 = __importDefault(State_65);
    class Env {
        #loaded = false;
        #onLoad = [];
        state = (0, State_65.default)(undefined);
        get isDev() {
...
define("endpoint/Endpoint", ["require", "exports", "utility/Env", "utility/Objects", "utility/Time"], function (require, exports, Env_10, Objects_11, Time_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Env_10 = __importDefault(Env_10);
    Objects_11 = __importDefault(Objects_11);
    ...
    function Endpoint(route, method, headers) {
                ...
                return Object.assign(endpoint, {
                    query: (...p2) => {
                        ...
                        for (let i = 0; i < length; i++)
                            newParameters.push(Objects_11.default.merge(parameters[i], p2[i]));
        ...
        async function query(data, search) {
            ...
            for (let i = 0; shouldRetry && i < 3; i++) {
                ...
                response = undefined;
                shouldRetry = false;
                response = await fetch(`${Env_10.default.API_ORIGIN}${url}${qs}`, {
                    method,
                    headers: Objects_11.default.filterNullish({
                        ...!Env_10.default.API_ORIGIN.includes('ngrok') ? undefined : { 'ngrok-skip-browser-warning': 'true' },
                        'Content-Type': body ? 'application/json' : undefined,
                        'Accept': 'application/json',
                        'App-Build-Number': Env_10.default.BUILD_NUMBER,
                        'App-Build-SHA': Env_10.default.BUILD_SHA,
                        ...headers,
                    }),
                    credentials: 'include',
                    body,
                    signal: AbortSignal.timeout(Time_10.default.seconds(7)),
                }).catch((e) => {
    ...
    (function (Endpoint) {
        function path(route) {
            return `${Env_10.default.API_ORIGIN.slice(0, -1)}${route}`;
        }
        Endpoint.path = path;
    })(Endpoint || (Endpoint = {}));
    exports.default = Endpoint;
});
define("endpoint/manifest/EndpointFormInputLengths", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_56) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_56 = __importDefault(Endpoint_56);
    exports.default = (0, Endpoint_56.default)('/manifest/form/lengths', 'get');
});
...
define("ui/view/ErrorView", ["require", "exports", "lang/en-nz", "ui/component/core/Heading", "ui/component/core/Paragraph", "ui/component/core/Placeholder", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, en_nz_20, Heading_6, Paragraph_4, Placeholder_9, View_15, ViewDefinition_15) {
    ...
    exports.default = (0, ViewDefinition_15.default)({
        create: (params) => {
            ...
            if (key in en_nz_20.default)
                (0, Paragraph_4.default)()
                    .and(Placeholder_9.default)
                    .text.use(key)
                    .appendTo(view.content);
            return view;
        },
...
define("ui/view/shared/component/ViewContainer", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Dialog", "ui/component/core/Loading", "ui/view/AccountView", "ui/view/ErrorView", "ui/view/RequireLoginView", "ui/view/shared/ext/ViewTransition", "utility/State"], function (require, exports, Session_27, Component_78, Button_32, Dialog_3, Loading_2, AccountView_3, ErrorView_1, RequireLoginView_1, ViewTransition_5, State_66) {
    ...
    State_66 = __importDefault(State_66);
    let globalId = 0;
    const ViewContainer = () => {
        let cancelLogin;
        const state = (0, State_66.default)(undefined);
        const container = (0, Component_78.default)()
            ...
            show: async (definition, params) => {
                ...
                const needsLogin = definition.requiresLogin && !Session_27.default.Auth.loggedIn.value;
                if (needsLogin || definition.load) {
                    ...
                    await loginPromise;
                    if (needsLogin && !Session_27.default.Auth.loggedIn.value) {
                        let setLoggedIn;
                        ...
                        ViewTransition_5.default.perform('view', async () => {
                            ...
                            if (!view)
                                return;
                            Session_27.default.Auth.loggedIn.subscribe(view, loggedIn => loggedIn && setLoggedIn());
                        });
                        await loggedIn;
                    }
                }
        ...
        function logIn() {
            if (Session_27.default.Auth.author.value)
                return;
            ...
            const authPromise = accountViewShown.then(async (view) => {
                ...
                await Promise.race([
                    Session_27.default.Auth.await(view),
                    loginCancelledPromise,
                ]);
                cancelLogin = undefined;
                return Session_27.default.Auth.loggedIn.value;
            });
            return {
                accountViewShown,
                authed: authPromise,
...
define("ui/component/PrimaryNav", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Heading", "ui/component/core/Link", "ui/component/core/Slot", "ui/utility/StringApplicator", "utility/Env"], function (require, exports, Session_28, Component_79, Button_33, Heading_7, Link_17, Slot_24, StringApplicator_12, Env_12) {
    ...
    exports.default = Component_79.default.Builder(nav => {
        ...
        Group('top', 'sidebar/section/browse')
            ...
            .using(Session_28.default.Auth.author, (group, author) => group
            ...
            .setDisabled(!author, 'no author')));
        (0, Slot_24.default)()
            .use(Session_28.default.Auth.author, (slot, author) => author
            && Group('top', 'sidebar/section/create')
                .tweak(group => {
                for (const work of author.works ?? [])
                    group.add(`/work/${work.author}/${work.vanity}`, StringApplicator_12.Quilt.fake(work.name), button => button.setIcon('book'));
            })
                .add('/work/new', 'sidebar/link/create-work', button => button.setIcon('plus')))
            .appendTo(top);
        Group('bottom', 'sidebar/section/profile')
            .using(Session_28.default.Auth.author, (group, author) => {
            if (author)
                group
                    .add(`/author/${author.vanity}`, StringApplicator_12.Quilt.fake(author.name), button => button
                    .setIcon('circle-user')
...
define("ui/component/Sidebar", ["require", "exports", "ui/Component", "utility/Store"], function (require, exports, Component_80, Store_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_80 = __importDefault(Component_80);
    Store_5 = __importDefault(Store_5);
    const Sidebar = Component_80.default.Builder('nav', (sidebar) => {
...
define("ui/component/Masthead", ["require", "exports", "model/Notifications", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Flag", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/NotificationList", "ui/component/PrimaryNav", "ui/component/Sidebar", "ui/utility/Viewport", "utility/AbortPromise", "utility/Env"], function (require, exports, Notifications_3, Session_29, Component_81, Button_34, Flag_2, Link_18, Slot_25, NotificationList_2, PrimaryNav_1, Sidebar_1, Viewport_7, AbortPromise_8, Env_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MastheadFlush = void 0;
    Notifications_3 = __importDefault(Notifications_3);
    Session_29 = __importDefault(Session_29);
    Component_81 = __importDefault(Component_81);
    Button_34 = __importDefault(Button_34);
    Flag_2 = __importDefault(Flag_2);
    Link_18 = __importDefault(Link_18);
    Slot_25 = __importDefault(Slot_25);
    ...
    const Masthead = Component_81.default.Builder('header', (masthead, view) => {
        ...
        (0, Button_34.default)()
            ...
            .appendTo(masthead);
        let popover;
        const left = (0, Component_81.default)()
            .append((0, Component_81.default)()
            .and(Button_34.default)
            .setIcon('bars')
            .type('icon')
            .style('masthead-left-hamburger', 'masthead-left-hamburger-sidebar')
            .ariaHidden()
            .event.subscribe('click', sidebar.toggle))
            .append((0, Button_34.default)()
            .setIcon('bars')
            .type('icon')
        ...
        HomeLink()
            ...
            .appendTo(left);
        (0, Component_81.default)()
            .style('masthead-search')
            .appendTo(masthead);
        (0, Slot_25.default)()
            .style.remove('slot')
            .style('masthead-user')
            .if(Session_29.default.Auth.loggedIn, slot => slot
            ////////////////////////////////////
            ...
            .append((0, Slot_25.default)().use(Notifications_3.default.unreadCount, (slot, count) => !count ? undefined
            : (0, Component_81.default)()
            ...
            .append((0, Slot_25.default)().use(Notifications_3.default.cache, AbortPromise_8.default.asyncFunction(async (signal, slot, notifications) => {
            ...
            for (const action of list.paginator.primaryActions.getChildren())
                if (action.is(Button_34.default))
            ...
            .anchor.add('aligned right', 'off top')
            .ariaRole('navigation')
            .append((0, Slot_25.default)()
            .style('action-group')
            .style.remove('slot')
            .use(Session_29.default.Auth.author, (slot, author) => {
            if (!author)
                return;
            ...
            (0, Button_34.default)()
                ...
                .text.use('view/account/action/logout')
                .event.subscribe('click', () => Session_29.default.reset())
                .appendTo(slot);
        }))))
        //#endregion
        ////////////////////////////////////
        )
            .else(() => (0, Button_34.default)()
        ...
        return masthead.extend(masthead => ({
            sidebar,
            flush: (0, exports.MastheadFlush)(),
        }));
    });
    exports.default = Masthead;
    const HomeLink = Component_81.default.Builder('a', (component) => {
        const flag = (0, Flag_2.default)()
            .style('masthead-home-logo');
        const homeLink = component.and(Link_18.default, '/')
            ...
            .append(flag)
            .append((0, Component_81.default)('img')
    ...
    exports.MastheadFlush = Component_81.default.Builder('header', (masthead) => {
        return masthead
            .style('masthead-flush')
            .append(HomeLink());
    });
});
define("ui/component/Mention", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/Link", "ui/utility/MarkdownContent"], function (require, exports, en_nz_21, Component_82, Link_19, MarkdownContent_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.registerMarkdownMentionHandler = registerMarkdownMentionHandler;
    en_nz_21 = __importDefault(en_nz_21);
    Component_82 = __importDefault(Component_82);
    Link_19 = __importDefault(Link_19);
    MarkdownContent_5 = __importDefault(MarkdownContent_5);
    const Mention = Component_82.default.Builder('a', (component, author) => {
        return component
            .and(Link_19.default, author && `/author/${author.vanity}`)
            .append((0, Component_82.default)().style('mention-punctuation').text.set('@'))
            .append((0, Component_82.default)().style('mention-author-name').text.set(author?.name ?? en_nz_21.default['shared/mention/unresolved']()))
            .style('mention');
    });
    exports.default = Mention;
    function registerMarkdownMentionHandler() {
        MarkdownContent_5.default.handle((element, context) => {
...
define("App", ["require", "exports", "lang/en-nz", "model/FormInputLengths", "model/Notifications", "model/Session", "navigation/Navigate", "style", "ui/Component", "ui/component/core/ExternalLink", "ui/component/core/Link", "ui/component/core/toast/ToastList", "ui/component/Masthead", "ui/component/Mention", "ui/InputBus", "ui/utility/ActiveListener", "ui/utility/FocusListener", "ui/utility/FontsListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/StringApplicator", "ui/utility/Viewport", "ui/view/shared/component/ViewContainer", "utility/DevServer", "utility/Env", "utility/State", "utility/Store", "utility/string/Strings"], function (require, exports, en_nz_22, FormInputLengths_6, Notifications_4, Session_30, Navigate_1, style_2, Component_83, ExternalLink_3, Link_20, ToastList_1, Masthead_1, Mention_1, InputBus_6, ActiveListener_1, FocusListener_3, FontsListener_2, HoverListener_2, Mouse_5, StringApplicator_13, Viewport_8, ViewContainer_1, DevServer_2, Env_14, State_67, Store_6, Strings_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    en_nz_22 = __importDefault(en_nz_22);
    FormInputLengths_6 = __importDefault(FormInputLengths_6);
    Notifications_4 = __importDefault(Notifications_4);
    Session_30 = __importDefault(Session_30);
    Navigate_1 = __importDefault(Navigate_1);
    style_2 = __importDefault(style_2);
    Component_83 = __importDefault(Component_83);
    ExternalLink_3 = __importDefault(ExternalLink_3);
    Link_20 = __importDefault(Link_20);
    ToastList_1 = __importDefault(ToastList_1);
    Masthead_1 = __importDefault(Masthead_1);
    InputBus_6 = __importDefault(InputBus_6);
    ...
    State_67 = __importDefault(State_67);
    Store_6 = __importDefault(Store_6);
    Strings_5 = __importDefault(Strings_5);
    ...
    StringApplicator_13.QuiltHelper.init({
        Component: Component_83.default,
        Link: Link_20.default,
        ExternalLink: ExternalLink_3.default,
    });
    ...
    async function App() {
        ...
        InputBus_6.default.subscribe('down', event => {
            if (event.use('F6'))
        ...
        InputBus_6.default.subscribe('up', event => {
            if (event.use('F4'))
                document.documentElement.classList.remove('persist-tooltips');
        });
        Component_83.default.allowBuilding();
        void FormInputLengths_6.default.getManifest();
        ...
        document.title = en_nz_22.default['fluff4me/title']().toString();
        ...
        State_67.default.UseManual({
            ...
            notificationCount: Notifications_4.default.unreadCount,
        }).mapManual(({ viewTitle, returnTo, notificationCount }) => {
            document.title = en_nz_22.default['fluff4me/title']({
                NOTIFICATIONS: notificationCount,
                PAGE: viewTitle,
                PAGE2: Strings_5.default.areSameWords(viewTitle ?? undefined, returnTo ?? undefined) ? undefined : returnTo,
            }).toString();
        });
        const related = (0, Component_83.default)()
            .style('app-content-related');
        const content = (0, Component_83.default)()
            .style('app-content')
            .append(view, related);
        Component_83.default.wrap(document.body).monitorScrollEvents();
        Component_83.default.wrap(document.documentElement).monitorScrollEvents();
        Component_83.default.wrap(window).monitorScrollEvents();
        const app = (0, Component_83.default)()
            .style('app')
        ...
        if (Env_14.default.isNgrok)
            (0, Component_83.default)()
                ...
                .appendTo(document.body);
        (0, ExternalLink_3.default)(undefined)
            .style('app-version')
            .attributes.bind('href', Env_14.default.state.mapManual(env => !env?.BUILD_SHA ? undefined : `https://github.com/fluff4me/fluff4.me/commit/${env.BUILD_SHA}`))
            .text.bind(Env_14.default.state.mapManual(env => !env ? ''
            : !env.BUILD_SHA
                ? 'dev'
...
define("utility/DOMRect", ["require", "exports", "utility/Define", "utility/maths/Vector2"], function (require, exports, Define_7, Vector2_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function default_1() {
        Define_7.default.magic(DOMRect.prototype, 'centreX', {
            get() {
                return this.left + this.width / 2;
            },
        });
        Define_7.default.magic(DOMRect.prototype, 'centreY', {
            get() {
                return this.top + this.height / 2;
            },
        });
        Define_7.default.magic(DOMRect.prototype, 'centre', {
            get() {
                return (0, Vector2_3.default)(this.left + this.width / 2, this.top + this.height / 2);
            },
        });
        Define_7.default.magic(DOMRect.prototype, 'position', {
            get() {
                return (0, Vector2_3.default)(this.left, this.top);
            },
        });
        (0, Define_7.default)(DOMRect.prototype, 'expand', function (amount) {
            return new DOMRect(this.x - amount, this.y - amount, this.width + amount * 2, this.height + amount * 2);
        });
        (0, Define_7.default)(DOMRect.prototype, 'contract', function (amount) {
        ...
        (0, Define_7.default)(DOMRect.prototype, 'intersects', function (target) {
            if ('width' in target)
                return true
...
define("utility/Elements", ["require", "exports", "utility/Define"], function (require, exports, Define_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Elements) {
        function applyPrototypes() {
            Define_8.default.set(Element.prototype, 'asType', function (tagName) {
...
define("utility/Maps", ["require", "exports", "utility/Define"], function (require, exports, Define_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Define_9 = __importDefault(Define_9);
    var Maps;
    (function (Maps) {
        function applyPrototypes() {
            (0, Define_9.default)(Map.prototype, 'compute', function (key, provider) {
                if (this.has(key))
                    return this.get(key);
...
define("index", ["require", "exports", "utility/Arrays", "utility/DOMRect", "utility/Elements", "utility/Env", "utility/Import", "utility/Maps"], function (require, exports, Arrays_13, DOMRect_1, Elements_1, Env_15, Import_1, Maps_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Arrays_13 = __importDefault(Arrays_13);
    ...
    (0, DOMRect_1.default)();
    Arrays_13.default.applyPrototypes();
...
define("endpoint/chapter/EndpointChapterSetVisibility", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_57) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_57 = __importDefault(Endpoint_57);
    exports.default = (0, Endpoint_57.default)('/work/{author}/{work}/chapters/setvisibility', 'post');
});
define("endpoint/follow/EndpointFollowGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_58) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_58 = __importDefault(Endpoint_58);
    exports.default = {
        Author: (0, Endpoint_58.default)('/follows/author/{vanity}', 'get'),
        Work: (0, Endpoint_58.default)('/follows/work/{vanity}', 'get'),
        Tag: (0, Endpoint_58.default)('/follows/tag/{vanity}', 'get'),
        Category: (0, Endpoint_58.default)('/follows/category/{vanity}', 'get'),
    };
});
define("endpoint/follow/EndpointFollowGetAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_59) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_59 = __importDefault(Endpoint_59);
    exports.default = (0, Endpoint_59.default)('/following/{type}', 'get');
});
define("endpoint/follow/EndpointFollowGetWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_60) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_60 = __importDefault(Endpoint_60);
    exports.default = (0, Endpoint_60.default)('/follows/work/{author}/{vanity}', 'get');
});
define("endpoint/follow/EndpointIgnoreGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_61) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_61 = __importDefault(Endpoint_61);
    exports.default = {
        Author: (0, Endpoint_61.default)('/ignores/author/{vanity}', 'get'),
        Work: (0, Endpoint_61.default)('/ignores/work/{vanity}', 'get'),
        Tag: (0, Endpoint_61.default)('/ignores/tag/{vanity}', 'get'),
        Category: (0, Endpoint_61.default)('/ignores/category/{vanity}', 'get'),
    };
});
define("endpoint/follow/EndpointIgnoreGetAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_62) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_62 = __importDefault(Endpoint_62);
    exports.default = (0, Endpoint_62.default)('/ignoring/{type}', 'get');
});
define("endpoint/follow/EndpointIgnoreGetWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_63) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_63 = __importDefault(Endpoint_63);
    exports.default = (0, Endpoint_63.default)('/ignores/work/{author}/{vanity}', 'get');
});
define("endpoint/history/EndpointHistoryDeleteChapter", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_64) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_64 = __importDefault(Endpoint_64);
    exports.default = (0, Endpoint_64.default)('/history/delete/{author}/{work}/chapter/{url}', 'post');
});
define("endpoint/history/EndpointHistoryDeleteWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_65) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_65 = __importDefault(Endpoint_65);
    exports.default = (0, Endpoint_65.default)('/history/delete/{author}/{vanity}', 'post');
});
define("endpoint/notification/EndpointNotificationGetUnread", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_66) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_66 = __importDefault(Endpoint_66);
    exports.default = (0, Endpoint_66.default)('/notifications/get/unread', 'get');
});
define("endpoint/patreon/EndpointPatreonGetTiers", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_67) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_67 = __importDefault(Endpoint_67);
    exports.default = (0, Endpoint_67.default)('/patreon/campaign/tiers/get', 'get');
});
define("endpoint/privilege/EndpointPrivilegeGetAllAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_68) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_68 = __importDefault(Endpoint_68);
    exports.default = (0, Endpoint_68.default)('/privilege/get/{vanity}', 'get');
});
define("endpoint/privilege/EndpointPrivilegeGrantAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_69) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_69 = __importDefault(Endpoint_69);
    exports.default = (0, Endpoint_69.default)('/privilege/grant/author/{vanity}', 'post');
});
define("endpoint/privilege/EndpointPrivilegeGrantRole", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_70) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_70 = __importDefault(Endpoint_70);
    exports.default = (0, Endpoint_70.default)('/privilege/grant/role/{vanity}', 'post');
});
define("endpoint/privilege/EndpointPrivilegeRevokeAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_71) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_71 = __importDefault(Endpoint_71);
    exports.default = (0, Endpoint_71.default)('/privilege/revoke/author/{vanity}', 'post');
});
define("endpoint/privilege/EndpointPrivilegeRevokeRole", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_72) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_72 = __importDefault(Endpoint_72);
    exports.default = (0, Endpoint_72.default)('/privilege/revoke/role/{vanity}', 'post');
});
define("endpoint/role/EndpointRoleCreate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_73) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_73 = __importDefault(Endpoint_73);
    exports.default = (0, Endpoint_73.default)('/role/create', 'post');
});
define("endpoint/role/EndpointRoleDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_74) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_74 = __importDefault(Endpoint_74);
    exports.default = (0, Endpoint_74.default)('/role/delete/{role}', 'post');
});
define("endpoint/role/EndpointRoleGrantAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_75) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_75 = __importDefault(Endpoint_75);
    exports.default = (0, Endpoint_75.default)('/role/grant/{role}/{author}', 'post');
});
define("endpoint/role/EndpointRoleListAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_76) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_76 = __importDefault(Endpoint_76);
    exports.default = (0, Endpoint_76.default)('/role/get', 'get');
});
define("endpoint/role/EndpointRoleReorder", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_77) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_77 = __importDefault(Endpoint_77);
    exports.default = (0, Endpoint_77.default)('/role/reorder', 'post');
});
define("endpoint/role/EndpointRoleRevokeAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_78) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_78 = __importDefault(Endpoint_78);
    exports.default = (0, Endpoint_78.default)('/role/revoke/{role}/{author}', 'post');
});
define("endpoint/role/EndpointRoleUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_79) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_79 = __importDefault(Endpoint_79);
    exports.default = (0, Endpoint_79.default)('/role/update/{role}', 'post');
});
define("endpoint/tag/EndpointTagCreateCategory", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_80) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_80 = __importDefault(Endpoint_80);
    exports.default = (0, Endpoint_80.default)('/tag/create/category', 'post');
});
define("endpoint/tag/EndpointTagCreateGlobal", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_81) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_81 = __importDefault(Endpoint_81);
    exports.default = (0, Endpoint_81.default)('/tag/create/global', 'post');
});
define("endpoint/tag/EndpointTagCustomPromote", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_82) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_82 = __importDefault(Endpoint_82);
    exports.default = (0, Endpoint_82.default)('/tag/promote', 'post');
});
define("endpoint/tag/EndpointTagDeleteCategory", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_83) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_83 = __importDefault(Endpoint_83);
    exports.default = (0, Endpoint_83.default)('/tag/delete/category/{vanity}', 'post');
});
define("endpoint/tag/EndpointTagDeleteGlobal", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_84) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_84 = __importDefault(Endpoint_84);
    exports.default = (0, Endpoint_84.default)('/tag/delete/global/{vanity}', 'post');
});
define("endpoint/tag/EndpointTagGlobalDemote", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_85) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_85 = __importDefault(Endpoint_85);
    exports.default = (0, Endpoint_85.default)('/tag/demote/{vanity}', 'post');
});
define("endpoint/tag/EndpointTagUpdateCategory", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_86) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_86 = __importDefault(Endpoint_86);
    exports.default = (0, Endpoint_86.default)('/tag/update/category/{vanity}', 'post');
});
define("endpoint/tag/EndpointTagUpdateGlobal", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_87) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_87 = __importDefault(Endpoint_87);
    exports.default = (0, Endpoint_87.default)('/tag/update/global/{vanity}', 'post');
});
define("ui/component/core/ActionHeading", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Heading"], function (require, exports, Component_84, ActionRow_7, Heading_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_84 = __importDefault(Component_84);
    ActionRow_7 = __importDefault(ActionRow_7);
    Heading_8 = __importDefault(Heading_8);
    const ActionHeading = Component_84.default.Builder((component) => {
        const row = component.and(ActionRow_7.default)
            .viewTransition('action-heading')
            .style('action-heading');
        const heading = row.left.and(Heading_8.default).style('action-heading-heading');
...
define("ui/view/TestView", ["require", "exports", "markdown-it", "ui/Component", "ui/component/core/Block", "ui/component/core/TextEditor", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Env", "utility/string/MarkdownItHTML"], function (require, exports, markdown_it_2, Component_85, Block_20, TextEditor_5, View_17, ViewDefinition_17, Env_16, MarkdownItHTML_2) {
    ...
    exports.default = (0, ViewDefinition_17.default)({
        create: () => {
            ...
            const block = (0, Block_20.default)().appendTo(view.content);
            ...
            if (Env_16.default.isDev) {
                (0, Component_85.default)('br').appendTo(block.content);
                const output = (0, Component_85.default)('div');
                (0, Component_85.default)('div')
                    .attributes.set('contenteditable', 'plaintext-only')
...
define("utility/Tuples", ["require", "exports", "utility/Arrays"], function (require, exports, Arrays_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Arrays_14 = __importDefault(Arrays_14);
    var Tuples;
    (function (Tuples) {
        ...
        Tuples.make = make;
        const nullishFilters = Object.fromEntries(Arrays_14.default.range(6)
        ...
        const falsyFilters = Object.fromEntries(Arrays_14.default.range(6)
            // eslint-disable-next-line @typescript-eslint/no-unsafe-return
