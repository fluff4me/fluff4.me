...
define("ui/Announcer", ["require", "exports", "ui/Component"], function (require, exports, Component_21) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_21 = __importDefault(Component_21);
    var Announcer;
    (function (Announcer) {
        const assertive = (0, Component_21.default)()
        ...
        const polite = (0, Component_21.default)()
        ...
        function announceInternal(within, id, announcer) {
            ...
            announcer(keyOrHandler => {
                components.push((0, Component_21.default)("p")
...
define("ui/InputBus", ["require", "exports", "utility/EventManager"], function (require, exports, EventManager_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/utility/HoverListener", ["require", "exports", "ui/utility/Mouse"], function (require, exports, Mouse_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/Popover", ["require", "exports", "ui/Component", "ui/InputBus", "ui/utility/HoverListener", "ui/utility/Mouse", "utility/State", "utility/Task"], function (require, exports, Component_22, InputBus_1, HoverListener_1, Mouse_3, State_15, Task_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const FOCUS_TRAP = (0, Component_22.default)()
        .tabIndex("auto")
        .ariaHidden()
        .style.setProperty("display", "none")
        .prependTo(document.body);
    Component_22.default.extend(component => {
                ...
                async function updatePopoverState() {
                    const shouldShow = false
                        ...
                        || (true
                            && isShown
                            && (false
                                || popover.rect.value.expand(+popover.attributes.get("data-popover-mouse-padding") || 100).intersects(Mouse_3.default.state.value)
                                || InputBus_1.default.isDown("F4"))
                            && (popover.element.contains(HoverListener_1.default.hovered() ?? null) || !HoverListener_1.default.hovered()?.closest("[data-clear-popover]")))
                        || clickState;
    ...
    const Popover = Component_22.default.Builder((popover) => {
        let unbind;
        return popover
            .style("popover")
            ...
            .extend(popover => ({
            visible: (0, State_15.default)(false),
            setMousePadding: (padding) => popover.attributes.set("data-popover-mouse-padding", padding === undefined ? undefined : `${padding}`),
            show: () => {
                unbind?.();
...
define("ui/component/core/TextEditor", ["require", "exports", "markdown-it", "prosemirror-commands", "prosemirror-dropcursor", "prosemirror-example-setup", "prosemirror-gapcursor", "prosemirror-history", "prosemirror-keymap", "prosemirror-markdown", "prosemirror-model", "prosemirror-state", "prosemirror-view", "ui/Announcer", "ui/Component", "ui/component/core/Button", "ui/component/core/Checkbutton", "ui/component/core/extension/Input", "ui/component/core/Slot", "utility/Arrays", "utility/Objects", "utility/State", "w3c-keyname"], function (require, exports, markdown_it_1, prosemirror_commands_1, prosemirror_dropcursor_1, prosemirror_example_setup_1, prosemirror_gapcursor_1, prosemirror_history_1, prosemirror_keymap_1, prosemirror_markdown_1, prosemirror_model_1, prosemirror_state_1, prosemirror_view_1, Announcer_1, Component_23, Button_5, Checkbutton_2, Input_2, Slot_2, Arrays_3, Objects_3, State_16, w3c_keyname_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let globalid = 0;
    const TextEditor = Component_23.default.Builder((component) => {
        const id = globalid++;
        const isMarkdown = (0, State_16.default)(false);
        const content = (0, State_16.default)("");
        const state = (0, State_16.default)(undefined);
        ////////////////////////////////////
        //#region ToolbarButton
        const ToolbarButtonGroup = Component_23.default.Builder(component => component
            .ariaRole("group")
            .style("text-editor-toolbar-button-group"));
        const ToolbarButtonMark = Component_23.default.Builder((_, type) => {
        ...
        const ToolbarButtonWrap = Component_23.default.Builder((_, type) => {
        ...
        const ToolbarButtonBlockType = Component_23.default.Builder((_, type) => {
            const node = schema.nodes[type.replaceAll("-", "_")];
        ...
        const ToolbarButtonPopover = Component_23.default.Builder((_, type, initialiser) => {
            return (0, Button_5.default)()
        ...
        //#endregion
        ////////////////////////////////////
        const toolbar = (0, Component_23.default)()
        ...
        const editor = component
            ...
            .style("text-editor")
            .event.subscribe("click", (event) => {
            const target = Component_23.default.get(event.target);
        ...
        function createDefaultView(slot) {
            ...
            editor.mirror = view;
            editor.document = (0, Component_23.default)()
                .and(Input_2.default)
...
define("ui/component/core/Link", ["require", "exports", "ui/Component", "utility/Env"], function (require, exports, Component_24, Env_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_24 = __importDefault(Component_24);
    Env_5 = __importDefault(Env_5);
    const Link = Component_24.default.Builder("a", (component, route) => {
...
define("ui/component/masthead/Flag", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_25, Arrays_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_25 = __importDefault(Component_25);
    Arrays_4 = __importDefault(Arrays_4);
    const Flag = Component_25.default.Builder((component) => {
        const stripes = Arrays_4.default.range(5)
            .map(i => (0, Component_25.default)()
...
define("ui/component/PrimaryNav", ["require", "exports", "ui/Component"], function (require, exports, Component_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_26 = __importDefault(Component_26);
    exports.default = Component_26.default.Builder(nav => {
        // Heading()
        // 	.text.set("hi")
        // 	.appendTo(nav)
        return nav;
...
define("ui/component/Sidebar", ["require", "exports", "ui/Component", "utility/Store"], function (require, exports, Component_27, Store_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_27 = __importDefault(Component_27);
    Store_3 = __importDefault(Store_3);
    const Sidebar = Component_27.default.Builder("nav", (sidebar) => {
...
define("ui/ViewContainer", ["require", "exports", "ui/Component", "ui/view/component/ViewTransition", "ui/view/ErrorView"], function (require, exports, Component_28, ViewTransition_5, ErrorView_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ViewContainer = () => (0, Component_28.default)()
...
define("ui/component/Masthead", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Heading", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/masthead/Flag", "ui/component/PrimaryNav", "ui/component/Sidebar", "ui/utility/Viewport", "utility/Env", "utility/Task"], function (require, exports, Session_6, Component_29, Button_6, Heading_3, Link_1, Slot_3, Flag_1, PrimaryNav_1, Sidebar_1, Viewport_3, Env_6, Task_2) {
    ...
    const Masthead = Component_29.default.Builder("header", (masthead, view) => {
        ...
        (0, Button_6.default)()
            ...
            .appendTo(masthead);
        let popover;
        const left = (0, Component_29.default)()
        ...
        const homeLink = (0, Link_1.default)("/")
            ...
            .style("masthead-home")
            .append(flag)
            .append((0, Component_29.default)("img")
...
define("App", ["require", "exports", "lang/en-nz", "model/Session", "navigation/Navigate", "style", "ui/Component", "ui/component/Masthead", "ui/InputBus", "ui/utility/FocusListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/Viewport", "ui/ViewContainer", "utility/Async", "utility/Env", "utility/Store", "utility/Time"], function (require, exports, en_nz_5, Session_7, Navigate_1, style_2, Component_30, Masthead_1, InputBus_2, FocusListener_2, HoverListener_2, Mouse_4, Viewport_4, ViewContainer_1, Async_2, Env_7, Store_4, Time_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    async function App() {
        ...
        InputBus_2.default.subscribe("keydown", event => {
            if (event.use("F6"))
        ...
        InputBus_2.default.subscribe("keyup", event => {
            if (event.use("F4"))
        ...
        const related = (0, Component_30.default)()
            .style("app-content-related");
        const content = (0, Component_30.default)()
            .style("app-content")
            .append(view, related);
        const app = (0, Component_30.default)()
            .style("app")
