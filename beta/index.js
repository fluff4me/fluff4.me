...
define("ui/component/core/Link", ["require", "exports", "ui/Component", "utility/Env", "utility/State"], function (require, exports, Component_8, Env_4, State_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/utility/AnchorManipulator", ["require", "exports", "ui/utility/Mouse", "ui/utility/Viewport", "utility/State", "utility/Time"], function (require, exports, Mouse_3, Viewport_2, State_22, Time_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/ExternalLink", ["require", "exports", "ui/Component"], function (require, exports, Component_36) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/Paginator", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/Async", "utility/State"], function (require, exports, Component_38, Block_7, Button_9, Slot_8, Async_3, State_28) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Paginator = Component_38.default.Builder((component) => {
        ...
        let pageContent = [];
        let pages = [];
        const cursor = (0, State_28.default)(0);
...
define("ui/component/core/Timestamp", ["require", "exports", "ui/Component", "utility/State", "utility/Time"], function (require, exports, Component_40, State_29, Time_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Timestamp = Component_40.default.Builder((component, time) => {
        let translation;
        const state = (0, State_29.default)(new Date(time ?? Date.now()));
...
define("ui/component/core/ext/Draggable", ["require", "exports", "ui/Component", "utility/maths/Vector2", "utility/State"], function (require, exports, Component_41, Vector2_1, State_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const isDraggingAnyDraggable = (0, State_30.default)(false);
    const Draggable = Object.assign(Component_41.default.Extension((component, definition = {}) => {
        component.style('draggable');
        const state = (0, State_30.default)(DragState.None);
        const overrideStickyDistance = (0, State_30.default)(undefined);
        const overrideDelay = (0, State_30.default)(undefined);
        const stickyDistance = State_30.default.MapManual([overrideStickyDistance, definition.stickyDistance], (override, base) => override ?? base ?? 0);
        const delay = State_30.default.MapManual([overrideDelay, definition.delay], (override, base) => override ?? base ?? 0);
...
define("ui/component/core/ext/Sortable", ["require", "exports", "ui/Component", "ui/component/core/ext/Draggable", "utility/Arrays", "utility/maths/Vector2", "utility/State"], function (require, exports, Component_43, Draggable_2, Arrays_5, Vector2_2, State_31) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const isSortingAnySortable = (0, State_31.default)(false);
    const Sortable = Object.assign(Component_43.default.Extension((component, definition) => {
        const sorting = (0, State_31.default)(false);
        const sortDelay = (0, State_31.default)(definition.sortDelay ?? 0);
        const stickyDistance = (0, State_31.default)(definition.stickyDistance ?? 0);
        const order = (0, State_31.default)([]);
...
define("ui/utility/Applicator", ["require", "exports", "utility/State"], function (require, exports, State_32) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Applicator(host, defaultValueOrApply, apply) {
        ...
        function makeApplicator(host) {
            return {
                state: (0, State_32.default)(defaultValue),
                set: value => {
                    unbind?.();
                    setInternal(value);
                    return host;
...
define("ui/component/TagsEditor", ["require", "exports", "lang/en-nz", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/ext/Input", "ui/component/core/ext/Sortable", "ui/component/core/ProgressWheel", "ui/component/core/Slot", "ui/component/core/TextInput", "ui/component/Tag", "ui/utility/AnchorManipulator", "ui/utility/Applicator", "utility/AbortPromise", "utility/Mouse", "utility/State", "utility/string/Strings"], function (require, exports, en_nz_6, Tags_1, Component_44, Block_8, Input_4, Sortable_1, ProgressWheel_2, Slot_9, TextInput_4, Tag_1, AnchorManipulator_2, Applicator_1, AbortPromise_2, Mouse_4, State_33, Strings_2) {
    ...
    const TagsEditor = Component_44.default.Builder((component) => {
        const tagsState = (0, State_33.default)({ global_tags: [], custom_tags: [] });
        ////////////////////////////////////
        //#region Current
        ...
        ////////////////////////////////////
        //#region Suggestions
        const hasOrHadFocus = State_33.default.Some(component, component.hasFocused, component.hadFocusedLast);
        const suggestions = (0, Slot_9.default)()
            .style('tags-editor-suggestions')
            .use(State_33.default.UseManual({
            tags: tagsState,
            filter: input.state,
            focus: hasOrHadFocus,
        ...
        const maxLengthGlobal = (0, State_33.default)(undefined);
        const maxLengthCustom = (0, State_33.default)(undefined);
...
define("ui/component/Tags", ["require", "exports", "model/Tags", "ui/Component", "ui/component/core/Slot", "ui/component/Tag", "utility/AbortPromise", "utility/State"], function (require, exports, Tags_2, Component_45, Slot_10, Tag_2, AbortPromise_3, State_34) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/view/AuthorView", ["require", "exports", "endpoint/author/EndpointAuthorGet", "endpoint/work/EndpointWorkGetAllAuthor", "model/Session", "ui/Component", "ui/component/Author", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Paginator", "ui/component/core/Slot", "ui/component/Work", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, EndpointAuthorGet_1, EndpointWorkGetAllAuthor_1, Session_10, Component_47, Author_1, Button_12, Link_5, Paginator_1, Slot_12, Work_1, View_2, ViewDefinition_2) {
    ...
    exports.default = (0, ViewDefinition_2.default)({
        ...
        async create(params, { author }) {
            ...
            await paginator.useEndpoint(worksQuery, (slot, works) => slot.append(...works.map(workData => (0, Link_5.default)(`/work/${author.vanity}/${workData.vanity}`)
...
define("ui/component/core/InfoDialog", ["require", "exports", "ui/Component", "ui/component/core/BlockDialog", "ui/component/core/Button", "ui/utility/StringApplicator", "utility/State"], function (require, exports, Component_48, BlockDialog_2, Button_13, StringApplicator_5, State_35) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const InfoDialog = Object.assign(Component_48.default.Builder((component, definition) => {
        ...
        const state = (0, State_35.default)(undefined);
...
define("ui/component/core/RadioRow", ["require", "exports", "ui/Component", "ui/component/core/ext/Input", "ui/component/core/RadioButton", "ui/utility/Applicator", "utility/State"], function (require, exports, Component_49, Input_5, RadioButton_2, Applicator_2, State_36) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const RadioRow = Component_49.default.Builder((component) => {
        const selection = (0, State_36.default)(undefined);
        const options = {};
...
define("ui/view/ChapterEditView", ["require", "exports", "endpoint/chapter/EndpointChapterDelete", "endpoint/chapter/EndpointChapterGet", "model/Chapters", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/InfoDialog", "ui/component/core/Slot", "ui/view/chapter/ChapterEditForm", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "utility/State"], function (require, exports, EndpointChapterDelete_2, EndpointChapterGet_1, Chapters_1, Component_51, ActionRow_4, Button_14, InfoDialog_1, Slot_13, ChapterEditForm_1, View_3, ViewDefinition_3, ViewTransition_3, State_37) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_3.default)({
        requiresLogin: true,
        async load(params) {
            const response = !params.url ? undefined : await EndpointChapterGet_1.default.query({ params: params });
            if (response instanceof Error)
                throw response;
            const chapter = response?.data;
            const owner = (0, Component_51.default)();
            if (!chapter)
        ...
        create(params, { chapter }) {
            const id = 'chapter-edit';
            const view = (0, View_3.default)(id);
            if (params && chapter)
                view.breadcrumbs.setBackButton(`/work/${params.author}/${params.work}/chapter/${params.url}`, button => button.subText.set(chapter.name));
            const state = (0, State_37.default)(chapter);
            const stateInternal = (0, State_37.default)(chapter);
            (0, Slot_13.default)()
    ...
    function initActions(actions, chapter, work, author) {
        return actions
            ...
            && (0, Button_15.default)()
                ...
                .event.subscribe('click', () => navigate.toURL(`/work/${author.vanity}/${work.vanity}/chapter/${State_38.default.value(chapter).url}/edit`)))
            ...
            && (0, Button_15.default)()
                ...
                .event.subscribe('click', () => Chapters_2.default.delete(State_38.default.value(chapter))));
    }
    const Chapter = Object.assign(Component_52.default.Builder((component, chapter, work, author) => {
        ...
        const number = (0, Component_52.default)()
            .style('chapter-number')
            .text.set(chapterNumber ? `${chapterNumber.toLocaleString()}` : '')
            .appendTo(component);
        const chapterName = (0, Component_52.default)()
            .style('chapter-name')
            .text.set(chapter.name)
            .appendTo(component);
        const right = (0, Component_52.default)()
            .style('chapter-right')
            .appendTo(component);
        let timestamp;
        if (chapter.visibility === 'Private')
            timestamp = (0, Component_52.default)()
...
define("ui/component/Reaction", ["require", "exports", "ui/Component", "ui/component/core/Button", "utility/State"], function (require, exports, Component_53, Button_16, State_39) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Reaction = Component_53.default.Builder((component, type, reactionsIn = (0, State_39.default)(0), reactedIn = (0, State_39.default)(false)) => {
        const reactions = State_39.default.get(reactionsIn);
        const reacted = State_39.default.get(reactedIn);
        return component
            .style('reaction')
...
define("ui/component/Comment", ["require", "exports", "endpoint/comment/EndpointCommentAdd", "endpoint/comment/EndpointCommentDelete", "endpoint/comment/EndpointCommentUpdate", "endpoint/reaction/EndpointReactComment", "endpoint/reaction/EndpointUnreactComment", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/core/TextEditor", "ui/component/core/Timestamp", "ui/component/Reaction"], function (require, exports, EndpointCommentAdd_1, EndpointCommentDelete_1, EndpointCommentUpdate_1, EndpointReactComment_1, EndpointUnreactComment_1, en_nz_9, FormInputLengths_4, Session_13, Component_54, ActionRow_5, Button_17, Link_7, Slot_14, TextEditor_3, Timestamp_3, Reaction_1) {
    ...
    const Comment = Component_54.default.Builder((component, source, commentData, meta) => {
        const comment = component.and(Slot_14.default)
            .style('comment')
            .extend(comment => ({}));
        ...
        comment.use(comments, (slot, commentsData) => {
            ...
            if (commentData && !meta?.isRootComment) {
                ...
                if (commentData.edit) {
                    ...
                    const footer = (0, Component_54.default)('footer').and(ActionRow_5.default)
                    ...
                    (0, Slot_14.default)()
                        ...
                        if (!author)
                            return;
                        const footer = (0, Component_54.default)('footer')
            ...
            const childrenWrapper = (0, Component_54.default)()
...
define("ui/component/Comments", ["require", "exports", "endpoint/comment/EndpointCommentGetAllUnder", "model/Session", "ui/Component", "ui/component/Comment", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/AbortPromise", "utility/State"], function (require, exports, EndpointCommentGetAllUnder_1, Session_14, Component_55, Comment_1, Block_11, Button_18, Slot_15, AbortPromise_4, State_40) {
    ...
    const Comments = Component_55.default.Builder((rawComponent, under, isRootComment) => {
        ...
        (0, Slot_15.default)()
            ...
            const comments = (0, State_40.default)([comment]);
            const authors = (0, State_40.default)(!author ? [] : [author]);
            if (author)
            ...
            const query = (0, State_40.default)(undefined);
...
define("ui/view/shared/component/PaginatedView", ["require", "exports", "ui/Component", "ui/component/core/Paginator", "ui/view/shared/component/View"], function (require, exports, Component_56, Paginator_2, View_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/view/ChapterView", ["require", "exports", "endpoint/chapter/EndpointChapterGet", "endpoint/chapter/EndpointChapterGetPaged", "endpoint/history/EndpointHistoryAddChapter", "endpoint/reaction/EndpointReactChapter", "endpoint/reaction/EndpointUnreactChapter", "endpoint/work/EndpointWorkGet", "lang/en-nz", "model/Chapters", "model/Session", "model/TextBody", "ui/Component", "ui/component/Chapter", "ui/component/Comments", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/Reaction", "ui/component/Tags", "ui/component/Work", "ui/view/shared/component/PaginatedView", "ui/view/shared/component/ViewDefinition", "utility/maths/Maths", "utility/State"], function (require, exports, EndpointChapterGet_2, EndpointChapterGetPaged_1, EndpointHistoryAddChapter_1, EndpointReactChapter_1, EndpointUnreactChapter_1, EndpointWorkGet_1, en_nz_10, Chapters_3, Session_15, TextBody_1, Component_57, Chapter_1, Comments_1, Button_19, Link_8, Slot_16, Reaction_2, Tags_4, Work_2, PaginatedView_1, ViewDefinition_4, Maths_3, State_41) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_4.default)({
        ...
        async create(params, { workData, initialChapterResponse }) {
            ...
            (0, Link_8.default)(`/work/${author?.vanity}/${workData.vanity}`)
                ...
                .setContainsHeading()
                .appendTo(view.content);
            const chapterState = (0, State_41.default)(initialChapterResponse.data);
...
define("ui/view/debug/ButtonRegistry", ["require", "exports", "model/Session", "utility/Env"], function (require, exports, Session_16, Env_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("model/PagedData", ["require", "exports", "utility/State"], function (require, exports, State_42) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_42 = __importDefault(State_42);
    const PagedData = Object.assign(function (definition) {
        const pageCount = (0, State_42.default)(undefined);
        const pages = (0, State_42.default)([], false); // .setId('PagedData pages')
        return {
            pageCount,
            get pages() {
            ...
            get(page) {
                ...
                if (existing === undefined || existing === false) {
                    pages.value[page] = Promise.resolve(definition.get(page))
                        .then(data => {
                        if (!State_42.default.is(pages.value[page])) { // if it's already a State, it's been updated before this, don't overwrite
                            let newState;
                            if (State_42.default.is(data)) {
                                newState = (0, State_42.default)(null, false); // .setId(`PagedData page ${page} get 1`)
                                newState.bindManual(data);
                            }
                            else
                                newState = (0, State_42.default)(data, false); // .setId(`PagedData page ${page} get 2`)
            ...
            set(page, data, isLastPage) {
                if (State_42.default.is(pages.value[page]))
                    pages.value[page].value = data;
                else
                    pages.value[page] = (0, State_42.default)(data, false); // .setId(`PagedData page ${page} set`)
                if (isLastPage)
...
define("model/PagedListData", ["require", "exports", "model/PagedData", "utility/State"], function (require, exports, PagedData_1, State_43) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
            ...
            resized(resizePageSize) {
                ...
                list.rawPages.subscribeManual(() => {
                    ...
                    for (let i = 0; i < pages.length; i++) {
                        ...
                        function setPage(value) {
                            const state = pages[i] = (0, State_43.default)(null, false); // .setId('PagedListData subscribeManual setPage')
                            if (State_43.default.is(value))
                ...
                function getPage(page) {
                    ...
                    for (let i = startPageInSource; i < endPageInSource; i++) {
                        ...
                        if (i >= startPageInSource && i < endPageInSource && (!rawPage || (State_43.default.is(rawPage) && rawPage.value === false))) {
                ...
                function resolveData(sourcePages, startIndex, endIndex) {
                    ...
                    return State_43.default.Generator(() => data, false).observeManual(...sourcePages); // .setId('PagedListData resolveData')
                }
            },
            //#endregion
            ////////////////////////////////////
            ...
            async get(page) {
                ...
                if (dismantler) {
                    ...
                    for (const [key, value] of Object.entries(auxiliary)) {
                        if (value === content)
                            continue;
                        const state = aux[key] ??= (0, State_43.default)([]);
...
define("ui/component/core/Paginator2", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/Async", "utility/State"], function (require, exports, Component_59, Block_12, Button_21, Slot_17, Async_4, State_44) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Paginator2 = Component_59.default.Builder((component) => {
        ...
        block.footer.left.style('paginator-footer-left');
        block.footer.right.style('paginator-footer-right');
        const cursor = (0, State_44.default)(0);
        const allData = (0, State_44.default)(undefined, false);
        ...
        const currentData = (0, State_44.default)(false, false);
        let settingId = Symbol();
        State_44.default.Use(component, { cursor, allData }).use(component, async ({ cursor, allData }) => {
            if (!allData)
        ...
        const isLastPage = State_44.default.Map(component, [cursor, pageCount], (cursor, pageCount) => cursor >= (pageCount ?? Infinity));
        // first
        (0, Button_21.default)()
            .setIcon('angles-left')
            .type('icon')
        ...
        (0, Slot_17.default)()
            ...
            const wrapper = (0, Slot_17.default)().appendTo(slot);
            const pages = [];
...
define("ui/component/WorkFeed", ["require", "exports", "model/PagedListData", "ui/Component", "ui/component/core/Link", "ui/component/core/Paginator2", "ui/component/Work", "utility/State"], function (require, exports, PagedListData_1, Component_60, Link_9, Paginator2_1, Work_3, State_45) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const WorkFeed = Component_60.default.Builder((component) => {
        ...
        paginator.orElse(slot => (0, Component_60.default)()
            .style('placeholder')
...
define("ui/component/core/Tabinator", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "utility/Objects", "utility/State"], function (require, exports, Component_61, Block_13, Button_23, Objects_7, State_46) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Tab = void 0;
    ...
    exports.Tab = Component_61.default.Builder((component) => {
        const content = (0, Component_61.default)()
        ...
        .setName('Tab');
    const Tabinator = Component_61.default.Builder((component) => {
        const activeTab = (0, State_46.default)(undefined);
        const tabs = (0, State_46.default)([]);
...
define("ui/view/following/FollowingAuthorsTab", ["require", "exports", "endpoint/author/EndpointAuthorsResolveReferences", "model/Follows", "model/PagedListData", "ui/Component", "ui/component/Author", "ui/component/core/Link", "ui/component/core/Paginator2", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "utility/AbortPromise", "utility/Arrays"], function (require, exports, EndpointAuthorsResolveReferences_1, Follows_4, PagedListData_2, Component_62, Author_2, Link_11, Paginator2_2, Placeholder_3, Slot_18, Tabinator_1, AbortPromise_5, Arrays_6) {
    ...
    const FollowingAuthorsTab = Component_62.default.Builder((component, type) => {
...
define("ui/component/TagBlock", ["require", "exports", "lang/en-nz", "model/Follows", "model/Session", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/Tag"], function (require, exports, en_nz_12, Follows_5, Session_18, Tags_5, Component_63, Block_14, Button_24, Tag_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const TagBlock = Component_63.default.Builder((component, tag) => {
        const block = component
        ...
        const info = (0, Component_63.default)()
...
define("ui/view/following/FollowingTagsTab", ["require", "exports", "model/Follows", "model/Tags", "ui/Component", "ui/component/core/Link", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "ui/component/TagBlock", "utility/AbortPromise", "utility/Arrays"], function (require, exports, Follows_6, Tags_6, Component_64, Link_12, Placeholder_4, Slot_19, Tabinator_2, TagBlock_1, AbortPromise_6, Arrays_7) {
    ...
    const FollowingTagsTab = Component_64.default.Builder((component, type) => {
...
define("ui/view/following/FollowingWorksTab", ["require", "exports", "endpoint/work/EndpointWorksResolveReferences", "model/Follows", "model/PagedListData", "model/Works", "ui/Component", "ui/component/core/Link", "ui/component/core/Paginator2", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "ui/component/Work", "utility/AbortPromise", "utility/Arrays", "utility/State"], function (require, exports, EndpointWorksResolveReferences_1, Follows_7, PagedListData_3, Works_3, Component_65, Link_13, Paginator2_3, Placeholder_5, Slot_20, Tabinator_3, Work_4, AbortPromise_7, Arrays_8, State_47) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const FollowingWorksTab = Component_65.default.Builder((component, type) => {
...
define("model/Notifications", ["require", "exports", "endpoint/notification/EndpointNotificationGetAll", "endpoint/notification/EndpointNotificationGetCount", "endpoint/notification/EndpointNotificationMarkRead", "endpoint/notification/EndpointNotificationMarkUnread", "model/PagedListData", "model/Session", "utility/State", "utility/Store", "utility/Time"], function (require, exports, EndpointNotificationGetAll_1, EndpointNotificationGetCount_1, EndpointNotificationMarkRead_1, EndpointNotificationMarkUnread_1, PagedListData_5, Session_19, State_48, Store_3, Time_9) {
    ...
    (function (Notifications) {
        Session_19.default.setClearedWithSessionChange('notifications', () => {
        ...
        Notifications.authors = (0, State_48.default)(Store_3.default.items.notifications?.authors ?? []);
        Notifications.works = (0, State_48.default)(Store_3.default.items.notifications?.works ?? []);
        Notifications.chapters = (0, State_48.default)(Store_3.default.items.notifications?.chapters ?? []);
        Notifications.comments = (0, State_48.default)(Store_3.default.items.notifications?.comments ?? []);
        Notifications.hasMore = (0, State_48.default)(Store_3.default.items.notifications?.hasMore ?? false);
        Notifications.unreadCount = (0, State_48.default)(Store_3.default.items.notifications?.unreadCount ?? 0);
        Notifications.lastUpdate = (0, State_48.default)(Store_3.default.items.notifications?.lastUpdate ?? 0);
        function clear() {
        ...
        async function checkNotifications() {
            ...
            if (!Session_19.default.Auth.author.value)
                return;
...
define("ui/component/Notification", ["require", "exports", "lang/en-nz", "model/Authors", "model/Chapters", "model/Comments", "model/Notifications", "model/TextBody", "model/Works", "ui/Component", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Timestamp", "utility/State"], function (require, exports, en_nz_13, Authors_2, Chapters_4, Comments_2, Notifications_1, TextBody_2, Works_5, Component_66, Button_25, Link_15, Timestamp_4, State_49) {
    ...
    const Notification = Component_66.default.Builder('a', (component, data) => {
        const translationFunction = notificationQuilt[`notification/${data.type}`];
        if (!translationFunction)
            return undefined;
        const read = (0, State_49.default)(data.read);
        ...
        const justMarkedUnread = (0, State_49.default)(false);
        ...
        (0, Component_66.default)()
            .style('notification-label')
            .append((0, Component_66.default)().text.set(translationFunction?.({ TRIGGERED_BY, AUTHOR, WORK, CHAPTER })), document.createTextNode('   '), (0, Timestamp_4.default)(data.created_time).style('notification-timestamp'))
            .appendTo(notification);
        const comment = Comments_2.default.resolve(data.comment, Notifications_1.default.comments.value);
        if (comment) {
            (0, Component_66.default)()
                .style('markdown')
                .append(comment.body && (0, Component_66.default)('blockquote')
...
define("ui/component/NotificationList", ["require", "exports", "endpoint/notification/EndpointNotificationMarkRead", "model/Notifications", "ui/Component", "ui/component/core/Button", "ui/component/core/Paginator2", "ui/component/Notification"], function (require, exports, EndpointNotificationMarkRead_2, Notifications_2, Component_67, Button_26, Paginator2_5, Notification_1) {
    ...
    const NotificationList = Component_67.default.Builder(async (component, onlyUnread, pageSize) => {
    ...
    exports.default = (0, ViewDefinition_12.default)({
        ...
        create(params, { tag }) {
            ...
            (0, WorkFeed_3.default)()
                .setFromEndpoint((Session_20.default.Auth.author.value ? EndpointFeedGetAuthed_1.default : EndpointFeedGet_2.default)
                .prep(undefined, {
...
define("ui/component/core/Textarea", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/ext/Input", "ui/utility/StringApplicator", "utility/State"], function (require, exports, en_nz_14, Component_68, Input_6, StringApplicator_6, State_50) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Textarea = Component_68.default.Builder((component) => {
        ...
        const state = (0, State_50.default)('');
        const input = component
            .and(Input_6.default)
            ...
            const response = await (() => {
                switch (type) {
                    ...
                    case 'update': {
                        if (!state.value)
                            return;
                        const authorVanity = Session_21.default.Auth.author.value?.vanity;
                        if (!authorVanity)
                            return new Error('Cannot update a work when not signed in');
...
define("ui/view/WorkEditView", ["require", "exports", "endpoint/work/EndpointWorkGet", "model/Works", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/InfoDialog", "ui/component/core/Slot", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "ui/view/work/WorkEditForm", "utility/State"], function (require, exports, EndpointWorkGet_2, Works_6, Component_70, ActionRow_6, Button_27, InfoDialog_2, Slot_21, View_13, ViewDefinition_13, ViewTransition_4, WorkEditForm_1, State_51) {
    ...
    exports.default = (0, ViewDefinition_13.default)({
        requiresLogin: true,
        async load(params) {
            const response = params && await EndpointWorkGet_2.default.query({ params });
            if (response instanceof Error)
                throw response;
            const owner = (0, Component_70.default)();
        ...
        create(params, { work }) {
            const id = 'work-edit';
            const view = (0, View_13.default)(id);
            const state = (0, State_51.default)(work);
            const editFormState = (0, State_51.default)(work);
...
define("ui/view/WorkView", ["require", "exports", "endpoint/chapter/EndpointChapterGetAll", "endpoint/chapter/EndpointChapterReorder", "endpoint/history/EndpointHistoryAddWork", "endpoint/work/EndpointWorkGet", "model/PagedListData", "model/Session", "ui/Component", "ui/component/Chapter", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Paginator2", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/Work", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Errors", "utility/State"], function (require, exports, EndpointChapterGetAll_1, EndpointChapterReorder_1, EndpointHistoryAddWork_1, EndpointWorkGet_3, PagedListData_6, Session_22, Component_71, Chapter_3, Block_17, Button_28, Paginator2_6, Placeholder_6, Slot_22, Work_6, View_14, ViewDefinition_14, Errors_2, State_52) {
    ...
    exports.default = (0, ViewDefinition_14.default)({
        ...
        create(params, { work: workData }) {
            const view = (0, View_14.default)('work');
            if (Session_22.default.Auth.loggedIn.value)
            ...
            (0, Work_6.default)(workData, authorData)
                ...
                .setContainsHeading()
                .appendTo(view.content);
            const movingChapter = (0, State_52.default)(undefined);
            const chaptersListState = (0, State_52.default)(null);
            (0, Slot_22.default)()
                ...
                (0, Slot_22.default)()
                    ...
                    (0, Chapter_3.default)(movingChapterData, workData, authorData)
                        ...
                        .insertAction('reorder', 'before', 'delete', Session_22.default.Auth.author, (slot, self) => true
                ...
                .appendTo(slot))
                .setActionsMenu(popover => popover
                .append((0, Slot_22.default)()
                .if(Session_22.default.Auth.author.map(popover, author => author?.vanity === params.author), () => (0, Button_28.default)()
                .setIcon('plus')
                .type('flush')
...
define("ui/utility/StringApplicator", ["require", "exports", "lang/en-nz", "utility/State"], function (require, exports, en_nz_16, State_53) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function BaseStringApplicator(host, defaultValue, set) {
        ...
        function makeApplicator(host) {
            return {
                state: (0, State_53.default)(defaultValue),
                set: value => {
                    unbind?.();
...
define("ui/component/core/Button", ["require", "exports", "ui/Component", "ui/utility/BrowserListener", "ui/utility/FontsListener", "ui/utility/TypeManipulator", "utility/State", "utility/Type"], function (require, exports, Component_72, BrowserListener_1, FontsListener_1, TypeManipulator_3, State_54, Type_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Button = Component_72.default.Builder('button', (component) => {
        const disabledReasons = new Set();
        const disabled = State_54.default.Generator(() => !!disabledReasons.size);
        const hasSubtext = (0, State_54.default)(false);
        let icon;
        ...
        const button = component
            ...
            .extendJIT('textWrapper', button => (0, Component_72.default)()
            .style('button-text')
            .appendTo(button))
        ...
        function setIcon(newIcon) {
            button.icon ??= (0, Component_72.default)()
                .style('button-icon')
...
define("ui/component/core/Label", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Form", "ui/view/shared/component/View", "utility/State"], function (require, exports, Component_73, Button_29, Form_4, View_15, State_55) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Label = Component_73.default.Builder('label', (label) => {
        label.style('label');
        const textWrapper = (0, Component_73.default)()
            .style('label-text')
            .appendTo(label);
        ...
        return label
            .extend(label => ({
            textWrapper,
            for: (0, State_55.default)(undefined),
            setFor: inputName => {
    ...
    let globalI = 0;
    exports.AutoLabel = Component_73.default.Builder('label', (component) => {
        const i = globalI++;
        ...
        label.event.subscribe(['insert', 'ancestorInsert'], () => {
            ...
            const view = label.closest(View_15.default);
...
define("ui/Component", ["require", "exports", "lang/en-nz", "ui/utility/AnchorManipulator", "ui/utility/AttributeManipulator", "ui/utility/ClassManipulator", "ui/utility/EventManipulator", "ui/utility/FocusListener", "ui/utility/StringApplicator", "ui/utility/StyleManipulator", "ui/utility/TextManipulator", "ui/utility/Viewport", "utility/Arrays", "utility/Async", "utility/Define", "utility/Env", "utility/Errors", "utility/State", "utility/string/Strings"], function (require, exports, en_nz_18, AnchorManipulator_3, AttributeManipulator_1, ClassManipulator_1, EventManipulator_1, FocusListener_2, StringApplicator_9, StyleManipulator_1, TextManipulator_2, Viewport_5, Arrays_9, Async_5, Define_5, Env_8, Errors_3, State_56, Strings_3) {
    ...
    function Component(type = 'span') {
        ...
        let component = {
            supers: (0, State_56.default)([]),
            isComponent: true,
            isInsertionDestination: true,
            element: document.createElement(type),
            removed: (0, State_56.default)(false),
            rooted: (0, State_56.default)(false),
            get tagName() {
            ...
            get hovered() {
                return Define_5.default.set(component, 'hovered', (0, State_56.default)(false));
            },
            get focused() {
                return Define_5.default.set(component, 'focused', (0, State_56.default)(false));
            },
            get hasFocused() {
                return Define_5.default.set(component, 'hasFocused', (0, State_56.default)(false));
            },
            get hadFocusedLast() {
                return Define_5.default.set(component, 'hadFocusedLast', (0, State_56.default)(false));
            },
            get hoveredOrFocused() {
                return Define_5.default.set(component, 'hoveredOrFocused', State_56.default.Generator(() => component.hovered.value || component.focused.value)
                    .observe(component, component.hovered, component.focused));
            },
            get hoveredOrHasFocused() {
                return Define_5.default.set(component, 'hoveredOrHasFocused', State_56.default.Generator(() => component.hovered.value || component.hasFocused.value)
                    .observe(component, component.hovered, component.hasFocused));
            },
            get active() {
                return Define_5.default.set(component, 'active', (0, State_56.default)(false));
            },
            get id() {
                return Define_5.default.set(component, 'id', (0, State_56.default)(undefined));
            },
            get name() {
                return Define_5.default.set(component, 'name', (0, State_56.default)(undefined));
            },
            get rect() {
                const rectState = State_56.default.JIT(() => component.element.getBoundingClientRect());
            ...
            *getDescendants(builder) {
            ...
            ariaLabelledBy: labelledBy => {
                ...
                if (labelledBy) {
                    const state = State_56.default.Generator(() => labelledBy.id.value ?? labelledBy.attributes.get('for'))
    ...
    (function (Component) {
        ...
        function Builder(initialOrBuilder, builder) {
            ...
            async function ensureOriginalComponentNotSubscriptionOwner(original) {
                if (!original || !State_56.default.OwnerMetadata.hasSubscriptions(original))
                    return;
...
define("model/Session", ["require", "exports", "endpoint/auth/EndpointAuthDelete", "endpoint/session/EndpointSessionGet", "endpoint/session/EndpointSessionReset", "utility/Env", "utility/Popup", "utility/State", "utility/Store"], function (require, exports, EndpointAuthDelete_1, EndpointSessionGet_1, EndpointSessionReset_1, Env_9, Popup_2, State_57, Store_4) {
    ...
    var Session;
    (function (Session) {
        Session.has = (0, State_57.default)(false);
        ...
        let Auth;
        (function (Auth) {
            Auth.state = (0, State_57.default)('none');
            Auth.loggedIn = State_57.default.Generator(() => Auth.state.value === 'logged-in').observeManual(Auth.state);
            Auth.authorisations = (0, State_57.default)([]);
            Auth.author = (0, State_57.default)(undefined, (a, b) => a?.vanity === b?.vanity);
            function getAll() {
            ...
            async function requestDangerToken(type, service) {
                ...
                const result = await (0, Popup_2.default)(`Re-authenticate Using ${service.name}`, `${Env_9.default.API_ORIGIN}danger-token/request/${type}/${service.id}/begin`, 600, 900)
                    .then(() => true).catch(err => { console.warn(err); return false; });
...
define("model/Manifest", ["require", "exports", "model/Session", "utility/State", "utility/Time"], function (require, exports, Session_23, State_58, Time_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Manifest(definition) {
        ...
        const state = (0, State_58.default)(undefined, false);
        tryLoad();
        const result = Object.assign(state, {
            ...
            async getManifest(force) {
                ...
                if (!force && result.isFresh(state.value))
                    return state.value;
                if (definition.requiresAuthor && !Session_23.default.Auth.loggedIn.value)
                    return undefined;
...
define("ui/view/ErrorView", ["require", "exports", "lang/en-nz", "ui/component/core/Heading", "ui/component/core/Paragraph", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, en_nz_19, Heading_3, Paragraph_3, View_16, ViewDefinition_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_15.default)({
        create: (params) => {
            const view = (0, View_16.default)('error');
...
define("ui/view/RequireLoginView", ["require", "exports", "ui/component/core/ActionRow", "ui/component/core/Block", "ui/component/core/Button", "ui/view/AccountView", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, ActionRow_7, Block_18, Button_30, AccountView_2, View_17, ViewDefinition_16) {
    ...
    exports.default = (0, ViewDefinition_16.default)({
        create: () => {
            const view = (0, View_17.default)('require-login');
...
define("ui/view/shared/component/ViewContainer", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Dialog", "ui/view/AccountView", "ui/view/ErrorView", "ui/view/RequireLoginView", "ui/view/shared/ext/ViewTransition"], function (require, exports, Session_24, Component_74, Button_31, Dialog_3, AccountView_3, ErrorView_1, RequireLoginView_1, ViewTransition_5) {
    ...
    const ViewContainer = () => {
        let cancelLogin;
        const container = (0, Component_74.default)()
            ...
            show: async (definition, params) => {
                ...
                const needsLogin = definition.requiresLogin && !Session_24.default.Auth.loggedIn.value;
                if (needsLogin || definition.load) {
                    ...
                    await loginPromise;
                    if (needsLogin && !Session_24.default.Auth.loggedIn.value) {
                        let setLoggedIn;
                        ...
                        ViewTransition_5.default.perform('view', async () => {
                            ...
                            if (!view)
                                return;
                            Session_24.default.Auth.loggedIn.subscribe(view, loggedIn => loggedIn && setLoggedIn());
                        });
                        await loggedIn;
                    }
                }
        ...
        function logIn() {
            if (Session_24.default.Auth.author.value)
                return;
            ...
            const authPromise = accountViewShown.then(async (view) => {
                ...
                await Promise.race([
                    Session_24.default.Auth.await(view),
                    loginCancelledPromise,
                ]);
                cancelLogin = undefined;
                return Session_24.default.Auth.loggedIn.value;
            });
            return {
                accountViewShown,
                authed: authPromise,
...
define("navigation/Navigate", ["require", "exports", "navigation/Routes", "ui/utility/EventManipulator", "ui/view/ErrorView", "utility/Env"], function (require, exports, Routes_1, EventManipulator_2, ErrorView_2, Env_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        const navigate = {
            ...
            setURL: (url) => {
                if (url !== location.pathname)
                    history.pushState({}, '', `${Env_10.default.URL_ORIGIN}${url.slice(1)}`);
            },
            toRawURL: (url) => {
...
define("ui/component/masthead/Flag", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_75, Arrays_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_75 = __importDefault(Component_75);
    Arrays_10 = __importDefault(Arrays_10);
    const Flag = Component_75.default.Builder((component) => {
        const stripes = Arrays_10.default.range(5)
            .map(i => (0, Component_75.default)()
...
define("ui/component/PrimaryNav", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Heading", "ui/component/core/Link", "ui/component/core/Slot", "ui/utility/StringApplicator", "utility/Env"], function (require, exports, Session_25, Component_76, Button_32, Heading_4, Link_16, Slot_23, StringApplicator_10, Env_11) {
    ...
    exports.default = Component_76.default.Builder(nav => {
        nav.style('primary-nav');
        const top = (0, Component_76.default)()
            .style('primary-nav-top')
            .appendTo(nav);
        const bottom = (0, Component_76.default)()
        ...
        Group('top', 'sidebar/section/browse')
            ...
            .using(Session_25.default.Auth.author, (group, author) => group
            ...
            .setDisabled(!author, 'no author')));
        (0, Slot_23.default)()
            .use(Session_25.default.Auth.author, (slot, author) => author
        ...
        Group('bottom', 'sidebar/section/profile')
            .using(Session_25.default.Auth.author, (group, author) => {
            if (author)
                group
        ...
        if (Env_11.default.ENVIRONMENT === 'dev')
...
define("ui/component/Sidebar", ["require", "exports", "ui/Component", "utility/Store"], function (require, exports, Component_77, Store_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_77 = __importDefault(Component_77);
    Store_5 = __importDefault(Store_5);
    const Sidebar = Component_77.default.Builder('nav', (sidebar) => {
...
define("ui/component/Masthead", ["require", "exports", "model/Notifications", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/masthead/Flag", "ui/component/NotificationList", "ui/component/PrimaryNav", "ui/component/Sidebar", "ui/utility/Viewport", "utility/AbortPromise", "utility/Env"], function (require, exports, Notifications_3, Session_26, Component_78, Button_33, Link_17, Slot_24, Flag_1, NotificationList_2, PrimaryNav_1, Sidebar_1, Viewport_6, AbortPromise_8, Env_12) {
    ...
    const Masthead = Component_78.default.Builder('header', (masthead, view) => {
        ...
        (0, Button_33.default)()
            ...
            .appendTo(masthead);
        let popover;
        const left = (0, Component_78.default)()
            .append((0, Component_78.default)()
        ...
        const homeLink = (0, Link_17.default)('/')
            ...
            .append(flag)
            .append((0, Component_78.default)('img')
            .style('masthead-home-logo-wordmark')
            .ariaHidden()
            .attributes.set('src', `${Env_12.default.URL_ORIGIN}image/logo-wordmark.svg`)))
            .appendTo(left);
        ...
        (0, Component_78.default)()
            .style('masthead-search')
            .appendTo(masthead);
        (0, Slot_24.default)()
            .style.remove('slot')
            .style('masthead-user')
            .if(Session_26.default.Auth.loggedIn, () => (0, Component_78.default)()
            ////////////////////////////////////
            ...
            .append((0, Slot_24.default)().use(Notifications_3.default.unreadCount, (slot, count) => !count ? undefined
            : (0, Component_78.default)()
            ...
            .append((0, Slot_24.default)().use(Notifications_3.default.cache, AbortPromise_8.default.asyncFunction(async (signal, slot, notifications) => {
            ...
            .anchor.add('aligned right', 'off bottom')
            .ariaRole('navigation')
            .append((0, Slot_24.default)()
            .style('action-group')
            .style.remove('slot')
            .use(Session_26.default.Auth.author, (slot, author) => {
            if (!author)
                return;
            ...
            (0, Button_33.default)()
                ...
                .text.use('view/account/action/logout')
                .event.subscribe('click', () => Session_26.default.reset())
                .appendTo(slot);
        }))))
        //#endregion
        ////////////////////////////////////
...
define("ui/component/Mention", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/Link", "ui/utility/MarkdownContent"], function (require, exports, en_nz_20, Component_79, Link_18, MarkdownContent_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Mention = Component_79.default.Builder('a', (component, author) => {
        return component
            .and(Link_18.default, author && `/author/${author.vanity}`)
            .append((0, Component_79.default)().style('mention-punctuation').text.set('@'))
            .append((0, Component_79.default)().style('mention-author-name').text.set(author?.name ?? en_nz_20.default['shared/mention/unresolved']()))
            .style('mention');
    });
...
define("App", ["require", "exports", "lang/en-nz", "model/FormInputLengths", "model/Session", "navigation/Navigate", "style", "ui/Component", "ui/component/core/ExternalLink", "ui/component/core/Link", "ui/component/core/toast/ToastList", "ui/component/Masthead", "ui/component/Mention", "ui/InputBus", "ui/utility/ActiveListener", "ui/utility/FocusListener", "ui/utility/FontsListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/StringApplicator", "ui/utility/Viewport", "ui/view/shared/component/ViewContainer", "utility/Async", "utility/DevServer", "utility/Store", "utility/Time"], function (require, exports, en_nz_21, FormInputLengths_6, Session_27, Navigate_1, style_2, Component_80, ExternalLink_2, Link_19, ToastList_1, Masthead_1, Mention_1, InputBus_3, ActiveListener_1, FocusListener_3, FontsListener_2, HoverListener_2, Mouse_5, StringApplicator_11, Viewport_7, ViewContainer_1, Async_6, DevServer_2, Store_6, Time_12) {
    ...
    StringApplicator_11.QuiltHelper.init({
        Component: Component_80.default,
    ...
    async function App() {
        ...
        Component_80.default.allowBuilding();
        ...
        const related = (0, Component_80.default)()
            .style('app-content-related');
        const content = (0, Component_80.default)()
            .style('app-content')
            .monitorScrollEvents()
            .append(view, related);
        const app = (0, Component_80.default)()
            .style('app')
...
define("index", ["require", "exports", "utility/Arrays", "utility/DOMRect", "utility/Elements", "browser-source-map-support", "utility/Env", "utility/Maps"], function (require, exports, Arrays_11, DOMRect_1, Elements_1, browser_source_map_support_1, Env_13, Maps_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/ActionHeading", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Heading"], function (require, exports, Component_81, ActionRow_8, Heading_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_81 = __importDefault(Component_81);
    ActionRow_8 = __importDefault(ActionRow_8);
    Heading_5 = __importDefault(Heading_5);
    const ActionHeading = Component_81.default.Builder((component) => {
...
define("ui/view/TestView", ["require", "exports", "markdown-it", "ui/Component", "ui/component/core/Block", "ui/component/core/TextEditor", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Env", "utility/string/MarkdownItHTML"], function (require, exports, markdown_it_2, Component_82, Block_19, TextEditor_5, View_18, ViewDefinition_17, Env_14, MarkdownItHTML_2) {
    ...
    exports.default = (0, ViewDefinition_17.default)({
        create: () => {
            const view = (0, View_18.default)('home');
            ...
            (0, TextEditor_5.default)()
                .appendTo(block.content);
            if (Env_14.default.isDev) {
                (0, Component_82.default)('br').appendTo(block.content);
                const output = (0, Component_82.default)('div');
                (0, Component_82.default)('div')
                    .attributes.set('contenteditable', 'plaintext-only')
