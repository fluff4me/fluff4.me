...
namespace Objects {
	...
	export function map<T, R extends [PropertyKeySafe, any]> (object: T, mapper: (pair: KeyValuePairs<T>) => R) {
	...
	export async function mapAsync<T, R extends [PropertyKeySafe, any]> (object: T, mapper: (pair: KeyValuePairs<T>) => Promise<R>) {
